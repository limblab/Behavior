...
MODEL           = random_walk
MODULES         = random_walk_capi.c random_walk_data.c rt_atan2.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c 
MAKEFILE        = random_walk.mk
...
S_FUNCTIONS     = xpctimeinfo.c donipcie.c serPos.c Byte2Bits.c dopci8255.c enccbcioquadcount.c mastercon_rw.c danipcie.c xpcudpbytesend.c
S_FUNCTIONS_LIB = 
NUMST           = 4
TID01EQ         = 1
NCSTATES        = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\limblab\Desktop\RICARD~1\Target\RANDOM~1
