...
#
# File    : xpc_vc.tmf   $Revision: 1.1.1.1 $ $Date: 2008-01-16 19:29:17 $
#
# Abstract:
...
MODEL           = xpcosc
MODULES         = rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpcosc_capi.c xpcosc_data.c 
MAKEFILE        = xpcosc.mk
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\limblab\Desktop\RICARD~1\Target\XPCOSC~1
