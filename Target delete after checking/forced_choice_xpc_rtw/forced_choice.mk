...
#
# File    : xpc_vc.tmf   $Revision: 1.1.1.1 $ $Date: 2008-01-16 19:29:16 $
#
# Abstract:
...
MODEL           = forced_choice
MODULES         = forced_choice_capi.c forced_choice_data.c rt_atan2.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c 
MAKEFILE        = forced_choice.mk
...
S_FUNCTIONS     = xpctimeinfo.c donipcie.c serPos.c Byte2Bits.c dopci8255.c enccbcioquadcount.c mastercon_fc.c danipcie.c xpcudpbytesend.c
S_FUNCTIONS_LIB = 
NUMST           = 4
TID01EQ         = 1
NCSTATES        = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\limblab\Desktop\RICARD~1\Target\FORCED~1
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\limblab\Desktop\RICARD~1\Target
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\libsrc
