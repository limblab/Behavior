...
MODEL           = CO_bump
MODULES         = CO_bump_capi.c CO_bump_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = CO_bump.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\tucker\Desktop\GIT\Behavior\src\target
S_FUNCTIONS     = xpctimeinfo.c donipcie.c Byte2Bits.c dopci8255.c serPos.c ich5.c xpcudpbytereceive.c adnipcie.c enccbcioquadcount.c mastercon_CO_bump.cpp xpcudpbytesend.c danipcie.c xpcionie.c
S_FUNCTIONS_LIB = 
NUMST           = 3
TID01EQ         = 1
NCSTATES        = 0
...
MODELLIB                  = CO_bumplib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = CO_bump_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\CO_bump_slrt_rtw
