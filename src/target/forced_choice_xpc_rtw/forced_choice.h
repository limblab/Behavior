...
typedef struct {
  ...
  real_T Sum3_n;                       /* '<S71>/Sum3' */
  real_T Sum1_a;                       /* '<S71>/Sum1' */
  real_T TrigonometricFunction1_j;     /* '<S69>/Trigonometric Function1' */
  real_T Sum_f;                        /* '<S69>/Sum' */
  real_T TrigonometricFunction2_g;     /* '<S69>/Trigonometric Function2' */
  ...
  real_T TrigonometricFunction_k;      /* '<S69>/Trigonometric Function' */
  real_T Product_d;                    /* '<S69>/Product' */
  real_T DigitalFilter2_b;             /* '<S68>/Digital Filter2' */
  real_T Derivative_h;                 /* '<S68>/Derivative' */
  real_T dG_f;                         /* '<S68>/dG' */
  real_T DigitalFilter_k;              /* '<S68>/Digital Filter' */
  real_T Switch[2];                    /* '<S10>/Switch' */
  real_T Clock_p;                      /* '<S43>/Clock' */
  real_T Clock_l;                      /* '<S47>/Clock' */
  real_T Sum_k;                        /* '<S47>/Sum' */
  real_T Sum_a;                        /* '<S43>/Sum' */
  real_T Abs2;                         /* '<S40>/Abs2' */
  real_T Abs3;                         /* '<S40>/Abs3' */
  real_T Clock_f;                      /* '<S45>/Clock' */
  real_T Sum_d;                        /* '<S45>/Sum' */
  real_T Clock_b;                      /* '<S44>/Clock' */
  real_T Sum_p;                        /* '<S44>/Sum' */
  real_T x;                            /* '<S23>/x' */
  real_T x_h;                          /* '<S24>/x' */
  real_T Add;                          /* '<S21>/Add' */
  real_T x_m;                          /* '<S25>/x' */
  ...
  real_T BehaviorFC_o7[4];             /* '<Root>/Behavior FC' */
  real_T BehaviorFC_o8[2];             /* '<Root>/Behavior FC' */
  real_T Switch2[2];                   /* '<S4>/Switch2' */
  real_T MG1;                          /* '<S4>/MG1' */
  real_T MG2;                          /* '<S4>/MG2' */
  real_T Clock_i;                      /* '<S65>/Clock' */
  real_T HiddenBuf_InsertedFor_Sampleand;/* 'synthesized block' */
  real_T Sum_f5;                       /* '<S65>/Sum' */
  real_T UniformRandomNumber;          /* '<S6>/Uniform Random Number' */
  real_T Switch_n;                     /* '<S6>/Switch' */
  real_T HiddenBuf_InsertedFor_Samplea_o;/* 'synthesized block' */
  ...
  real_T y_i;                          /* '<S18>/y' */
  real_T Add1_k;                       /* '<S18>/Add1' */
  real_T z_e;                          /* '<S18>/z' */
  real_T Add3_m;                       /* '<S18>/Add3' */
  real_T product2_m;                   /* '<S18>/product2' */
  real_T Add2_p;                       /* '<S18>/Add2' */
  real_T product3_j;                   /* '<S18>/product3' */
  real_T product4_l;                   /* '<S18>/product4' */
  real_T Add4_d;                       /* '<S18>/Add4' */
  real_T product1_h;                   /* '<S18>/product1' */
  real_T dX_c;                         /* '<S18>/dX' */
  real_T AddX_h;                       /* '<S18>/AddX' */
  real_T dY_j;                         /* '<S18>/dY' */
  real_T AddX1_a;                      /* '<S18>/AddX1' */
  real_T dZ_k;                         /* '<S18>/dZ' */
  real_T AddX2_f;                      /* '<S18>/AddX2' */
  real_T y_k;                          /* '<S19>/y' */
  real_T Add1_l;                       /* '<S19>/Add1' */
  real_T z_h;                          /* '<S19>/z' */
  real_T Add3_i;                       /* '<S19>/Add3' */
  real_T product2_g;                   /* '<S19>/product2' */
  real_T Add2_c;                       /* '<S19>/Add2' */
  real_T product3_k;                   /* '<S19>/product3' */
  real_T product4_h;                   /* '<S19>/product4' */
  real_T Add4_i;                       /* '<S19>/Add4' */
  real_T product1_b;                   /* '<S19>/product1' */
  real_T dX_h;                         /* '<S19>/dX' */
  real_T AddX_e;                       /* '<S19>/AddX' */
  real_T dY_o;                         /* '<S19>/dY' */
  real_T AddX1_g;                      /* '<S19>/AddX1' */
  real_T dZ_m;                         /* '<S19>/dZ' */
  real_T AddX2_m;                      /* '<S19>/AddX2' */
  real_T y_a;                          /* '<S20>/y' */
  real_T Add1_ld;                      /* '<S20>/Add1' */
  real_T z_a;                          /* '<S20>/z' */
  real_T Add3_o;                       /* '<S20>/Add3' */
  real_T product2_n;                   /* '<S20>/product2' */
  real_T Add2_f;                       /* '<S20>/Add2' */
  real_T product3_ji;                  /* '<S20>/product3' */
  real_T product4_o;                   /* '<S20>/product4' */
  real_T Add4_h;                       /* '<S20>/Add4' */
  real_T product1_o;                   /* '<S20>/product1' */
  real_T dX_i;                         /* '<S20>/dX' */
  real_T AddX_k;                       /* '<S20>/AddX' */
  real_T dY_k;                         /* '<S20>/dY' */
  real_T AddX1_c;                      /* '<S20>/AddX1' */
  real_T dZ_mc;                        /* '<S20>/dZ' */
  real_T AddX2_d;                      /* '<S20>/AddX2' */
  real_T y_p;                          /* '<S23>/y' */
  real_T Add1_o;                       /* '<S23>/Add1' */
  real_T z_p;                          /* '<S23>/z' */
  real_T Add3_m2;                      /* '<S23>/Add3' */
  real_T product2_go;                  /* '<S23>/product2' */
  real_T Add2_n;                       /* '<S23>/Add2' */
  real_T product3_m;                   /* '<S23>/product3' */
  real_T product4_j;                   /* '<S23>/product4' */
  real_T Add4_p;                       /* '<S23>/Add4' */
  real_T product1_k;                   /* '<S23>/product1' */
  real_T dX_b;                         /* '<S23>/dX' */
  real_T AddX_n;                       /* '<S23>/AddX' */
  real_T dY_ks;                        /* '<S23>/dY' */
  real_T AddX1_p;                      /* '<S23>/AddX1' */
  real_T dZ_j;                         /* '<S23>/dZ' */
  real_T AddX2_i;                      /* '<S23>/AddX2' */
  real_T y_pt;                         /* '<S24>/y' */
  real_T Add1_e;                       /* '<S24>/Add1' */
  real_T z_m;                          /* '<S24>/z' */
  real_T Add3_n;                       /* '<S24>/Add3' */
  real_T product2_n2;                  /* '<S24>/product2' */
  real_T Add2_d;                       /* '<S24>/Add2' */
  real_T product3_b;                   /* '<S24>/product3' */
  real_T product4_n;                   /* '<S24>/product4' */
  real_T Add4_c;                       /* '<S24>/Add4' */
  real_T product1_ka;                  /* '<S24>/product1' */
  real_T dX_i1;                        /* '<S24>/dX' */
  real_T AddX_m;                       /* '<S24>/AddX' */
  real_T dY_g;                         /* '<S24>/dY' */
  real_T AddX1_j;                      /* '<S24>/AddX1' */
  real_T dZ_k3;                        /* '<S24>/dZ' */
  real_T AddX2_j;                      /* '<S24>/AddX2' */
  real_T y_e;                          /* '<S25>/y' */
  real_T Add1_ln;                      /* '<S25>/Add1' */
  real_T z_mc;                         /* '<S25>/z' */
  real_T Add3_k;                       /* '<S25>/Add3' */
  real_T product2_a;                   /* '<S25>/product2' */
  real_T Add2_k;                       /* '<S25>/Add2' */
  real_T product3_c;                   /* '<S25>/product3' */
  real_T product4_c;                   /* '<S25>/product4' */
  real_T Add4_im;                      /* '<S25>/Add4' */
  real_T product1_bp;                  /* '<S25>/product1' */
  real_T dX_l;                         /* '<S25>/dX' */
  real_T AddX_kb;                      /* '<S25>/AddX' */
  real_T dY_op;                        /* '<S25>/dY' */
  real_T AddX1_k;                      /* '<S25>/AddX1' */
  real_T dZ_f;                         /* '<S25>/dZ' */
  real_T AddX2_b;                      /* '<S25>/AddX2' */
  real_T y_ke;                         /* '<S26>/y' */
  real_T Add1_i;                       /* '<S26>/Add1' */
  real_T z_n;                          /* '<S26>/z' */
  real_T Add3_d;                       /* '<S26>/Add3' */
  real_T product2_j;                   /* '<S26>/product2' */
  real_T Add2_cy;                      /* '<S26>/Add2' */
  real_T product3_a;                   /* '<S26>/product3' */
  real_T product4_p;                   /* '<S26>/product4' */
  real_T Add4_hy;                      /* '<S26>/Add4' */
  real_T product1_kd;                  /* '<S26>/product1' */
  real_T dX_a;                         /* '<S26>/dX' */
  real_T AddX_mq;                      /* '<S26>/AddX' */
  real_T dY_p;                         /* '<S26>/dY' */
  real_T AddX1_e;                      /* '<S26>/AddX1' */
  real_T dZ_p;                         /* '<S26>/dZ' */
  real_T AddX2_fp;                     /* '<S26>/AddX2' */
  real_T MatrixConcatenation1[4];      /* '<Root>/Matrix Concatenation1' */
  real_T Add_n;                        /* '<S8>/Add' */
  real_T Add1_m;                       /* '<S8>/Add1' */
  real_T Gain_n;                       /* '<S8>/Gain' */
  real_T Gain1_d;                      /* '<S8>/Gain1' */
  ...
  real_T Add_i;                        /* '<S70>/Add' */
  real_T Add1_k0;                      /* '<S70>/Add1' */
  ...
  real_T xPCTargetTime_n;              /* '<S72>/xPC Target  Time ' */
  real_T Subtract;                     /* '<S72>/Subtract' */
  real_T ScaleTouSec;                  /* '<S72>/ScaleTouSec' */
  real_T Switch_m;                     /* '<S72>/Switch' */
  ...
  real_T Gain_i[2];                    /* '<S29>/Gain' */
  real_T MathFunction[4];              /* '<S33>/Math Function' */
  real_T MatrixMultiply_f[2];          /* '<S29>/Matrix Multiply' */
  ...
  real_T Add_j;                        /* '<S41>/Add' */
  real_T Saturation;                   /* '<S41>/Saturation' */
  real_T Gain4;                        /* '<S41>/Gain4' */
  real_T Product1_m;                   /* '<S41>/Product1' */
  real_T Gain2;                        /* '<S41>/Gain2' */
  real_T Add1_p;                       /* '<S41>/Add1' */
  real_T Saturation1;                  /* '<S41>/Saturation1' */
  real_T Add1_c;                       /* '<S21>/Add1' */
  real_T LorentzForceGain[2];          /* '<S3>/LorentzForceGain' */
  real_T dynamicAngleSwitch;           /* '<S3>/dynamicAngle Switch' */
  real_T sin_c;                        /* '<S22>/sin' */
  real_T Inverter[2];                  /* '<S22>/Inverter' */
  real_T Product3_g;                   /* '<S22>/Product3' */
  real_T cos_n;                        /* '<S22>/cos' */
  real_T Product2_p;                   /* '<S22>/Product2' */
  real_T Subtract_b;                   /* '<S22>/Subtract' */
  real_T Product1_h;                   /* '<S22>/Product1' */
  real_T Product_h;                    /* '<S22>/Product' */
  real_T Add_f;                        /* '<S22>/Add' */
  real_T Gain_l[2];                    /* '<S22>/Gain' */
  real_T Gain_e;                       /* '<S3>/Gain' */
  real_T Add1_cy;                      /* '<S15>/Add1' */
  real_T LorentzForceGain_f[2];        /* '<S2>/LorentzForceGain' */
  real_T DynamicAngleSwitch;           /* '<S2>/DynamicAngle Switch' */
  real_T sin_h;                        /* '<S16>/sin' */
  real_T Inverter_f[2];                /* '<S16>/Inverter' */
  real_T Product3_c;                   /* '<S16>/Product3' */
  real_T cos_i;                        /* '<S16>/cos' */
  real_T Product2_k;                   /* '<S16>/Product2' */
  real_T Subtract_n;                   /* '<S16>/Subtract' */
  real_T Product1_l;                   /* '<S16>/Product1' */
  real_T Product_p;                    /* '<S16>/Product' */
  real_T Add_cv;                       /* '<S16>/Add' */
  real_T Gain_j[2];                    /* '<S16>/Gain' */
  real_T Gain_ii;                      /* '<S2>/Gain' */
  uint8_T Compare;                     /* '<S34>/Compare' */
  uint8_T Compare_g;                   /* '<S36>/Compare' */
  uint8_T Compare_j;                   /* '<S37>/Compare' */
  uint8_T Compare_k;                   /* '<S60>/Compare' */
  uint8_T Compare_gq;                  /* '<S63>/Compare' */
  ...
  uint8_T Compare_jg;                  /* '<S59>/Compare' */
  uint8_T Uk1_c;                       /* '<S46>/Delay Input1' */
  uint8_T FixPtRelationalOperator_l;   /* '<S46>/FixPt Relational Operator' */
  uint8_T Compare_n;                   /* '<S57>/Compare' */
  uint8_T Compare_l;                   /* '<S50>/Compare' */
  uint8_T Uk1_k;                       /* '<S39>/Delay Input1' */
  uint8_T FixPtRelationalOperator_d;   /* '<S39>/FixPt Relational Operator' */
  uint8_T Compare_jc;                  /* '<S55>/Compare' */
  uint8_T Compare_e;                   /* '<S49>/Compare' */
  ...
  boolean_T Memory_k;                  /* '<S47>/Memory' */
  boolean_T LogicalOperator4;          /* '<S47>/Logical Operator4' */
  boolean_T LogicalOperator_f;         /* '<S5>/Logical Operator' */
  boolean_T LogicalOperator2_b;        /* '<S47>/Logical Operator2' */
  boolean_T LogicalOperator1_p;        /* '<S47>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_b;/* '<S47>/Logical Operator1' */
  boolean_T RelationalOperator_p;      /* '<S47>/Relational Operator' */
  boolean_T LogicalOperator_fl;        /* '<S47>/Logical Operator' */
  boolean_T LogicalOperator5;          /* '<S47>/Logical Operator5' */
  boolean_T LogicalOperator2_d;        /* '<S43>/Logical Operator2' */
  boolean_T LogicalOperator1_h;        /* '<S43>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_i;/* '<S43>/Logical Operator1' */
  boolean_T RelationalOperator_n;      /* '<S43>/Relational Operator' */
  boolean_T LogicalOperator_p;         /* '<S43>/Logical Operator' */
  boolean_T LogicalOperator1_e;        /* '<S40>/Logical Operator1' */
  boolean_T NOT;                       /* '<S5>/NOT' */
  boolean_T Memory_ha;                 /* '<S45>/Memory' */
  boolean_T LogicalOperator2_da;       /* '<S45>/Logical Operator2' */
  boolean_T LogicalOperator1_i;        /* '<S45>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_g;/* '<S45>/Logical Operator1' */
  boolean_T RelationalOperator_b;      /* '<S45>/Relational Operator' */
  boolean_T LogicalOperator_g;         /* '<S45>/Logical Operator' */
  boolean_T DataTypeConversion2;       /* '<S5>/Data Type Conversion2' */
  boolean_T LogicalOperator1_c;        /* '<S5>/Logical Operator1' */
  boolean_T Memory_m;                  /* '<S44>/Memory' */
  boolean_T LogicalOperator2_e;        /* '<S44>/Logical Operator2' */
  boolean_T LogicalOperator1_hr;       /* '<S44>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_f;/* '<S44>/Logical Operator1' */
  boolean_T RelationalOperator_pi;     /* '<S44>/Relational Operator' */
  boolean_T LogicalOperator_fa;        /* '<S44>/Logical Operator' */
  boolean_T DataTypeConversion1;       /* '<S5>/Data Type Conversion1' */
  boolean_T Memory_f;                  /* '<S42>/Memory' */
  boolean_T Logic[2];                  /* '<S42>/Logic' */
  boolean_T LogicalOperator5_h;        /* '<S5>/Logical Operator5' */
  boolean_T LogicalOperator1_g;        /* '<S4>/Logical Operator1' */
  boolean_T MatrixConcatenation[2];    /* '<S4>/Matrix Concatenation' */
  boolean_T RelationalOperator_f;      /* '<S6>/Relational Operator' */
  boolean_T RelationalOperator_c;      /* '<S65>/Relational Operator' */
  boolean_T Compare_pl;                /* '<S74>/Compare' */
  boolean_T Compare_a;                 /* '<S73>/Compare' */
  boolean_T LogicalOperator6;          /* '<S5>/Logical Operator6' */
  boolean_T LogicalOperator3_j;        /* '<S5>/Logical Operator3' */
  rtB_SampleandHold_forced_choice SampleandHold;/* '<S65>/Sample and Hold' */
  rtB_SampleandHold_forced_choice SampleandHold_i;/* '<S6>/Sample and Hold' */
  rtB_EnabledSubsystem_forced_cho EnabledSubsystem_l;/* '<S47>/Enabled Subsystem' */
  rtB_EnabledSubsystem_forced_cho EnabledSubsystem_i;/* '<S45>/Enabled Subsystem' */
  rtB_EnabledSubsystem_forced_cho EnabledSubsystem_hg;/* '<S44>/Enabled Subsystem' */
  rtB_EnabledSubsystem_forced_cho EnabledSubsystem_h;/* '<S43>/Enabled Subsystem' */
  rtB_EnabledSubsystem_forced_cho EnabledSubsystem;/* '<S31>/Enabled Subsystem' */
...
typedef struct {
  ...
  real_T DigitalFilter2_FILT_STATES_g[11];/* '<S68>/Digital Filter2' */
  real_T DigitalFilter_FILT_STATES_d[11];/* '<S68>/Digital Filter' */
  real_T x_DSTATE;                     /* '<S23>/x' */
  real_T x_DSTATE_h;                   /* '<S24>/x' */
  real_T x_DSTATE_g;                   /* '<S25>/x' */
  real_T x_DSTATE_e;                   /* '<S26>/x' */
  real_T x_DSTATE_k;                   /* '<S17>/x' */
  real_T x_DSTATE_en;                  /* '<S18>/x' */
  real_T x_DSTATE_b;                   /* '<S19>/x' */
  real_T x_DSTATE_d;                   /* '<S20>/x' */
  real_T BehaviorFC_DSTATE;            /* '<Root>/Behavior FC' */
  real_T y_DSTATE;                     /* '<S17>/y' */
  real_T z_DSTATE;                     /* '<S17>/z' */
  real_T y_DSTATE_n;                   /* '<S18>/y' */
  real_T z_DSTATE_g;                   /* '<S18>/z' */
  real_T y_DSTATE_h;                   /* '<S19>/y' */
  real_T z_DSTATE_m;                   /* '<S19>/z' */
  real_T y_DSTATE_f;                   /* '<S20>/y' */
  real_T z_DSTATE_f;                   /* '<S20>/z' */
  real_T y_DSTATE_a;                   /* '<S23>/y' */
  real_T z_DSTATE_i;                   /* '<S23>/z' */
  real_T y_DSTATE_ag;                  /* '<S24>/y' */
  real_T z_DSTATE_gn;                  /* '<S24>/z' */
  real_T y_DSTATE_p;                   /* '<S25>/y' */
  real_T z_DSTATE_a;                   /* '<S25>/z' */
  real_T y_DSTATE_g;                   /* '<S26>/y' */
  real_T z_DSTATE_p;                   /* '<S26>/z' */
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Derivative_RWORK_a;                /* '<S68>/Derivative' */

  real_T BehaviorFC_RWORK[4];          /* '<Root>/Behavior FC' */
  ...
  int32_T DigitalFilter2_CIRCBUFFIDX_b;/* '<S68>/Digital Filter2' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_f;                 /* '<S7>/S-Function' */

  int_T Send_IWORK[2];                 /* '<S9>/Send' */
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_gk;                /* '<S11>/S-Function' */
  ...
  int_T PCI6025E_IWORK_k[3];           /* '<S72>/PCI-6025E ' */
  uint8_T DelayInput1_DSTATE;          /* '<S61>/Delay Input1' */
  uint8_T DelayInput1_DSTATE_d;        /* '<S46>/Delay Input1' */
  uint8_T DelayInput1_DSTATE_m;        /* '<S39>/Delay Input1' */
  uint8_T DelayInput1_DSTATE_b;        /* '<S38>/Delay Input1' */
  boolean_T Memory_PreviousInput;      /* '<S31>/Memory' */
  boolean_T Memory_PreviousInput_l;    /* '<S4>/Memory' */
  boolean_T Memory_PreviousInput_e;    /* '<S43>/Memory' */
  boolean_T Memory_PreviousInput_n;    /* '<S47>/Memory' */
  boolean_T Memory_PreviousInput_eh;   /* '<S45>/Memory' */
  boolean_T Memory_PreviousInput_g;    /* '<S44>/Memory' */
  boolean_T Memory_PreviousInput_h;    /* '<S42>/Memory' */
  rtDW_SampleandHold_forced_choic SampleandHold;/* '<S65>/Sample and Hold' */
  rtDW_SampleandHold_forced_choic SampleandHold_i;/* '<S6>/Sample and Hold' */
  rtDW_EnabledSubsystem_forced_ch EnabledSubsystem_l;/* '<S47>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_forced_ch EnabledSubsystem_i;/* '<S45>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_forced_ch EnabledSubsystem_hg;/* '<S44>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_forced_ch EnabledSubsystem_h;/* '<S43>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_forced_ch EnabledSubsystem;/* '<S31>/Enabled Subsystem' */
} D_Work_forced_choice;

/* Zero-crossing (trigger) state */
typedef struct {
  rtZCE_SampleandHold_forced_choi SampleandHold;/* '<S6>/Sample and Hold' */
  rtZCE_SampleandHold_forced_choi SampleandHold_i;/* '<S6>/Sample and Hold' */
} PrevZCSigStates_forced_choice;
...
#define rtPrevZCSigState               forced_choice_PrevZCSigState
#define PrevZCSigStates                PrevZCSigStates_forced_choice

/* Parameters for system: '<S6>/Sample and Hold' */
struct rtP_SampleandHold_forced_choice {
...
struct Parameters_forced_choice {
  ...
  real_T DigitalFilter_RTP1COEFF[11];  /* Expression: NumCoeffs
                                        * '<S67>/Digital Filter'
                                        */
  real_T DigitalFilter2_ICRTP_l;       /* Expression: a.IC
                                        * '<S68>/Digital Filter2'
                                        */
  real_T DigitalFilter2_RTP1COEFF_m[11];/* Expression: NumCoeffs
                                         * '<S68>/Digital Filter2'
                                         */
  ...
  real_T DigitalFilter_ICRTP_h;        /* Expression: a.IC
                                        * '<S68>/Digital Filter'
                                        */
  real_T DigitalFilter_RTP1COEFF_p[11];/* Expression: NumCoeffs
                                        * '<S68>/Digital Filter'
                                        */
  ...
  real_T Time_Value_o;                 /* Expression: Time
                                        * '<S47>/Time'
                                        */
  real_T Time_Value_n;                 /* Expression: Time
                                        * '<S43>/Time'
                                        */
  ...
  real_T Constant_Value_l;             /* Expression: const
                                        * '<S52>/Constant'
                                        */
  real_T Time_Value_m;                 /* Expression: Time
                                        * '<S45>/Time'
                                        */
  ...
  real_T BehaviorFC_P8_Size[2];        /* Computed Parameter: P8Size
                                        * '<Root>/Behavior FC'
                                        */
  real_T BehaviorFC_P8;                /* Expression: 2
                                        * '<Root>/Behavior FC'
                                        */
  real_T BehaviorFC_P9_Size[2];        /* Computed Parameter: P9Size
                                        * '<Root>/Behavior FC'
                                        */
  real_T BehaviorFC_P9;                /* Expression: 2
                                        * '<Root>/Behavior FC'
                                        */
  ...
  real_T BehaviorFC_P11_Size[2];       /* Computed Parameter: P11Size
                                        * '<Root>/Behavior FC'
                                        */
  real_T BehaviorFC_P11;               /* Expression: 5
                                        * '<Root>/Behavior FC'
                                        */
  real_T BehaviorFC_P12_Size[2];       /* Computed Parameter: P12Size
                                        * '<Root>/Behavior FC'
                                        */
  real_T BehaviorFC_P12;               /* Expression: 0
                                        * '<Root>/Behavior FC'
                                        */
  real_T BehaviorFC_P13_Size[2];       /* Computed Parameter: P13Size
                                        * '<Root>/Behavior FC'
                                        */
  real_T BehaviorFC_P13;               /* Expression: 1
                                        * '<Root>/Behavior FC'
                                        */
  ...
  real_T Constant_Value_o;             /* Expression: const
                                        * '<S27>/Constant'
                                        */
  real_T Constant_Value_l0;            /* Expression: const
                                        * '<S28>/Constant'
                                        */
  ...
  real_T timescale_Value_e;            /* Expression: .0001
                                        * '<S18>/timescale'
                                        */
  real_T sigma_Value_b;                /* Expression: 10
                                        * '<S18>/sigma'
                                        */
  ...
  real_T z_X0_f;                       /* Expression: .1
                                        * '<S23>/z'
                                        */
  real_T beta_Value_gv;                /* Expression: 8/3
                                        * '<S23>/beta'
                                        */
  real_T timescale_Value_c;            /* Expression: .0001
                                        * '<S23>/timescale'
                                        */
  real_T sigma_Value_bo;               /* Expression: 10
                                        * '<S23>/sigma'
                                        */
  real_T y_X0_f;                       /* Expression: y0
                                        * '<S24>/y'
                                        */
  real_T rho_Value_dl;                 /* Expression: 28
                                        * '<S24>/rho'
                                        */
  ...
  real_T timescale_Value_f;            /* Expression: .0001
                                        * '<S26>/timescale'
                                        */
  real_T sigma_Value_k4;               /* Expression: 10
                                        * '<S26>/sigma'
                                        */
  ...
  real_T Gain1_Gain_e;                 /* Expression: .5
                                        * '<S8>/Gain1'
                                        */
  real_T Gain_Gain_n;                  /* Expression: 0.0367
                                        * '<S2>/Gain'
                                        */
  ...
  real_T Gain_Gain_d;                  /* Expression: 0.0367
                                        * '<S3>/Gain'
                                        */
  real_T visAngle_Value_i;             /* Expression: 0
                                        * '<S3>/visAngle'
                                        */
  real_T DynamicAngle_Value_c;         /* Expression: 0
                                        * '<S3>/DynamicAngle'
                                        */
  real_T Inverter_Gain_l;              /* Expression: -1
                                        * '<S22>/Inverter'
                                        */
  real_T Gain_Gain_mk;                 /* Expression: 1
                                        * '<S22>/Gain'
                                        */
  real_T LorentzForceGain_Gain_m;      /* Expression: .0005
                                        * '<S3>/LorentzForceGain'
                                        */
  real_T staticX_Value_i;              /* Expression: 0
                                        * '<S3>/staticX'
                                        */
  real_T staticY_Value_o;              /* Expression: 0
                                        * '<S3>/staticY'
                                        */
  real_T Off_Value_j;                  /* Expression: 0
                                        * '<S3>/Off'
                                        */
  ...
  real_T Gain4_Gain;                   /* Expression: -.0002
                                        * '<S41>/Gain4'
                                        */
  real_T Gain2_Gain_f;                 /* Expression: -.001
                                        * '<S41>/Gain2'
                                        */
  ...
  real_T PCI6025E_P5_Size_h[2];        /* Computed Parameter: P5Size
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P5_h;                /* Expression: slot
                                        * '<S72>/PCI-6025E '
                                        */
  ...
  real_T Constant_Value_m2;            /* Expression: const
                                        * '<S73>/Constant'
                                        */
  real_T Switch_Threshold_n;           /* Expression: 2
                                        * '<S70>/Switch'
                                        */
  ...
  uint8_T DelayInput1_X0_c;            /* Computed Parameter: X0
                                        * '<S39>/Delay Input1'
                                        */
  uint8_T DelayInput1_X0_d;            /* Computed Parameter: X0
                                        * '<S38>/Delay Input1'
                                        */
  ...
  boolean_T Memory_X0_n;               /* Computed Parameter: X0
                                        * '<S43>/Memory'
                                        */
  boolean_T Memory_X0_f;               /* Computed Parameter: X0
                                        * '<S47>/Memory'
                                        */
  ...
  boolean_T Logic_table[16];           /* Computed Parameter: TruthTable
                                        * '<S42>/Logic'
                                        */
  rtP_SampleandHold_forced_choice SampleandHold;/* '<S6>/Sample and Hold' */
  rtP_SampleandHold_forced_choice SampleandHold_i;/* '<S6>/Sample and Hold' */
};
...
/* Zero-crossing (trigger) state */
extern PrevZCSigStates_forced_choice forced_choice_PrevZCSigState;
 ...
 * '<S2>'   : forced_choice/Catch Force Generator
 * '<S3>'   : forced_choice/Force Generator
 * '<S4>'   : forced_choice/Motor Control
 * '<S5>'   : forced_choice/Recentering Subsystem
 * '<S6>'   : forced_choice/RewardSbs
 * '<S7>'   : forced_choice/Status
 * '<S8>'   : forced_choice/Target Peek
 * '<S9>'   : forced_choice/UDPXmit
 * '<S10>'  : forced_choice/Velocity Calculation
 * '<S11>'  : forced_choice/Version Display
 * '<S12>'  : forced_choice/WordSbs
 * '<S13>'  : forced_choice/XY Position Subsystem
 * '<S14>'  : forced_choice/Xpos
 * '<S15>'  : forced_choice/Catch Force Generator/LorentzForce
 * '<S16>'  : forced_choice/Catch Force Generator/ViscLoadSubsystem
 * '<S17>'  : forced_choice/Catch Force Generator/LorentzForce/Lorentz
 * '<S18>'  : forced_choice/Catch Force Generator/LorentzForce/Lorentz1
 * '<S19>'  : forced_choice/Catch Force Generator/LorentzForce/Lorentz2
 * '<S20>'  : forced_choice/Catch Force Generator/LorentzForce/Lorentz3
 * '<S21>'  : forced_choice/Force Generator/LorentzForce
 * '<S22>'  : forced_choice/Force Generator/ViscLoadSubsystem
 * '<S23>'  : forced_choice/Force Generator/LorentzForce/Lorentz
 * '<S24>'  : forced_choice/Force Generator/LorentzForce/Lorentz1
 * '<S25>'  : forced_choice/Force Generator/LorentzForce/Lorentz2
 * '<S26>'  : forced_choice/Force Generator/LorentzForce/Lorentz3
 * '<S27>'  : forced_choice/Motor Control/Compare To Constant
 * '<S28>'  : forced_choice/Motor Control/Compare To Constant1
 * '<S29>'  : forced_choice/Motor Control/Force//Torque Transform
 * '<S30>'  : forced_choice/Motor Control/Recenter//ServoKill
 * '<S31>'  : forced_choice/Motor Control/Schmidt
 * '<S32>'  : forced_choice/Motor Control/Xpos
 * '<S33>'  : forced_choice/Motor Control/Force//Torque Transform/Transpose
 * '<S34>'  : forced_choice/Motor Control/Schmidt/Compare To Zero
 * '<S35>'  : forced_choice/Motor Control/Schmidt/Enabled Subsystem
 * '<S36>'  : forced_choice/Recentering Subsystem/Compare To Zero
 * '<S37>'  : forced_choice/Recentering Subsystem/Compare To Zero1
 * '<S38>'  : forced_choice/Recentering Subsystem/Falling Edge
 * '<S39>'  : forced_choice/Recentering Subsystem/Falling Edge1
 * '<S40>'  : forced_choice/Recentering Subsystem/No Movement
 * '<S41>'  : forced_choice/Recentering Subsystem/PD Controller
 * '<S42>'  : forced_choice/Recentering Subsystem/S-R Flip-Flop
 * '<S43>'  : forced_choice/Recentering Subsystem/Schmidt1
 * '<S44>'  : forced_choice/Recentering Subsystem/Schmidt2
 * '<S45>'  : forced_choice/Recentering Subsystem/Schmidt3
 * '<S46>'  : forced_choice/Recentering Subsystem/Start Moving
 * '<S47>'  : forced_choice/Recentering Subsystem/Timer
 * '<S48>'  : forced_choice/Recentering Subsystem/Xpos1
 * '<S49>'  : forced_choice/Recentering Subsystem/Falling Edge/Nonpositive
 * '<S50>'  : forced_choice/Recentering Subsystem/Falling Edge1/Nonpositive
 * '<S51>'  : forced_choice/Recentering Subsystem/No Movement/Compare To Constant2
 * '<S52>'  : forced_choice/Recentering Subsystem/No Movement/Compare To Constant3
 * '<S53>'  : forced_choice/Recentering Subsystem/Schmidt1/Compare To Zero
 * '<S54>'  : forced_choice/Recentering Subsystem/Schmidt1/Enabled Subsystem
 * '<S55>'  : forced_choice/Recentering Subsystem/Schmidt2/Compare To Zero
 * '<S56>'  : forced_choice/Recentering Subsystem/Schmidt2/Enabled Subsystem
 * '<S57>'  : forced_choice/Recentering Subsystem/Schmidt3/Compare To Zero
 * '<S58>'  : forced_choice/Recentering Subsystem/Schmidt3/Enabled Subsystem
 * '<S59>'  : forced_choice/Recentering Subsystem/Start Moving/Nonpositive
 * '<S60>'  : forced_choice/Recentering Subsystem/Timer/Compare To Zero
 * '<S61>'  : forced_choice/Recentering Subsystem/Timer/Detect Fall Nonpositive
 * '<S62>'  : forced_choice/Recentering Subsystem/Timer/Enabled Subsystem
 * '<S63>'  : forced_choice/Recentering Subsystem/Timer/Detect Fall Nonpositive/Nonpositive
 * '<S64>'  : forced_choice/RewardSbs/Sample and Hold
 * '<S65>'  : forced_choice/RewardSbs/Schmidt
 * '<S66>'  : forced_choice/RewardSbs/Schmidt/Sample and Hold
 * '<S67>'  : forced_choice/Velocity Calculation/Pos2VelX
 * '<S68>'  : forced_choice/Velocity Calculation/Pos2VelY
 * '<S69>'  : forced_choice/XY Position Subsystem/Cursor Rotation
 * '<S70>'  : forced_choice/XY Position Subsystem/For Iterator Subsystem
 * '<S71>'  : forced_choice/XY Position Subsystem/Jacobian-Cartesian Transformation
 * '<S72>'  : forced_choice/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem
 * '<S73>'  : forced_choice/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem/Compare To Constant
 * '<S74>'  : forced_choice/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem/Compare To Constant1
 */
