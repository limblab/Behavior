...
bio(10).dim=[1,1];
bio(10).sigWidth=1;
bio(10).sigAddress='&random_walk_B.LogicalOperator_a';
...
bio(11).dim=[1,1];
bio(11).sigWidth=1;
bio(11).sigAddress='&random_walk_B.RelationalOperator_n';
...
bio(12).dim=[1,1];
bio(12).sigWidth=1;
bio(12).sigAddress='&random_walk_B.RelationalOperator1';
...
bio(13).dim=[1,1];
bio(13).sigWidth=1;
bio(13).sigAddress='&random_walk_B.RelationalOperator2';
...
bio(14).dim=[1,1];
bio(14).sigWidth=1;
bio(14).sigAddress='&random_walk_B.RelationalOperator3';
...
bio(15).dim=[1,1];
bio(15).sigWidth=1;
bio(15).sigAddress='&random_walk_B.Gain_b';
...
bio(16).dim=[2,1];
bio(16).sigWidth=2;
bio(16).sigAddress='&random_walk_B.LorentzForceGain_j[0]';
...
bio(17).dim=[1,1];
bio(17).sigWidth=1;
bio(17).sigAddress='&random_walk_B.DynamicAngleSwitch';
...
bio(18).dim=[2,1];
bio(18).sigWidth=2;
bio(18).sigAddress='&random_walk_B.LoadSelectSwitch[0]';
...
bio(19).dim=[1,1];
bio(19).sigWidth=1;
bio(19).sigAddress='&random_walk_B.Gain_d';
...
bio(20).dim=[2,1];
bio(20).sigWidth=2;
bio(20).sigAddress='&random_walk_B.LorentzForceGain[0]';
...
bio(21).dim=[2,1];
bio(21).sigWidth=2;
bio(21).sigAddress='&random_walk_B.MultiportSwitch[0]';
...
bio(22).dim=[1,1];
bio(22).sigWidth=1;
bio(22).sigAddress='&random_walk_B.dynamicAngleSwitch';
...
bio(23).dim=[2,1];
bio(23).sigWidth=2;
bio(23).sigAddress='&random_walk_B.MatrixConcatenation[0]';
...
bio(24).dim=[1,1];
bio(24).sigWidth=1;
bio(24).sigAddress='&random_walk_B.MG1';
...
bio(25).dim=[1,1];
bio(25).sigWidth=1;
bio(25).sigAddress='&random_walk_B.MG2';
...
bio(26).dim=[1,1];
bio(26).sigWidth=1;
bio(26).sigAddress='&random_walk_B.LogicalOperator1_b';
...
bio(27).dim=[1,1];
bio(27).sigWidth=1;
bio(27).sigAddress='&random_walk_B.Memory_e';
...
bio(28).dim=[2,1];
bio(28).sigWidth=2;
bio(28).sigAddress='&random_walk_B.Switch1[0]';
...
bio(29).dim=[2,1];
bio(29).sigWidth=2;
bio(29).sigAddress='&random_walk_B.Switch2[0]';
...
bio(30).dim=[1,1];
bio(30).sigWidth=1;
bio(30).sigAddress='&random_walk_B.DataTypeConversion1';
...
bio(31).dim=[1,1];
bio(31).sigWidth=1;
bio(31).sigAddress='&random_walk_B.DataTypeConversion2';
...
bio(32).dim=[2,1];
bio(32).sigWidth=2;
bio(32).sigAddress='&random_walk_B.BoundingBoxViscosity[0]';
...
bio(33).dim=[1,1];
bio(33).sigWidth=1;
bio(33).sigAddress='&random_walk_B.InBox';
...
bio(34).dim=[1,1];
bio(34).sigWidth=1;
bio(34).sigAddress='&random_walk_B.LogicalOperator_i';
...
bio(35).dim=[1,1];
bio(35).sigWidth=1;
bio(35).sigAddress='&random_walk_B.LogicalOperator1_a';
...
bio(36).dim=[1,1];
bio(36).sigWidth=1;
bio(36).sigAddress='&random_walk_B.LogicalOperator3_d';
...
bio(37).dim=[1,1];
bio(37).sigWidth=1;
bio(37).sigAddress='&random_walk_B.LogicalOperator5_h';
...
bio(38).dim=[1,1];
bio(38).sigWidth=1;
bio(38).sigAddress='&random_walk_B.LogicalOperator6';
...
bio(39).dim=[1,1];
bio(39).sigWidth=1;
bio(39).sigAddress='&random_walk_B.NOT';
...
bio(40).dim=[2,1];
bio(40).sigWidth=2;
bio(40).sigAddress='&random_walk_B.Switch_c[0]';
...
bio(41).dim=[1,1];
bio(41).sigWidth=1;
bio(41).sigAddress='&random_walk_B.DataTypeConversion';
...
bio(42).dim=[1,1];
bio(42).sigWidth=1;
bio(42).sigAddress='&random_walk_B.RelationalOperator_e';
...
bio(43).dim=[1,1];
bio(43).sigWidth=1;
bio(43).sigAddress='&random_walk_B.Switch_l';
...
bio(44).dim=[1,1];
bio(44).sigWidth=1;
bio(44).sigAddress='&random_walk_B.UniformRandomNumber';
...
bio(45).dim=[1,1];
bio(45).sigWidth=1;
bio(45).sigAddress='&random_walk_B.Gain_p';
...
bio(46).dim=[1,1];
bio(46).sigWidth=1;
bio(46).sigAddress='&random_walk_B.Gain1_c';
...
bio(47).dim=[1,1];
bio(47).sigWidth=1;
bio(47).sigAddress='&random_walk_B.Add_oe';
...
bio(48).dim=[1,1];
bio(48).sigWidth=1;
bio(48).sigAddress='&random_walk_B.Add1_f';
...
bio(49).dim=[112,1];
bio(49).sigWidth=112;
bio(49).sigAddress='&random_walk_B.RateTransition[0]';
...
bio(50).dim=[112,1];
bio(50).sigWidth=112;
bio(50).sigAddress='&random_walk_B.Pack[0]';
...
bio(51).dim=[1,1];
bio(51).sigWidth=1;
bio(51).sigAddress='&random_walk_B.TachGain1';
...
bio(52).dim=[1,1];
bio(52).sigWidth=1;
bio(52).sigAddress='&random_walk_B.TachGain2';
...
bio(53).dim=[2,1];
bio(53).sigWidth=2;
bio(53).sigAddress='&random_walk_B.MatrixMultiply[0]';
...
bio(54).dim=[1,1];
bio(54).sigWidth=1;
bio(54).sigAddress='&random_walk_B.PCI6025EAD_o1';
...
bio(55).dim=[1,1];
bio(55).sigWidth=1;
bio(55).sigAddress='&random_walk_B.PCI6025EAD_o2';
...
bio(56).dim=[2,1];
bio(56).sigWidth=2;
bio(56).sigAddress='&random_walk_B.Switch[0]';
...
bio(57).dim=[1,1];
bio(57).sigWidth=1;
bio(57).sigAddress='&random_walk_B.Gain';
...
bio(58).dim=[1,1];
bio(58).sigWidth=1;
bio(58).sigAddress='&random_walk_B.Gain1';
...
bio(59).dim=[1,1];
bio(59).sigWidth=1;
bio(59).sigAddress='&random_walk_B.PCIQUAD04';
...
bio(60).dim=[1,1];
bio(60).sigWidth=1;
bio(60).sigAddress='&random_walk_B.PCIQUAD041';
...
bio(61).dim=[1,1];
bio(61).sigWidth=1;
bio(61).sigAddress='&random_walk_B.Sum1';
...
bio(62).dim=[1,1];
bio(62).sigWidth=1;
bio(62).sigAddress='&random_walk_B.Sum3';
...
bio(63).dim=[1,1];
bio(63).sigWidth=1;
bio(63).sigAddress='&random_walk_B.Add_o';
...
bio(64).dim=[1,1];
bio(64).sigWidth=1;
bio(64).sigAddress='&random_walk_B.Add1_b1';
...
bio(65).dim=[2,1];
bio(65).sigWidth=2;
bio(65).sigAddress='&random_walk_B.Gain_a[0]';
...
bio(66).dim=[2,1];
bio(66).sigWidth=2;
bio(66).sigAddress='&random_walk_B.Inverter_a[0]';
...
bio(67).dim=[1,1];
bio(67).sigWidth=1;
bio(67).sigAddress='&random_walk_B.Product_d';
...
bio(68).dim=[1,1];
bio(68).sigWidth=1;
bio(68).sigAddress='&random_walk_B.Product1_jf';
...
bio(69).dim=[1,1];
bio(69).sigWidth=1;
bio(69).sigAddress='&random_walk_B.Product2_j';
...
bio(70).dim=[1,1];
bio(70).sigWidth=1;
bio(70).sigAddress='&random_walk_B.Product3_g';
...
bio(71).dim=[1,1];
bio(71).sigWidth=1;
bio(71).sigAddress='&random_walk_B.Add_p';
...
bio(72).dim=[1,1];
bio(72).sigWidth=1;
bio(72).sigAddress='&random_walk_B.Subtract_g';
...
bio(73).dim=[1,1];
bio(73).sigWidth=1;
bio(73).sigAddress='&random_walk_B.cos_j';
...
bio(74).dim=[1,1];
bio(74).sigWidth=1;
bio(74).sigAddress='&random_walk_B.sin_l';
...
bio(75).dim=[1,1];
bio(75).sigWidth=1;
bio(75).sigAddress='&random_walk_B.Add';
...
bio(76).dim=[1,1];
bio(76).sigWidth=1;
bio(76).sigAddress='&random_walk_B.Add1_a';
...
bio(77).dim=[2,1];
bio(77).sigWidth=2;
bio(77).sigAddress='&random_walk_B.Gain_n[0]';
...
bio(78).dim=[2,1];
bio(78).sigWidth=2;
bio(78).sigAddress='&random_walk_B.Inverter[0]';
...
bio(79).dim=[1,1];
bio(79).sigWidth=1;
bio(79).sigAddress='&random_walk_B.Product_e';
...
bio(80).dim=[1,1];
bio(80).sigWidth=1;
bio(80).sigAddress='&random_walk_B.Product1_f';
...
bio(81).dim=[1,1];
bio(81).sigWidth=1;
bio(81).sigAddress='&random_walk_B.Product2_m';
...
bio(82).dim=[1,1];
bio(82).sigWidth=1;
bio(82).sigAddress='&random_walk_B.Product3_m';
...
bio(83).dim=[1,1];
bio(83).sigWidth=1;
bio(83).sigAddress='&random_walk_B.Add_ci';
...
bio(84).dim=[1,1];
bio(84).sigWidth=1;
bio(84).sigAddress='&random_walk_B.Subtract_j';
...
bio(85).dim=[1,1];
bio(85).sigWidth=1;
bio(85).sigAddress='&random_walk_B.cos_o';
...
bio(86).dim=[1,1];
bio(86).sigWidth=1;
bio(86).sigAddress='&random_walk_B.sin_e';
...
bio(87).dim=[1,1];
bio(87).sigWidth=1;
bio(87).sigAddress='&random_walk_B.Compare_a';
...
bio(88).dim=[1,1];
bio(88).sigWidth=1;
bio(88).sigAddress='&random_walk_B.Compare_h2';
...
bio(89).dim=[2,1];
bio(89).sigWidth=2;
bio(89).sigAddress='&random_walk_B.Gain_o[0]';
...
bio(90).dim=[2,1];
bio(90).sigWidth=2;
bio(90).sigAddress='&random_walk_B.MatrixMultiply_k[0]';
...
bio(91).dim=[1,1];
bio(91).sigWidth=1;
bio(91).sigAddress='&random_walk_B.Clock';
...
bio(92).dim=[1,1];
bio(92).sigWidth=1;
bio(92).sigAddress='&random_walk_B.LogicalOperator';
...
bio(93).dim=[1,1];
bio(93).sigWidth=1;
bio(93).sigAddress='&random_walk_B.LogicalOperator1';
...
bio(94).dim=[1,1];
bio(94).sigWidth=1;
bio(94).sigAddress='&random_walk_B.LogicalOperator2';
...
bio(95).dim=[1,1];
bio(95).sigWidth=1;
bio(95).sigAddress='&random_walk_B.Memory';
...
bio(96).dim=[1,1];
bio(96).sigWidth=1;
bio(96).sigAddress='&random_walk_B.RelationalOperator';
...
bio(97).dim=[1,1];
bio(97).sigWidth=1;
bio(97).sigAddress='&random_walk_B.Sum';
...
bio(98).dim=[1,1];
bio(98).sigWidth=1;
bio(98).sigAddress='&random_walk_B.Compare_j';
...
bio(99).dim=[1,1];
bio(99).sigWidth=1;
bio(99).sigAddress='&random_walk_B.Compare_m';
...
bio(100).dim=[1,1];
bio(100).sigWidth=1;
bio(100).sigAddress='&random_walk_B.FixPtRelationalOperator_b';
...
bio(101).dim=[1,1];
bio(101).sigWidth=1;
bio(101).sigAddress='&random_walk_B.Uk1_i';
...
bio(102).dim=[1,1];
bio(102).sigWidth=1;
bio(102).sigAddress='&random_walk_B.FixPtRelationalOperator_d';
...
bio(103).dim=[1,1];
bio(103).sigWidth=1;
bio(103).sigAddress='&random_walk_B.Uk1_n';
...
bio(104).dim=[1,1];
bio(104).sigWidth=1;
bio(104).sigAddress='&random_walk_B.Abs2';
...
bio(105).dim=[1,1];
bio(105).sigWidth=1;
bio(105).sigAddress='&random_walk_B.Abs3';
...
bio(106).dim=[1,1];
bio(106).sigWidth=1;
bio(106).sigAddress='&random_walk_B.LogicalOperator1_d';
...
bio(107).dim=[1,1];
bio(107).sigWidth=1;
bio(107).sigAddress='&random_walk_B.Gain1_n';
...
bio(108).dim=[1,1];
bio(108).sigWidth=1;
bio(108).sigAddress='&random_walk_B.Gain2';
...
bio(109).dim=[1,1];
bio(109).sigWidth=1;
bio(109).sigAddress='&random_walk_B.Gain3';
...
bio(110).dim=[1,1];
bio(110).sigWidth=1;
bio(110).sigAddress='&random_walk_B.Gain4';
...
bio(111).dim=[1,1];
bio(111).sigWidth=1;
bio(111).sigAddress='&random_walk_B.Product_n';
...
bio(112).dim=[1,1];
bio(112).sigWidth=1;
bio(112).sigAddress='&random_walk_B.Product1_j';
...
bio(113).dim=[1,1];
bio(113).sigWidth=1;
bio(113).sigAddress='&random_walk_B.Saturation';
...
bio(114).dim=[1,1];
bio(114).sigWidth=1;
bio(114).sigAddress='&random_walk_B.Saturation1';
...
bio(115).dim=[1,1];
bio(115).sigWidth=1;
bio(115).sigAddress='&random_walk_B.Add_c';
...
bio(116).dim=[1,1];
bio(116).sigWidth=1;
bio(116).sigAddress='&random_walk_B.Add1_d';
...
bio(117).dim=[2,1];
bio(117).sigWidth=2;
bio(117).sigAddress='&random_walk_B.Logic[0]';
...
bio(118).dim=[1,1];
bio(118).sigWidth=1;
bio(118).sigAddress='&random_walk_B.Memory_jh';
...
bio(119).dim=[1,1];
bio(119).sigWidth=1;
bio(119).sigAddress='&random_walk_B.Clock_m';
...
bio(120).dim=[1,1];
bio(120).sigWidth=1;
bio(120).sigAddress='&random_walk_B.LogicalOperator_if';
...
bio(121).dim=[1,1];
bio(121).sigWidth=1;
bio(121).sigAddress='&random_walk_B.LogicalOperator1_p';
...
bio(122).dim=[1,1];
bio(122).sigWidth=1;
bio(122).sigAddress='&random_walk_B.LogicalOperator2_o';
...
bio(123).dim=[1,1];
bio(123).sigWidth=1;
bio(123).sigAddress='&random_walk_B.Memory_i';
...
bio(124).dim=[1,1];
bio(124).sigWidth=1;
bio(124).sigAddress='&random_walk_B.RelationalOperator_c';
...
bio(125).dim=[1,1];
bio(125).sigWidth=1;
bio(125).sigAddress='&random_walk_B.Sum_hd';
...
bio(126).dim=[1,1];
bio(126).sigWidth=1;
bio(126).sigAddress='&random_walk_B.Clock_n';
...
bio(127).dim=[1,1];
bio(127).sigWidth=1;
bio(127).sigAddress='&random_walk_B.LogicalOperator_e';
...
bio(128).dim=[1,1];
bio(128).sigWidth=1;
bio(128).sigAddress='&random_walk_B.LogicalOperator1_pq';
...
bio(129).dim=[1,1];
bio(129).sigWidth=1;
bio(129).sigAddress='&random_walk_B.LogicalOperator2_mi';
...
bio(130).dim=[1,1];
bio(130).sigWidth=1;
bio(130).sigAddress='&random_walk_B.Memory_j';
...
bio(131).dim=[1,1];
bio(131).sigWidth=1;
bio(131).sigAddress='&random_walk_B.RelationalOperator_l';
...
bio(132).dim=[1,1];
bio(132).sigWidth=1;
bio(132).sigAddress='&random_walk_B.Sum_ms';
...
bio(133).dim=[1,1];
bio(133).sigWidth=1;
bio(133).sigAddress='&random_walk_B.Clock_e';
...
bio(134).dim=[1,1];
bio(134).sigWidth=1;
bio(134).sigAddress='&random_walk_B.LogicalOperator_b';
...
bio(135).dim=[1,1];
bio(135).sigWidth=1;
bio(135).sigAddress='&random_walk_B.LogicalOperator1_i';
...
bio(136).dim=[1,1];
bio(136).sigWidth=1;
bio(136).sigAddress='&random_walk_B.LogicalOperator2_j';
...
bio(138).dim=[1,1];
bio(138).sigWidth=1;
bio(138).sigAddress='&random_walk_B.RelationalOperator_pq';
...
bio(139).dim=[1,1];
bio(139).sigWidth=1;
bio(139).sigAddress='&random_walk_B.Sum_o';
...
bio(140).dim=[1,1];
bio(140).sigWidth=1;
bio(140).sigAddress='&random_walk_B.FixPtRelationalOperator_m';
...
bio(141).dim=[1,1];
bio(141).sigWidth=1;
bio(141).sigAddress='&random_walk_B.Uk1_j';
...
bio(142).dim=[1,1];
bio(142).sigWidth=1;
bio(142).sigAddress='&random_walk_B.Clock_i';
...
bio(143).dim=[1,1];
bio(143).sigWidth=1;
bio(143).sigAddress='&random_walk_B.LogicalOperator_ai';
...
bio(144).dim=[1,1];
bio(144).sigWidth=1;
bio(144).sigAddress='&random_walk_B.LogicalOperator1_f';
...
bio(145).dim=[1,1];
bio(145).sigWidth=1;
bio(145).sigAddress='&random_walk_B.LogicalOperator2_m';
...
bio(146).dim=[1,1];
bio(146).sigWidth=1;
bio(146).sigAddress='&random_walk_B.LogicalOperator3';
...
bio(147).dim=[1,1];
bio(147).sigWidth=1;
bio(147).sigAddress='&random_walk_B.LogicalOperator4';
...
bio(148).dim=[1,1];
bio(148).sigWidth=1;
bio(148).sigAddress='&random_walk_B.LogicalOperator5';
...
bio(149).dim=[1,1];
bio(149).sigWidth=1;
bio(149).sigAddress='&random_walk_B.Memory_e5';
...
bio(150).dim=[1,1];
bio(150).sigWidth=1;
bio(150).sigAddress='&random_walk_B.RelationalOperator_p';
...
bio(151).dim=[1,1];
bio(151).sigWidth=1;
bio(151).sigAddress='&random_walk_B.Sum_m';
...
bio(152).dim=[1,1];
bio(152).sigWidth=1;
bio(152).sigAddress='&random_walk_B.SampleandHold_g.In';
...
bio(153).dim=[1,1];
bio(153).sigWidth=1;
bio(153).sigAddress='&random_walk_B.Clock_k';
...
bio(154).dim=[1,1];
bio(154).sigWidth=1;
bio(154).sigAddress='&random_walk_B.RelationalOperator_o';
...
bio(155).dim=[1,1];
bio(155).sigWidth=1;
bio(155).sigAddress='&random_walk_B.Sum_l';
...
bio(156).dim=[1,1];
bio(156).sigWidth=1;
bio(156).sigAddress='&random_walk_B.Derivative';
...
bio(157).dim=[1,1];
bio(157).sigWidth=1;
bio(157).sigAddress='&random_walk_B.dG';
...
bio(158).dim=[1,1];
bio(158).sigWidth=1;
bio(158).sigAddress='&random_walk_B.DigitalFilter';
...
bio(159).dim=[1,1];
bio(159).sigWidth=1;
bio(159).sigAddress='&random_walk_B.DigitalFilter2';
...
bio(160).dim=[1,1];
bio(160).sigWidth=1;
bio(160).sigAddress='&random_walk_B.Derivative_d';
...
bio(161).dim=[1,1];
bio(161).sigWidth=1;
bio(161).sigAddress='&random_walk_B.dG_d';
...
bio(162).dim=[1,1];
bio(162).sigWidth=1;
bio(162).sigAddress='&random_walk_B.DigitalFilter_c';
...
bio(163).dim=[1,1];
bio(163).sigWidth=1;
bio(163).sigAddress='&random_walk_B.DigitalFilter2_k';
...
bio(164).dim=[1,1];
bio(164).sigWidth=1;
bio(164).sigAddress='&random_walk_B.sqrtu1u1u2u2';
...
bio(165).dim=[1,1];
bio(165).sigWidth=1;
bio(165).sigAddress='&random_walk_B.Product_l';
...
bio(166).dim=[1,1];
bio(166).sigWidth=1;
bio(166).sigAddress='&random_walk_B.Product1_m';
...
bio(167).dim=[1,1];
bio(167).sigWidth=1;
bio(167).sigAddress='&random_walk_B.Sum_h';
...
bio(168).dim=[1,1];
bio(168).sigWidth=1;
bio(168).sigAddress='&random_walk_B.TrigonometricFunction_g';
...
bio(169).dim=[1,1];
bio(169).sigWidth=1;
bio(169).sigAddress='&random_walk_B.TrigonometricFunction1_p';
...
bio(170).dim=[1,1];
bio(170).sigWidth=1;
bio(170).sigAddress='&random_walk_B.TrigonometricFunction2_i';
...
bio(171).dim=[1,1];
bio(171).sigWidth=1;
bio(171).sigAddress='&random_walk_B.ForIterator';
...
bio(172).dim=[1,1];
bio(172).sigWidth=1;
bio(172).sigAddress='&random_walk_B.SerialConverter';
...
bio(173).dim=[1,1];
bio(173).sigWidth=1;
bio(173).sigAddress='&random_walk_B.ToBits_o1';
...
bio(174).dim=[1,1];
bio(174).sigWidth=1;
bio(174).sigAddress='&random_walk_B.ToBits_o2';
...
bio(175).dim=[1,1];
bio(175).sigWidth=1;
bio(175).sigAddress='&random_walk_B.ToBits_o3';
...
bio(176).dim=[1,1];
bio(176).sigWidth=1;
bio(176).sigAddress='&random_walk_B.ToBits_o4';
...
bio(177).dim=[1,1];
bio(177).sigWidth=1;
bio(177).sigAddress='&random_walk_B.ToBits_o5';
...
bio(178).dim=[1,1];
bio(178).sigWidth=1;
bio(178).sigAddress='&random_walk_B.ToBits_o6';
...
bio(179).dim=[1,1];
bio(179).sigWidth=1;
bio(179).sigAddress='&random_walk_B.ToBits_o7';
...
bio(180).dim=[1,1];
bio(180).sigWidth=1;
bio(180).sigAddress='&random_walk_B.ToBits_o8';
...
bio(181).dim=[1,1];
bio(181).sigWidth=1;
bio(181).sigAddress='&random_walk_B.ToBits1_o1';
...
bio(182).dim=[1,1];
bio(182).sigWidth=1;
bio(182).sigAddress='&random_walk_B.ToBits1_o2';
...
bio(183).dim=[1,1];
bio(183).sigWidth=1;
bio(183).sigAddress='&random_walk_B.ToBits1_o3';
...
bio(184).dim=[1,1];
bio(184).sigWidth=1;
bio(184).sigAddress='&random_walk_B.ToBits1_o4';
...
bio(185).dim=[1,1];
bio(185).sigWidth=1;
bio(185).sigAddress='&random_walk_B.ToBits1_o5';
...
bio(186).dim=[1,1];
bio(186).sigWidth=1;
bio(186).sigAddress='&random_walk_B.ToBits1_o6';
...
bio(187).dim=[1,1];
bio(187).sigWidth=1;
bio(187).sigAddress='&random_walk_B.ToBits1_o7';
...
bio(188).dim=[1,1];
bio(188).sigWidth=1;
bio(188).sigAddress='&random_walk_B.ToBits1_o8';
...
bio(189).dim=[1,1];
bio(189).sigWidth=1;
bio(189).sigAddress='&random_walk_B.xPCTargetTime';
...
bio(190).dim=[1,1];
bio(190).sigWidth=1;
bio(190).sigAddress='&random_walk_B.Add_j';
...
bio(191).dim=[1,1];
bio(191).sigWidth=1;
bio(191).sigAddress='&random_walk_B.Add1_oz';
...
bio(192).dim=[1,1];
bio(192).sigWidth=1;
bio(192).sigAddress='&random_walk_B.Switch_j';
...
bio(193).dim=[2,2];
bio(193).sigWidth=4;
bio(193).sigAddress='&random_walk_B.MatrixConcatenate2[0]';
...
bio(194).dim=[2,2];
bio(194).sigWidth=4;
bio(194).sigAddress='&random_walk_B.MatrixConcatenate2[0]';
...
bio(195).dim=[2,2];
bio(195).sigWidth=4;
bio(195).sigAddress='&random_walk_B.MatrixConcatenate2[0]';
...
bio(196).dim=[2,2];
bio(196).sigWidth=4;
bio(196).sigAddress='&random_walk_B.MatrixConcatenate2[0]';
...
bio(197).dim=[2,2];
bio(197).sigWidth=4;
bio(197).sigAddress='&random_walk_B.MatrixConcatenate2[0]';
...
bio(198).dim=[2,2];
bio(198).sigWidth=4;
bio(198).sigAddress='&random_walk_B.MatrixConcatenate2[0]';
...
bio(199).dim=[1,1];
bio(199).sigWidth=1;
bio(199).sigAddress='&random_walk_B.Product';
...
bio(200).dim=[1,1];
bio(200).sigWidth=1;
bio(200).sigAddress='&random_walk_B.Product1';
...
bio(201).dim=[1,1];
bio(201).sigWidth=1;
bio(201).sigAddress='&random_walk_B.Product2';
...
bio(202).dim=[1,1];
bio(202).sigWidth=1;
bio(202).sigAddress='&random_walk_B.Product3';
...
bio(203).dim=[1,1];
bio(203).sigWidth=1;
bio(203).sigAddress='&random_walk_B.Sum1_g';
...
bio(204).dim=[1,1];
bio(204).sigWidth=1;
bio(204).sigAddress='&random_walk_B.Sum2';
...
bio(205).dim=[1,1];
bio(205).sigWidth=1;
bio(205).sigAddress='&random_walk_B.Sum3_i';
...
bio(206).dim=[1,1];
bio(206).sigWidth=1;
bio(206).sigAddress='&random_walk_B.Sum4';
...
bio(207).dim=[1,1];
bio(207).sigWidth=1;
bio(207).sigAddress='&random_walk_B.TrigonometricFunction';
...
bio(208).dim=[1,1];
bio(208).sigWidth=1;
bio(208).sigAddress='&random_walk_B.TrigonometricFunction1';
...
bio(209).dim=[1,1];
bio(209).sigWidth=1;
bio(209).sigAddress='&random_walk_B.TrigonometricFunction2';
...
bio(210).dim=[1,1];
bio(210).sigWidth=1;
bio(210).sigAddress='&random_walk_B.TrigonometricFunction3';
...
bio(211).dim=[1,1];
bio(211).sigWidth=1;
bio(211).sigAddress='&random_walk_B.dX';
...
bio(212).dim=[1,1];
bio(212).sigWidth=1;
bio(212).sigAddress='&random_walk_B.dY';
...
bio(213).dim=[1,1];
bio(213).sigWidth=1;
bio(213).sigAddress='&random_walk_B.dZ';
...
bio(214).dim=[1,1];
bio(214).sigWidth=1;
bio(214).sigAddress='&random_walk_B.product1';
...
bio(215).dim=[1,1];
bio(215).sigWidth=1;
bio(215).sigAddress='&random_walk_B.product2';
...
bio(216).dim=[1,1];
bio(216).sigWidth=1;
bio(216).sigAddress='&random_walk_B.product3';
...
bio(217).dim=[1,1];
bio(217).sigWidth=1;
bio(217).sigAddress='&random_walk_B.product4';
...
bio(218).dim=[1,1];
bio(218).sigWidth=1;
bio(218).sigAddress='&random_walk_B.Add1';
...
bio(219).dim=[1,1];
bio(219).sigWidth=1;
bio(219).sigAddress='&random_walk_B.Add2';
...
bio(220).dim=[1,1];
bio(220).sigWidth=1;
bio(220).sigAddress='&random_walk_B.Add3';
...
bio(221).dim=[1,1];
bio(221).sigWidth=1;
bio(221).sigAddress='&random_walk_B.Add4';
...
bio(222).dim=[1,1];
bio(222).sigWidth=1;
bio(222).sigAddress='&random_walk_B.AddX';
...
bio(223).dim=[1,1];
bio(223).sigWidth=1;
bio(223).sigAddress='&random_walk_B.AddX1';
...
bio(224).dim=[1,1];
bio(224).sigWidth=1;
bio(224).sigAddress='&random_walk_B.AddX2';
...
bio(225).dim=[1,1];
bio(225).sigWidth=1;
bio(225).sigAddress='&random_walk_B.x_k';
...
bio(226).dim=[1,1];
bio(226).sigWidth=1;
bio(226).sigAddress='&random_walk_B.y';
...
bio(227).dim=[1,1];
bio(227).sigWidth=1;
bio(227).sigAddress='&random_walk_B.z';
...
bio(228).dim=[1,1];
bio(228).sigWidth=1;
bio(228).sigAddress='&random_walk_B.dX_o';
...
bio(229).dim=[1,1];
bio(229).sigWidth=1;
bio(229).sigAddress='&random_walk_B.dY_g';
...
bio(230).dim=[1,1];
bio(230).sigWidth=1;
bio(230).sigAddress='&random_walk_B.dZ_o';
...
bio(231).dim=[1,1];
bio(231).sigWidth=1;
bio(231).sigAddress='&random_walk_B.product1_i';
...
bio(232).dim=[1,1];
bio(232).sigWidth=1;
bio(232).sigAddress='&random_walk_B.product2_p';
...
bio(233).dim=[1,1];
bio(233).sigWidth=1;
bio(233).sigAddress='&random_walk_B.product3_c';
...
bio(234).dim=[1,1];
bio(234).sigWidth=1;
bio(234).sigAddress='&random_walk_B.product4_j';
...
bio(235).dim=[1,1];
bio(235).sigWidth=1;
bio(235).sigAddress='&random_walk_B.Add1_m';
...
bio(236).dim=[1,1];
bio(236).sigWidth=1;
bio(236).sigAddress='&random_walk_B.Add2_e';
...
bio(237).dim=[1,1];
bio(237).sigWidth=1;
bio(237).sigAddress='&random_walk_B.Add3_h';
...
bio(238).dim=[1,1];
bio(238).sigWidth=1;
bio(238).sigAddress='&random_walk_B.Add4_e';
...
bio(239).dim=[1,1];
bio(239).sigWidth=1;
bio(239).sigAddress='&random_walk_B.AddX_o';
...
bio(240).dim=[1,1];
bio(240).sigWidth=1;
bio(240).sigAddress='&random_walk_B.AddX1_l';
...
bio(241).dim=[1,1];
bio(241).sigWidth=1;
bio(241).sigAddress='&random_walk_B.AddX2_l';
...
bio(242).dim=[1,1];
bio(242).sigWidth=1;
bio(242).sigAddress='&random_walk_B.x_m';
...
bio(243).dim=[1,1];
bio(243).sigWidth=1;
bio(243).sigAddress='&random_walk_B.y_m';
...
bio(244).dim=[1,1];
bio(244).sigWidth=1;
bio(244).sigAddress='&random_walk_B.z_e';
...
bio(245).dim=[1,1];
bio(245).sigWidth=1;
bio(245).sigAddress='&random_walk_B.dX_p';
...
bio(246).dim=[1,1];
bio(246).sigWidth=1;
bio(246).sigAddress='&random_walk_B.dY_a';
...
bio(247).dim=[1,1];
bio(247).sigWidth=1;
bio(247).sigAddress='&random_walk_B.dZ_m';
...
bio(248).dim=[1,1];
bio(248).sigWidth=1;
bio(248).sigAddress='&random_walk_B.product1_a';
...
bio(249).dim=[1,1];
bio(249).sigWidth=1;
bio(249).sigAddress='&random_walk_B.product2_e';
...
bio(250).dim=[1,1];
bio(250).sigWidth=1;
bio(250).sigAddress='&random_walk_B.product3_o';
...
bio(251).dim=[1,1];
bio(251).sigWidth=1;
bio(251).sigAddress='&random_walk_B.product4_o';
...
bio(252).dim=[1,1];
bio(252).sigWidth=1;
bio(252).sigAddress='&random_walk_B.Add1_mk';
...
bio(253).dim=[1,1];
bio(253).sigWidth=1;
bio(253).sigAddress='&random_walk_B.Add2_k';
...
bio(254).dim=[1,1];
bio(254).sigWidth=1;
bio(254).sigAddress='&random_walk_B.Add3_c';
...
bio(255).dim=[1,1];
bio(255).sigWidth=1;
bio(255).sigAddress='&random_walk_B.Add4_el';
...
bio(256).dim=[1,1];
bio(256).sigWidth=1;
bio(256).sigAddress='&random_walk_B.AddX_d';
...
bio(257).dim=[1,1];
bio(257).sigWidth=1;
bio(257).sigAddress='&random_walk_B.AddX1_p';
...
bio(258).dim=[1,1];
bio(258).sigWidth=1;
bio(258).sigAddress='&random_walk_B.AddX2_b';
...
bio(259).dim=[1,1];
bio(259).sigWidth=1;
bio(259).sigAddress='&random_walk_B.x_o';
...
bio(260).dim=[1,1];
bio(260).sigWidth=1;
bio(260).sigAddress='&random_walk_B.y_f';
...
bio(261).dim=[1,1];
bio(261).sigWidth=1;
bio(261).sigAddress='&random_walk_B.z_g';
...
bio(262).dim=[1,1];
bio(262).sigWidth=1;
bio(262).sigAddress='&random_walk_B.dX_b';
...
bio(263).dim=[1,1];
bio(263).sigWidth=1;
bio(263).sigAddress='&random_walk_B.dY_n';
...
bio(264).dim=[1,1];
bio(264).sigWidth=1;
bio(264).sigAddress='&random_walk_B.dZ_n';
...
bio(265).dim=[1,1];
bio(265).sigWidth=1;
bio(265).sigAddress='&random_walk_B.product1_g';
...
bio(266).dim=[1,1];
bio(266).sigWidth=1;
bio(266).sigAddress='&random_walk_B.product2_d';
...
bio(267).dim=[1,1];
bio(267).sigWidth=1;
bio(267).sigAddress='&random_walk_B.product3_i';
...
bio(268).dim=[1,1];
bio(268).sigWidth=1;
bio(268).sigAddress='&random_walk_B.product4_i';
...
bio(269).dim=[1,1];
bio(269).sigWidth=1;
bio(269).sigAddress='&random_walk_B.Add1_c';
...
bio(270).dim=[1,1];
bio(270).sigWidth=1;
bio(270).sigAddress='&random_walk_B.Add2_g';
...
bio(271).dim=[1,1];
bio(271).sigWidth=1;
bio(271).sigAddress='&random_walk_B.Add3_hn';
...
bio(272).dim=[1,1];
bio(272).sigWidth=1;
bio(272).sigAddress='&random_walk_B.Add4_o';
...
bio(273).dim=[1,1];
bio(273).sigWidth=1;
bio(273).sigAddress='&random_walk_B.AddX_b';
...
bio(274).dim=[1,1];
bio(274).sigWidth=1;
bio(274).sigAddress='&random_walk_B.AddX1_lw';
...
bio(275).dim=[1,1];
bio(275).sigWidth=1;
bio(275).sigAddress='&random_walk_B.AddX2_a';
...
bio(276).dim=[1,1];
bio(276).sigWidth=1;
bio(276).sigAddress='&random_walk_B.x_mw';
...
bio(277).dim=[1,1];
bio(277).sigWidth=1;
bio(277).sigAddress='&random_walk_B.y_k';
...
bio(278).dim=[1,1];
bio(278).sigWidth=1;
bio(278).sigAddress='&random_walk_B.z_m';
...
bio(279).dim=[1,1];
bio(279).sigWidth=1;
bio(279).sigAddress='&random_walk_B.dX_l';
...
bio(280).dim=[1,1];
bio(280).sigWidth=1;
bio(280).sigAddress='&random_walk_B.dY_o';
...
bio(281).dim=[1,1];
bio(281).sigWidth=1;
bio(281).sigAddress='&random_walk_B.dZ_j';
...
bio(282).dim=[1,1];
bio(282).sigWidth=1;
bio(282).sigAddress='&random_walk_B.product1_e';
...
bio(283).dim=[1,1];
bio(283).sigWidth=1;
bio(283).sigAddress='&random_walk_B.product2_c';
...
bio(284).dim=[1,1];
bio(284).sigWidth=1;
bio(284).sigAddress='&random_walk_B.product3_m';
...
bio(285).dim=[1,1];
bio(285).sigWidth=1;
bio(285).sigAddress='&random_walk_B.product4_p';
...
bio(286).dim=[1,1];
bio(286).sigWidth=1;
bio(286).sigAddress='&random_walk_B.Add1_o';
...
bio(287).dim=[1,1];
bio(287).sigWidth=1;
bio(287).sigAddress='&random_walk_B.Add2_c';
...
bio(288).dim=[1,1];
bio(288).sigWidth=1;
bio(288).sigAddress='&random_walk_B.Add3_j';
...
bio(289).dim=[1,1];
bio(289).sigWidth=1;
bio(289).sigAddress='&random_walk_B.Add4_b';
...
bio(290).dim=[1,1];
bio(290).sigWidth=1;
bio(290).sigAddress='&random_walk_B.AddX_f';
...
bio(291).dim=[1,1];
bio(291).sigWidth=1;
bio(291).sigAddress='&random_walk_B.AddX1_o';
...
bio(292).dim=[1,1];
bio(292).sigWidth=1;
bio(292).sigAddress='&random_walk_B.AddX2_f';
...
bio(293).dim=[1,1];
bio(293).sigWidth=1;
bio(293).sigAddress='&random_walk_B.x';
...
bio(294).dim=[1,1];
bio(294).sigWidth=1;
bio(294).sigAddress='&random_walk_B.y_g';
...
bio(295).dim=[1,1];
bio(295).sigWidth=1;
bio(295).sigAddress='&random_walk_B.z_l';
...
bio(296).dim=[1,1];
bio(296).sigWidth=1;
bio(296).sigAddress='&random_walk_B.dX_m';
...
bio(297).dim=[1,1];
bio(297).sigWidth=1;
bio(297).sigAddress='&random_walk_B.dY_f';
...
bio(298).dim=[1,1];
bio(298).sigWidth=1;
bio(298).sigAddress='&random_walk_B.dZ_g';
...
bio(299).dim=[1,1];
bio(299).sigWidth=1;
bio(299).sigAddress='&random_walk_B.product1_f';
...
bio(300).dim=[1,1];
bio(300).sigWidth=1;
bio(300).sigAddress='&random_walk_B.product2_l';
...
bio(301).dim=[1,1];
bio(301).sigWidth=1;
bio(301).sigAddress='&random_walk_B.product3_b';
...
bio(302).dim=[1,1];
bio(302).sigWidth=1;
bio(302).sigAddress='&random_walk_B.product4_d';
...
bio(303).dim=[1,1];
bio(303).sigWidth=1;
bio(303).sigAddress='&random_walk_B.Add1_b';
...
bio(304).dim=[1,1];
bio(304).sigWidth=1;
bio(304).sigAddress='&random_walk_B.Add2_b';
...
bio(305).dim=[1,1];
bio(305).sigWidth=1;
bio(305).sigAddress='&random_walk_B.Add3_e';
...
bio(306).dim=[1,1];
bio(306).sigWidth=1;
bio(306).sigAddress='&random_walk_B.Add4_bs';
...
bio(307).dim=[1,1];
bio(307).sigWidth=1;
bio(307).sigAddress='&random_walk_B.AddX_j';
...
bio(308).dim=[1,1];
bio(308).sigWidth=1;
bio(308).sigAddress='&random_walk_B.AddX1_b';
...
bio(309).dim=[1,1];
bio(309).sigWidth=1;
bio(309).sigAddress='&random_walk_B.AddX2_e';
...
bio(310).dim=[1,1];
bio(310).sigWidth=1;
bio(310).sigAddress='&random_walk_B.x_f';
...
bio(311).dim=[1,1];
bio(311).sigWidth=1;
bio(311).sigAddress='&random_walk_B.y_e';
...
bio(312).dim=[1,1];
bio(312).sigWidth=1;
bio(312).sigAddress='&random_walk_B.z_o';
...
bio(313).dim=[1,1];
bio(313).sigWidth=1;
bio(313).sigAddress='&random_walk_B.dX_f';
...
bio(314).dim=[1,1];
bio(314).sigWidth=1;
bio(314).sigAddress='&random_walk_B.dY_b';
...
bio(315).dim=[1,1];
bio(315).sigWidth=1;
bio(315).sigAddress='&random_walk_B.dZ_f';
...
bio(316).dim=[1,1];
bio(316).sigWidth=1;
bio(316).sigAddress='&random_walk_B.product1_ae';
...
bio(317).dim=[1,1];
bio(317).sigWidth=1;
bio(317).sigAddress='&random_walk_B.product2_g';
...
bio(318).dim=[1,1];
bio(318).sigWidth=1;
bio(318).sigAddress='&random_walk_B.product3_d';
...
bio(319).dim=[1,1];
bio(319).sigWidth=1;
bio(319).sigAddress='&random_walk_B.product4_j1';
...
bio(320).dim=[1,1];
bio(320).sigWidth=1;
bio(320).sigAddress='&random_walk_B.Add1_l';
...
bio(321).dim=[1,1];
bio(321).sigWidth=1;
bio(321).sigAddress='&random_walk_B.Add2_l';
...
bio(322).dim=[1,1];
bio(322).sigWidth=1;
bio(322).sigAddress='&random_walk_B.Add3_p';
...
bio(323).dim=[1,1];
bio(323).sigWidth=1;
bio(323).sigAddress='&random_walk_B.Add4_k';
...
bio(324).dim=[1,1];
bio(324).sigWidth=1;
bio(324).sigAddress='&random_walk_B.AddX_on';
...
bio(325).dim=[1,1];
bio(325).sigWidth=1;
bio(325).sigAddress='&random_walk_B.AddX1_j';
...
bio(326).dim=[1,1];
bio(326).sigWidth=1;
bio(326).sigAddress='&random_walk_B.AddX2_h';
...
bio(327).dim=[1,1];
bio(327).sigWidth=1;
bio(327).sigAddress='&random_walk_B.x_h';
...
bio(328).dim=[1,1];
bio(328).sigWidth=1;
bio(328).sigAddress='&random_walk_B.y_j';
...
bio(329).dim=[1,1];
bio(329).sigWidth=1;
bio(329).sigAddress='&random_walk_B.z_n';
...
bio(330).dim=[1,1];
bio(330).sigWidth=1;
bio(330).sigAddress='&random_walk_B.dX_bi';
...
bio(331).dim=[1,1];
bio(331).sigWidth=1;
bio(331).sigAddress='&random_walk_B.dY_na';
...
bio(332).dim=[1,1];
bio(332).sigWidth=1;
bio(332).sigAddress='&random_walk_B.dZ_i';
...
bio(333).dim=[1,1];
bio(333).sigWidth=1;
bio(333).sigAddress='&random_walk_B.product1_o';
...
bio(334).dim=[1,1];
bio(334).sigWidth=1;
bio(334).sigAddress='&random_walk_B.product2_cg';
...
bio(335).dim=[1,1];
bio(335).sigWidth=1;
bio(335).sigAddress='&random_walk_B.product3_im';
...
bio(336).dim=[1,1];
bio(336).sigWidth=1;
bio(336).sigAddress='&random_walk_B.product4_p0';
...
bio(337).dim=[1,1];
bio(337).sigWidth=1;
bio(337).sigAddress='&random_walk_B.Add1_n';
...
bio(338).dim=[1,1];
bio(338).sigWidth=1;
bio(338).sigAddress='&random_walk_B.Add2_d';
...
bio(339).dim=[1,1];
bio(339).sigWidth=1;
bio(339).sigAddress='&random_walk_B.Add3_a';
...
bio(340).dim=[1,1];
bio(340).sigWidth=1;
bio(340).sigAddress='&random_walk_B.Add4_h';
...
bio(341).dim=[1,1];
bio(341).sigWidth=1;
bio(341).sigAddress='&random_walk_B.AddX_jl';
...
bio(342).dim=[1,1];
bio(342).sigWidth=1;
bio(342).sigAddress='&random_walk_B.AddX1_bw';
...
bio(343).dim=[1,1];
bio(343).sigWidth=1;
bio(343).sigAddress='&random_walk_B.AddX2_g';
...
bio(344).dim=[1,1];
bio(344).sigWidth=1;
bio(344).sigAddress='&random_walk_B.x_l';
...
bio(345).dim=[1,1];
bio(345).sigWidth=1;
bio(345).sigAddress='&random_walk_B.y_o';
...
bio(346).dim=[1,1];
bio(346).sigWidth=1;
bio(346).sigAddress='&random_walk_B.z_j';
...
bio(347).dim=[2,2];
bio(347).sigWidth=4;
bio(347).sigAddress='&random_walk_B.MathFunction[0]';
...
bio(348).dim=[1,1];
bio(348).sigWidth=1;
bio(348).sigAddress='&random_walk_B.Compare';
...
bio(349).dim=[1,1];
bio(349).sigWidth=1;
bio(349).sigAddress='&random_walk_B.EnabledSubsystem.In1';
...
bio(350).dim=[1,1];
bio(350).sigWidth=1;
bio(350).sigAddress='&random_walk_B.Compare_my';
...
bio(351).dim=[1,1];
bio(351).sigWidth=1;
bio(351).sigAddress='&random_walk_B.Compare_n';
...
bio(352).dim=[1,1];
bio(352).sigWidth=1;
bio(352).sigAddress='&random_walk_B.Compare_o';
...
bio(353).dim=[1,1];
bio(353).sigWidth=1;
bio(353).sigAddress='&random_walk_B.Compare_d';
...
bio(354).dim=[1,1];
bio(354).sigWidth=1;
bio(354).sigAddress='&random_walk_B.Compare_l';
...
bio(355).dim=[1,1];
bio(355).sigWidth=1;
bio(355).sigAddress='&random_walk_B.EnabledSubsystem_d.In1';
...
bio(356).dim=[1,1];
bio(356).sigWidth=1;
bio(356).sigAddress='&random_walk_B.Compare_f';
...
bio(357).dim=[1,1];
bio(357).sigWidth=1;
bio(357).sigAddress='&random_walk_B.EnabledSubsystem_n.In1';
...
bio(358).dim=[1,1];
bio(358).sigWidth=1;
bio(358).sigAddress='&random_walk_B.Compare_d1';
...
bio(359).dim=[1,1];
bio(359).sigWidth=1;
bio(359).sigAddress='&random_walk_B.EnabledSubsystem_o.In1';
...
bio(360).dim=[1,1];
bio(360).sigWidth=1;
bio(360).sigAddress='&random_walk_B.Compare_g';
...
bio(361).dim=[1,1];
bio(361).sigWidth=1;
bio(361).sigAddress='&random_walk_B.Compare_j0';
...
bio(362).dim=[1,1];
bio(362).sigWidth=1;
bio(362).sigAddress='&random_walk_B.FixPtRelationalOperator';
...
bio(363).dim=[1,1];
bio(363).sigWidth=1;
bio(363).sigAddress='&random_walk_B.Uk1';
...
bio(364).dim=[1,1];
bio(364).sigWidth=1;
bio(364).sigAddress='&random_walk_B.EnabledSubsystem_l.In1';
...
bio(365).dim=[1,1];
bio(365).sigWidth=1;
bio(365).sigAddress='&random_walk_B.SampleandHold.In';
...
bio(366).dim=[1,1];
bio(366).sigWidth=1;
bio(366).sigAddress='&random_walk_B.ScaleTouSec';
...
bio(367).dim=[1,1];
bio(367).sigWidth=1;
bio(367).sigAddress='&random_walk_B.xPCTargetTime_a';
...
bio(368).dim=[1,1];
bio(368).sigWidth=1;
bio(368).sigAddress='&random_walk_B.Subtract';
...
bio(369).dim=[1,1];
bio(369).sigWidth=1;
bio(369).sigAddress='&random_walk_B.Switch_g';
...
bio(370).dim=[1,1];
bio(370).sigWidth=1;
bio(370).sigAddress='&random_walk_B.Compare_h';
...
bio(371).dim=[1,1];
bio(371).sigWidth=1;
bio(371).sigAddress='&random_walk_B.Compare_h0';
...
bio(372).dim=[1,1];
bio(372).sigWidth=1;
bio(372).sigAddress='&random_walk_B.Compare_nw';
