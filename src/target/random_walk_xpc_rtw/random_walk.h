...
typedef struct {
  ...
  real_T Sum3_i;                       /* '<S71>/Sum3' */
  real_T Sum1_g;                       /* '<S71>/Sum1' */
  real_T TrigonometricFunction1_p;     /* '<S69>/Trigonometric Function1' */
  real_T Sum_h;                        /* '<S69>/Sum' */
  real_T TrigonometricFunction2_i;     /* '<S69>/Trigonometric Function2' */
  real_T sqrtu1u1u2u2;                 /* '<S69>/sqrt(u[1]*u[1] + u[2]*u[2])' */
  real_T Product1_m;                   /* '<S69>/Product1' */
  ...
  real_T DigitalFilter2_k;             /* '<S68>/Digital Filter2' */
  real_T Derivative_d;                 /* '<S68>/Derivative' */
  real_T dG_d;                         /* '<S68>/dG' */
  real_T DigitalFilter_c;              /* '<S68>/Digital Filter' */
  real_T Switch[2];                    /* '<S10>/Switch' */
  real_T Clock_m;                      /* '<S43>/Clock' */
  real_T Clock_i;                      /* '<S47>/Clock' */
  real_T Sum_m;                        /* '<S47>/Sum' */
  real_T Sum_hd;                       /* '<S43>/Sum' */
  real_T Abs2;                         /* '<S40>/Abs2' */
  real_T Abs3;                         /* '<S40>/Abs3' */
  real_T Clock_e;                      /* '<S45>/Clock' */
  real_T Sum_o;                        /* '<S45>/Sum' */
  real_T Clock_n;                      /* '<S44>/Clock' */
  real_T Sum_ms;                       /* '<S44>/Sum' */
  real_T x;                            /* '<S23>/x' */
  real_T x_f;                          /* '<S24>/x' */
  real_T Add;                          /* '<S21>/Add' */
  real_T x_h;                          /* '<S25>/x' */
  ...
  real_T BehaviorRW_o7[4];             /* '<Root>/Behavior RW' */
  real_T BehaviorRW_o8[2];             /* '<Root>/Behavior RW' */
  real_T Switch2[2];                   /* '<S4>/Switch2' */
  real_T MG1;                          /* '<S4>/MG1' */
  real_T MG2;                          /* '<S4>/MG2' */
  real_T Clock_k;                      /* '<S65>/Clock' */
  real_T HiddenBuf_InsertedFor_Sampleand;/* 'synthesized block' */
  real_T Sum_l;                        /* '<S65>/Sum' */
  real_T UniformRandomNumber;          /* '<S6>/Uniform Random Number' */
  real_T Switch_l;                     /* '<S6>/Switch' */
  real_T HiddenBuf_InsertedFor_Samplea_d;/* 'synthesized block' */
  ...
  real_T z_e;                          /* '<S18>/z' */
  real_T Add3_h;                       /* '<S18>/Add3' */
  real_T product2_p;                   /* '<S18>/product2' */
  real_T Add2_e;                       /* '<S18>/Add2' */
  real_T product3_c;                   /* '<S18>/product3' */
  real_T product4_j;                   /* '<S18>/product4' */
  real_T Add4_e;                       /* '<S18>/Add4' */
  real_T product1_i;                   /* '<S18>/product1' */
  real_T dX_o;                         /* '<S18>/dX' */
  real_T AddX_o;                       /* '<S18>/AddX' */
  real_T dY_g;                         /* '<S18>/dY' */
  real_T AddX1_l;                      /* '<S18>/AddX1' */
  real_T dZ_o;                         /* '<S18>/dZ' */
  real_T AddX2_l;                      /* '<S18>/AddX2' */
  real_T y_f;                          /* '<S19>/y' */
  real_T Add1_mk;                      /* '<S19>/Add1' */
  real_T z_g;                          /* '<S19>/z' */
  real_T Add3_c;                       /* '<S19>/Add3' */
  real_T product2_e;                   /* '<S19>/product2' */
  real_T Add2_k;                       /* '<S19>/Add2' */
  real_T product3_o;                   /* '<S19>/product3' */
  real_T product4_o;                   /* '<S19>/product4' */
  real_T Add4_el;                      /* '<S19>/Add4' */
  real_T product1_a;                   /* '<S19>/product1' */
  real_T dX_p;                         /* '<S19>/dX' */
  real_T AddX_d;                       /* '<S19>/AddX' */
  real_T dY_a;                         /* '<S19>/dY' */
  real_T AddX1_p;                      /* '<S19>/AddX1' */
  real_T dZ_m;                         /* '<S19>/dZ' */
  real_T AddX2_b;                      /* '<S19>/AddX2' */
  real_T y_k;                          /* '<S20>/y' */
  real_T Add1_c;                       /* '<S20>/Add1' */
  real_T z_m;                          /* '<S20>/z' */
  real_T Add3_hn;                      /* '<S20>/Add3' */
  real_T product2_d;                   /* '<S20>/product2' */
  real_T Add2_g;                       /* '<S20>/Add2' */
  real_T product3_i;                   /* '<S20>/product3' */
  real_T product4_i;                   /* '<S20>/product4' */
  real_T Add4_o;                       /* '<S20>/Add4' */
  real_T product1_g;                   /* '<S20>/product1' */
  real_T dX_b;                         /* '<S20>/dX' */
  real_T AddX_b;                       /* '<S20>/AddX' */
  real_T dY_n;                         /* '<S20>/dY' */
  real_T AddX1_lw;                     /* '<S20>/AddX1' */
  real_T dZ_n;                         /* '<S20>/dZ' */
  real_T AddX2_a;                      /* '<S20>/AddX2' */
  real_T y_g;                          /* '<S23>/y' */
  real_T Add1_o;                       /* '<S23>/Add1' */
  real_T z_l;                          /* '<S23>/z' */
  real_T Add3_j;                       /* '<S23>/Add3' */
  real_T product2_c;                   /* '<S23>/product2' */
  real_T Add2_c;                       /* '<S23>/Add2' */
  real_T product3_m;                   /* '<S23>/product3' */
  real_T product4_p;                   /* '<S23>/product4' */
  real_T Add4_b;                       /* '<S23>/Add4' */
  real_T product1_e;                   /* '<S23>/product1' */
  real_T dX_l;                         /* '<S23>/dX' */
  real_T AddX_f;                       /* '<S23>/AddX' */
  real_T dY_o;                         /* '<S23>/dY' */
  real_T AddX1_o;                      /* '<S23>/AddX1' */
  real_T dZ_j;                         /* '<S23>/dZ' */
  real_T AddX2_f;                      /* '<S23>/AddX2' */
  real_T y_e;                          /* '<S24>/y' */
  real_T Add1_b;                       /* '<S24>/Add1' */
  real_T z_o;                          /* '<S24>/z' */
  real_T Add3_e;                       /* '<S24>/Add3' */
  real_T product2_l;                   /* '<S24>/product2' */
  real_T Add2_b;                       /* '<S24>/Add2' */
  real_T product3_b;                   /* '<S24>/product3' */
  real_T product4_d;                   /* '<S24>/product4' */
  real_T Add4_bs;                      /* '<S24>/Add4' */
  real_T product1_f;                   /* '<S24>/product1' */
  real_T dX_m;                         /* '<S24>/dX' */
  real_T AddX_j;                       /* '<S24>/AddX' */
  real_T dY_f;                         /* '<S24>/dY' */
  real_T AddX1_b;                      /* '<S24>/AddX1' */
  real_T dZ_g;                         /* '<S24>/dZ' */
  real_T AddX2_e;                      /* '<S24>/AddX2' */
  real_T y_j;                          /* '<S25>/y' */
  real_T Add1_l;                       /* '<S25>/Add1' */
  real_T z_n;                          /* '<S25>/z' */
  real_T Add3_p;                       /* '<S25>/Add3' */
  real_T product2_g;                   /* '<S25>/product2' */
  real_T Add2_l;                       /* '<S25>/Add2' */
  real_T product3_d;                   /* '<S25>/product3' */
  real_T product4_j1;                  /* '<S25>/product4' */
  real_T Add4_k;                       /* '<S25>/Add4' */
  real_T product1_ae;                  /* '<S25>/product1' */
  real_T dX_f;                         /* '<S25>/dX' */
  real_T AddX_on;                      /* '<S25>/AddX' */
  real_T dY_b;                         /* '<S25>/dY' */
  real_T AddX1_j;                      /* '<S25>/AddX1' */
  real_T dZ_f;                         /* '<S25>/dZ' */
  real_T AddX2_h;                      /* '<S25>/AddX2' */
  real_T y_o;                          /* '<S26>/y' */
  real_T Add1_n;                       /* '<S26>/Add1' */
  real_T z_j;                          /* '<S26>/z' */
  real_T Add3_a;                       /* '<S26>/Add3' */
  real_T product2_cg;                  /* '<S26>/product2' */
  real_T Add2_d;                       /* '<S26>/Add2' */
  real_T product3_im;                  /* '<S26>/product3' */
  real_T product4_p0;                  /* '<S26>/product4' */
  real_T Add4_h;                       /* '<S26>/Add4' */
  real_T product1_o;                   /* '<S26>/product1' */
  real_T dX_bi;                        /* '<S26>/dX' */
  real_T AddX_jl;                      /* '<S26>/AddX' */
  real_T dY_na;                        /* '<S26>/dY' */
  real_T AddX1_bw;                     /* '<S26>/AddX1' */
  real_T dZ_i;                         /* '<S26>/dZ' */
  real_T AddX2_g;                      /* '<S26>/AddX2' */
  real_T MatrixConcatenation1[4];      /* '<Root>/Matrix Concatenation1' */
  real_T Add_oe;                       /* '<S8>/Add' */
  real_T Add1_f;                       /* '<S8>/Add1' */
  real_T Gain_p;                       /* '<S8>/Gain' */
  real_T Gain1_c;                      /* '<S8>/Gain1' */
  real_T ForIterator;                  /* '<S70>/For Iterator' */
  real_T Switch_j;                     /* '<S70>/Switch' */
  ...
  real_T Add_j;                        /* '<S70>/Add' */
  real_T Add1_oz;                      /* '<S70>/Add1' */
  ...
  real_T xPCTargetTime_a;              /* '<S72>/xPC Target  Time ' */
  real_T Subtract;                     /* '<S72>/Subtract' */
  real_T ScaleTouSec;                  /* '<S72>/ScaleTouSec' */
  real_T Switch_g;                     /* '<S72>/Switch' */
  ...
  real_T Add_ci;                       /* '<S22>/Add' */
  real_T Gain_n[2];                    /* '<S22>/Gain' */
  real_T Gain_d;                       /* '<S3>/Gain' */
  real_T Add1_b1;                      /* '<S15>/Add1' */
  real_T LorentzForceGain_j[2];        /* '<S2>/LorentzForceGain' */
  real_T DynamicAngleSwitch;           /* '<S2>/DynamicAngle Switch' */
  real_T sin_l;                        /* '<S16>/sin' */
  real_T Inverter_a[2];                /* '<S16>/Inverter' */
  real_T Product3_g;                   /* '<S16>/Product3' */
  real_T cos_j;                        /* '<S16>/cos' */
  real_T Product2_j;                   /* '<S16>/Product2' */
  real_T Subtract_g;                   /* '<S16>/Subtract' */
  real_T Product1_jf;                  /* '<S16>/Product1' */
  real_T Product_d;                    /* '<S16>/Product' */
  real_T Add_p;                        /* '<S16>/Add' */
  real_T Gain_a[2];                    /* '<S16>/Gain' */
  real_T Gain_b;                       /* '<S2>/Gain' */
  uint8_T Compare;                     /* '<S34>/Compare' */
  uint8_T Compare_j;                   /* '<S36>/Compare' */
  uint8_T Compare_m;                   /* '<S37>/Compare' */
  uint8_T Compare_j0;                  /* '<S60>/Compare' */
  uint8_T Compare_h;                   /* '<S63>/Compare' */
  uint8_T Uk1;                         /* '<S61>/Delay Input1' */
  uint8_T FixPtRelationalOperator;     /* '<S61>/FixPt Relational Operator' */
  uint8_T Compare_l;                   /* '<S53>/Compare' */
  uint8_T Compare_o;                   /* '<S51>/Compare' */
  uint8_T Compare_d;                   /* '<S52>/Compare' */
  uint8_T Compare_g;                   /* '<S59>/Compare' */
  uint8_T Uk1_j;                       /* '<S46>/Delay Input1' */
  uint8_T FixPtRelationalOperator_m;   /* '<S46>/FixPt Relational Operator' */
  uint8_T Compare_d1;                  /* '<S57>/Compare' */
  uint8_T Compare_n;                   /* '<S50>/Compare' */
  uint8_T Uk1_n;                       /* '<S39>/Delay Input1' */
  uint8_T FixPtRelationalOperator_d;   /* '<S39>/FixPt Relational Operator' */
  uint8_T Compare_f;                   /* '<S55>/Compare' */
  uint8_T Compare_my;                  /* '<S49>/Compare' */
  uint8_T Uk1_i;                       /* '<S38>/Delay Input1' */
  uint8_T FixPtRelationalOperator_b;   /* '<S38>/FixPt Relational Operator' */
  uint8_T Compare_a;                   /* '<S27>/Compare' */
  uint8_T Compare_h2;                  /* '<S28>/Compare' */
  uint8_T Pack[112];                   /* '<S9>/Pack' */
  uint8_T RateTransition[112];         /* '<S9>/Rate Transition' */
  boolean_T Memory;                    /* '<S31>/Memory' */
  boolean_T Memory_e;                  /* '<S4>/Memory' */
  ...
  boolean_T Memory_e5;                 /* '<S47>/Memory' */
  ...
  boolean_T HiddenBuf_InsertedFor_Enabled_k;/* '<S47>/Logical Operator1' */
  boolean_T RelationalOperator_p;      /* '<S47>/Relational Operator' */
  boolean_T LogicalOperator_ai;        /* '<S47>/Logical Operator' */
  boolean_T LogicalOperator5;          /* '<S47>/Logical Operator5' */
  boolean_T LogicalOperator2_o;        /* '<S43>/Logical Operator2' */
  boolean_T LogicalOperator1_p;        /* '<S43>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_m;/* '<S43>/Logical Operator1' */
  boolean_T RelationalOperator_c;      /* '<S43>/Relational Operator' */
  boolean_T LogicalOperator_if;        /* '<S43>/Logical Operator' */
  boolean_T LogicalOperator1_d;        /* '<S40>/Logical Operator1' */
  boolean_T NOT;                       /* '<S5>/NOT' */
  boolean_T Memory_o;                  /* '<S45>/Memory' */
  boolean_T LogicalOperator2_j;        /* '<S45>/Logical Operator2' */
  boolean_T LogicalOperator1_i;        /* '<S45>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_a;/* '<S45>/Logical Operator1' */
  boolean_T RelationalOperator_pq;     /* '<S45>/Relational Operator' */
  boolean_T LogicalOperator_b;         /* '<S45>/Logical Operator' */
  boolean_T DataTypeConversion2;       /* '<S5>/Data Type Conversion2' */
  boolean_T LogicalOperator1_a;        /* '<S5>/Logical Operator1' */
  boolean_T Memory_j;                  /* '<S44>/Memory' */
  boolean_T LogicalOperator2_mi;       /* '<S44>/Logical Operator2' */
  boolean_T LogicalOperator1_pq;       /* '<S44>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_i;/* '<S44>/Logical Operator1' */
  boolean_T RelationalOperator_l;      /* '<S44>/Relational Operator' */
  boolean_T LogicalOperator_e;         /* '<S44>/Logical Operator' */
  boolean_T DataTypeConversion1;       /* '<S5>/Data Type Conversion1' */
  boolean_T Memory_jh;                 /* '<S42>/Memory' */
  boolean_T Logic[2];                  /* '<S42>/Logic' */
  boolean_T LogicalOperator5_h;        /* '<S5>/Logical Operator5' */
  boolean_T LogicalOperator1_b;        /* '<S4>/Logical Operator1' */
  boolean_T MatrixConcatenation[2];    /* '<S4>/Matrix Concatenation' */
  boolean_T RelationalOperator_e;      /* '<S6>/Relational Operator' */
  boolean_T RelationalOperator_o;      /* '<S65>/Relational Operator' */
  boolean_T Compare_nw;                /* '<S74>/Compare' */
  boolean_T Compare_h0;                /* '<S73>/Compare' */
  boolean_T LogicalOperator6;          /* '<S5>/Logical Operator6' */
  boolean_T LogicalOperator3_d;        /* '<S5>/Logical Operator3' */
  rtB_SampleandHold_random_walk SampleandHold;/* '<S65>/Sample and Hold' */
  rtB_SampleandHold_random_walk SampleandHold_g;/* '<S6>/Sample and Hold' */
  rtB_EnabledSubsystem_random_wal EnabledSubsystem_l;/* '<S47>/Enabled Subsystem' */
  rtB_EnabledSubsystem_random_wal EnabledSubsystem_o;/* '<S45>/Enabled Subsystem' */
  rtB_EnabledSubsystem_random_wal EnabledSubsystem_n;/* '<S44>/Enabled Subsystem' */
  rtB_EnabledSubsystem_random_wal EnabledSubsystem_d;/* '<S43>/Enabled Subsystem' */
  rtB_EnabledSubsystem_random_wal EnabledSubsystem;/* '<S31>/Enabled Subsystem' */
} BlockIO_random_walk;
...
typedef struct {
  ...
  real_T DigitalFilter2_FILT_STATES_a[11];/* '<S68>/Digital Filter2' */
  real_T DigitalFilter_FILT_STATES_m[11];/* '<S68>/Digital Filter' */
  real_T x_DSTATE;                     /* '<S23>/x' */
  real_T x_DSTATE_m;                   /* '<S24>/x' */
  real_T x_DSTATE_d;                   /* '<S25>/x' */
  real_T x_DSTATE_k;                   /* '<S26>/x' */
  real_T x_DSTATE_b;                   /* '<S17>/x' */
  real_T x_DSTATE_g;                   /* '<S18>/x' */
  real_T x_DSTATE_l;                   /* '<S19>/x' */
  real_T x_DSTATE_n;                   /* '<S20>/x' */
  real_T BehaviorRW_DSTATE;            /* '<Root>/Behavior RW' */
  real_T y_DSTATE;                     /* '<S17>/y' */
  real_T z_DSTATE;                     /* '<S17>/z' */
  real_T y_DSTATE_j;                   /* '<S18>/y' */
  real_T z_DSTATE_d;                   /* '<S18>/z' */
  real_T y_DSTATE_c;                   /* '<S19>/y' */
  real_T z_DSTATE_b;                   /* '<S19>/z' */
  real_T y_DSTATE_l;                   /* '<S20>/y' */
  real_T z_DSTATE_j;                   /* '<S20>/z' */
  real_T y_DSTATE_k;                   /* '<S23>/y' */
  real_T z_DSTATE_m;                   /* '<S23>/z' */
  real_T y_DSTATE_ky;                  /* '<S24>/y' */
  real_T z_DSTATE_f;                   /* '<S24>/z' */
  real_T y_DSTATE_n;                   /* '<S25>/y' */
  real_T z_DSTATE_dr;                  /* '<S25>/z' */
  real_T y_DSTATE_d;                   /* '<S26>/y' */
  real_T z_DSTATE_dv;                  /* '<S26>/z' */
  ...
  void *BehaviorRW_PWORK;              /* '<Root>/Behavior RW' */
  ...
  int32_T DigitalFilter2_CIRCBUFFIDX_a;/* '<S68>/Digital Filter2' */
  int32_T DigitalFilter_CIRCBUFFIDX_d; /* '<S68>/Digital Filter' */
  int_T PCIQUAD04_IWORK;               /* '<S13>/PCI-QUAD04 ' */
  int_T PCIQUAD041_IWORK;              /* '<S13>/PCI-QUAD04 1' */
  int_T PCI6025EAD_IWORK[66];          /* '<S10>/PCI-6025E AD' */
  int_T BehaviorRW_IWORK[7];           /* '<Root>/Behavior RW' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_o;                 /* '<S7>/S-Function' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_i;                 /* '<S48>/S-Function' */
  ...
  uint8_T DelayInput1_DSTATE_h;        /* '<S46>/Delay Input1' */
  uint8_T DelayInput1_DSTATE_k;        /* '<S39>/Delay Input1' */
  ...
  boolean_T Memory_PreviousInput_e;    /* '<S47>/Memory' */
  boolean_T Memory_PreviousInput_d;    /* '<S45>/Memory' */
  boolean_T Memory_PreviousInput_b;    /* '<S44>/Memory' */
  boolean_T Memory_PreviousInput_h;    /* '<S42>/Memory' */
  rtDW_SampleandHold_random_walk SampleandHold;/* '<S65>/Sample and Hold' */
  rtDW_SampleandHold_random_walk SampleandHold_g;/* '<S6>/Sample and Hold' */
  rtDW_EnabledSubsystem_random_wa EnabledSubsystem_l;/* '<S47>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_random_wa EnabledSubsystem_o;/* '<S45>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_random_wa EnabledSubsystem_n;/* '<S44>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_random_wa EnabledSubsystem_d;/* '<S43>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_random_wa EnabledSubsystem;/* '<S31>/Enabled Subsystem' */
} D_Work_random_walk;

/* Zero-crossing (trigger) state */
typedef struct {
  rtZCE_SampleandHold_random_walk SampleandHold;/* '<S6>/Sample and Hold' */
  rtZCE_SampleandHold_random_walk SampleandHold_g;/* '<S6>/Sample and Hold' */
} PrevZCSigStates_random_walk;
...
#define rtPrevZCSigState               random_walk_PrevZCSigState
#define PrevZCSigStates                PrevZCSigStates_random_walk

/* Parameters for system: '<S6>/Sample and Hold' */
struct rtP_SampleandHold_random_walk {
...
struct Parameters_random_walk {
  ...
  real_T DigitalFilter_RTP1COEFF[11];  /* Expression: NumCoeffs
                                        * '<S67>/Digital Filter'
                                        */
  real_T DigitalFilter2_ICRTP_f;       /* Expression: a.IC
                                        * '<S68>/Digital Filter2'
                                        */
  real_T DigitalFilter2_RTP1COEFF_f[11];/* Expression: NumCoeffs
                                         * '<S68>/Digital Filter2'
                                         */
  real_T dG_Gain_d;                    /* Expression: 1
                                        * '<S68>/dG'
                                        */
  real_T DigitalFilter_ICRTP_p;        /* Expression: a.IC
                                        * '<S68>/Digital Filter'
                                        */
  ...
  real_T x_X0_i;                       /* Expression: .1
                                        * '<S26>/x'
                                        */
  real_T Load_Value_a;                 /* Expression: 0
                                        * '<S2>/Load'
                                        */
  ...
  real_T x_X0_p;                       /* Expression: .1
                                        * '<S18>/x'
                                        */
  real_T x_X0_iy;                      /* Expression: .1
                                        * '<S19>/x'
                                        */
  real_T x_X0_p3;                      /* Expression: .1
                                        * '<S20>/x'
                                        */
  ...
  real_T BehaviorRW_P10;               /* Expression: 0
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P11_Size[2];       /* Computed Parameter: P11Size
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P11;               /* Expression: 0
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P12_Size[2];       /* Computed Parameter: P12Size
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P12;               /* Expression: 10
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P13_Size[2];       /* Computed Parameter: P13Size
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P13;               /* Expression: 10
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P14_Size[2];       /* Computed Parameter: P14Size
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P14;               /* Expression: 1
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P15_Size[2];       /* Computed Parameter: P15Size
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P15;               /* Expression: 0
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P16_Size[2];       /* Computed Parameter: P16Size
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P16;               /* Expression: 0
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P17_Size[2];       /* Computed Parameter: P17Size
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P17;               /* Expression: 0
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P18_Size[2];       /* Computed Parameter: P18Size
                                        * '<Root>/Behavior RW'
                                        */
  real_T BehaviorRW_P18;               /* Expression: 0
                                        * '<Root>/Behavior RW'
                                        */
  ...
  real_T y_X0_g;                       /* Expression: y0
                                        * '<S23>/y'
                                        */
  real_T rho_Value_am;                 /* Expression: 28
                                        * '<S23>/rho'
                                        */
  real_T z_X0_cv;                      /* Expression: .1
                                        * '<S23>/z'
                                        */
  ...
  real_T beta_Value_g;                 /* Expression: 8/3
                                        * '<S24>/beta'
                                        */
  real_T timescale_Value_py;           /* Expression: .0001
                                        * '<S24>/timescale'
                                        */
  ...
  real_T y_X0_p;                       /* Expression: y0
                                        * '<S25>/y'
                                        */
  real_T rho_Value_eo;                 /* Expression: 28
                                        * '<S25>/rho'
                                        */
  real_T z_X0_l;                       /* Expression: .1
                                        * '<S25>/z'
                                        */
  real_T beta_Value_o2;                /* Expression: 8/3
                                        * '<S25>/beta'
                                        */
  real_T timescale_Value_dn;           /* Expression: .0001
                                        * '<S25>/timescale'
                                        */
  ...
  real_T y_X0_lz;                      /* Expression: y0
                                        * '<S26>/y'
                                        */
  real_T rho_Value_mm;                 /* Expression: 28
                                        * '<S26>/rho'
                                        */
  ...
  real_T timescale_Value_h;            /* Expression: .0001
                                        * '<S26>/timescale'
                                        */
  real_T sigma_Value_mj;               /* Expression: 10
                                        * '<S26>/sigma'
                                        */
  ...
  real_T Gain1_Gain_d;                 /* Expression: .5
                                        * '<S8>/Gain1'
                                        */
  real_T Gain_Gain_o;                  /* Expression: 0.0367
                                        * '<S2>/Gain'
                                        */
  ...
  real_T visAngle_Value_n;             /* Expression: 0
                                        * '<S3>/visAngle'
                                        */
  real_T DynamicAngle_Value_h;         /* Expression: 0
                                        * '<S3>/DynamicAngle'
                                        */
  ...
  real_T LorentzForceGain_Gain_j;      /* Expression: .0005
                                        * '<S3>/LorentzForceGain'
                                        */
  real_T staticX_Value_e;              /* Expression: 0
                                        * '<S3>/staticX'
                                        */
  real_T staticY_Value_a;              /* Expression: 0
                                        * '<S3>/staticY'
                                        */
  ...
  real_T Gain4_Gain;                   /* Expression: -.0002
                                        * '<S41>/Gain4'
                                        */
  real_T Gain2_Gain_d;                 /* Expression: -.001
                                        * '<S41>/Gain2'
                                        */
  ...
  real_T Constant_Value_a;             /* Expression: const
                                        * '<S73>/Constant'
                                        */
  real_T Switch_Threshold_a;           /* Expression: 2
                                        * '<S70>/Switch'
                                        */
  ...
  uint8_T DelayInput1_X0_k;            /* Computed Parameter: X0
                                        * '<S46>/Delay Input1'
                                        */
  uint8_T DelayInput1_X0_j;            /* Computed Parameter: X0
                                        * '<S39>/Delay Input1'
                                        */
  uint8_T DelayInput1_X0_a;            /* Computed Parameter: X0
                                        * '<S38>/Delay Input1'
                                        */
  ...
  boolean_T Logic_table[16];           /* Computed Parameter: TruthTable
                                        * '<S42>/Logic'
                                        */
  rtP_SampleandHold_random_walk SampleandHold;/* '<S6>/Sample and Hold' */
  rtP_SampleandHold_random_walk SampleandHold_g;/* '<S6>/Sample and Hold' */
};
...
/* Zero-crossing (trigger) state */
extern PrevZCSigStates_random_walk random_walk_PrevZCSigState;
 ...
 * '<S2>'   : random_walk/Catch Force Generator
 * '<S3>'   : random_walk/Force Generator
 * '<S4>'   : random_walk/Motor Control
 * '<S5>'   : random_walk/Recentering Subsystem
 * '<S6>'   : random_walk/RewardSbs
 * '<S7>'   : random_walk/Status
 * '<S8>'   : random_walk/Target Peek
 * '<S9>'   : random_walk/UDPXmit
 * '<S10>'  : random_walk/Velocity Calculation
 * '<S11>'  : random_walk/Version Display
 * '<S12>'  : random_walk/WordSbs
 * '<S13>'  : random_walk/XY Position Subsystem
 * '<S14>'  : random_walk/Xpos
 * '<S15>'  : random_walk/Catch Force Generator/LorentzForce
 * '<S16>'  : random_walk/Catch Force Generator/ViscLoadSubsystem
 * '<S17>'  : random_walk/Catch Force Generator/LorentzForce/Lorentz
 * '<S18>'  : random_walk/Catch Force Generator/LorentzForce/Lorentz1
 * '<S19>'  : random_walk/Catch Force Generator/LorentzForce/Lorentz2
 * '<S20>'  : random_walk/Catch Force Generator/LorentzForce/Lorentz3
 * '<S21>'  : random_walk/Force Generator/LorentzForce
 * '<S22>'  : random_walk/Force Generator/ViscLoadSubsystem
 * '<S23>'  : random_walk/Force Generator/LorentzForce/Lorentz
 * '<S24>'  : random_walk/Force Generator/LorentzForce/Lorentz1
 * '<S25>'  : random_walk/Force Generator/LorentzForce/Lorentz2
 * '<S26>'  : random_walk/Force Generator/LorentzForce/Lorentz3
 * '<S27>'  : random_walk/Motor Control/Compare To Constant
 * '<S28>'  : random_walk/Motor Control/Compare To Constant1
 * '<S29>'  : random_walk/Motor Control/Force//Torque Transform
 * '<S30>'  : random_walk/Motor Control/Recenter//ServoKill
 * '<S31>'  : random_walk/Motor Control/Schmidt
 * '<S32>'  : random_walk/Motor Control/Xpos
 * '<S33>'  : random_walk/Motor Control/Force//Torque Transform/Transpose
 * '<S34>'  : random_walk/Motor Control/Schmidt/Compare To Zero
 * '<S35>'  : random_walk/Motor Control/Schmidt/Enabled Subsystem
 * '<S36>'  : random_walk/Recentering Subsystem/Compare To Zero
 * '<S37>'  : random_walk/Recentering Subsystem/Compare To Zero1
 * '<S38>'  : random_walk/Recentering Subsystem/Falling Edge
 * '<S39>'  : random_walk/Recentering Subsystem/Falling Edge1
 * '<S40>'  : random_walk/Recentering Subsystem/No Movement
 * '<S41>'  : random_walk/Recentering Subsystem/PD Controller
 * '<S42>'  : random_walk/Recentering Subsystem/S-R Flip-Flop
 * '<S43>'  : random_walk/Recentering Subsystem/Schmidt1
 * '<S44>'  : random_walk/Recentering Subsystem/Schmidt2
 * '<S45>'  : random_walk/Recentering Subsystem/Schmidt3
 * '<S46>'  : random_walk/Recentering Subsystem/Start Moving
 * '<S47>'  : random_walk/Recentering Subsystem/Timer
 * '<S48>'  : random_walk/Recentering Subsystem/Xpos1
 * '<S49>'  : random_walk/Recentering Subsystem/Falling Edge/Nonpositive
 * '<S50>'  : random_walk/Recentering Subsystem/Falling Edge1/Nonpositive
 * '<S51>'  : random_walk/Recentering Subsystem/No Movement/Compare To Constant2
 * '<S52>'  : random_walk/Recentering Subsystem/No Movement/Compare To Constant3
 * '<S53>'  : random_walk/Recentering Subsystem/Schmidt1/Compare To Zero
 * '<S54>'  : random_walk/Recentering Subsystem/Schmidt1/Enabled Subsystem
 * '<S55>'  : random_walk/Recentering Subsystem/Schmidt2/Compare To Zero
 * '<S56>'  : random_walk/Recentering Subsystem/Schmidt2/Enabled Subsystem
 * '<S57>'  : random_walk/Recentering Subsystem/Schmidt3/Compare To Zero
 * '<S58>'  : random_walk/Recentering Subsystem/Schmidt3/Enabled Subsystem
 * '<S59>'  : random_walk/Recentering Subsystem/Start Moving/Nonpositive
 * '<S60>'  : random_walk/Recentering Subsystem/Timer/Compare To Zero
 * '<S61>'  : random_walk/Recentering Subsystem/Timer/Detect Fall Nonpositive
 * '<S62>'  : random_walk/Recentering Subsystem/Timer/Enabled Subsystem
 * '<S63>'  : random_walk/Recentering Subsystem/Timer/Detect Fall Nonpositive/Nonpositive
 * '<S64>'  : random_walk/RewardSbs/Sample and Hold
 * '<S65>'  : random_walk/RewardSbs/Schmidt
 * '<S66>'  : random_walk/RewardSbs/Schmidt/Sample and Hold
 * '<S67>'  : random_walk/Velocity Calculation/Pos2VelX
 * '<S68>'  : random_walk/Velocity Calculation/Pos2VelY
 * '<S69>'  : random_walk/XY Position Subsystem/Cursor Rotation
 * '<S70>'  : random_walk/XY Position Subsystem/For Iterator Subsystem
 * '<S71>'  : random_walk/XY Position Subsystem/Jacobian-Cartesian Transformation
 * '<S72>'  : random_walk/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem
 * '<S73>'  : random_walk/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem/Compare To Constant
 * '<S74>'  : random_walk/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem/Compare To Constant1
 */
