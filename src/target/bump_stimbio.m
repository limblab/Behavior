...
bio(1).dim=[4,1];
bio(1).sigWidth=4;
bio(1).sigAddress='&bump_stim_B.MatrixConcatenation1[0]';
bio(getlenBIO) = bio(1);

bio(2).blkName='Behavior BS/p1';
bio(2).sigName='';
bio(2).portIdx=0;
bio(2).dim=[2,1];
bio(2).sigWidth=2;
bio(2).sigAddress='&bump_stim_B.BehaviorBS_o1[0]';

bio(3).blkName='Behavior BS/p2';
bio(3).sigName='';
bio(3).portIdx=1;
bio(3).dim=[5,1];
bio(3).sigWidth=5;
bio(3).sigAddress='&bump_stim_B.BehaviorBS_o2[0]';

bio(4).blkName='Behavior BS/p3';
bio(4).sigName='';
bio(4).portIdx=2;
bio(4).dim=[1,1];
bio(4).sigWidth=1;
bio(4).sigAddress='&bump_stim_B.BehaviorBS_o3';

bio(5).blkName='Behavior BS/p4';
bio(5).sigName='';
bio(5).portIdx=3;
bio(5).dim=[10,1];
bio(5).sigWidth=10;
bio(5).sigAddress='&bump_stim_B.BehaviorBS_o4[0]';

bio(6).blkName='Behavior BS/p5';
bio(6).sigName='';
bio(6).portIdx=4;
bio(6).dim=[1,1];
bio(6).sigWidth=1;
bio(6).sigAddress='&bump_stim_B.BehaviorBS_o5';

bio(7).blkName='Behavior BS/p6';
bio(7).sigName='';
bio(7).portIdx=5;
bio(7).dim=[2,1];
bio(7).sigWidth=2;
bio(7).sigAddress='&bump_stim_B.BehaviorBS_o6[0]';

bio(8).blkName='Behavior BS/p7';
bio(8).sigName='';
bio(8).portIdx=6;
bio(8).dim=[4,1];
bio(8).sigWidth=4;
bio(8).sigAddress='&bump_stim_B.BehaviorBS_o7[0]';

bio(9).blkName='Behavior BS/p8';
bio(9).sigName='';
bio(9).portIdx=7;
bio(9).dim=[2,1];
bio(9).sigWidth=2;
bio(9).sigAddress='&bump_stim_B.BehaviorBS_o8[0]';
...
bio(10).dim=[1,1];
bio(10).sigWidth=1;
bio(10).sigAddress='&bump_stim_B.LogicalOperator_n';
...
bio(11).dim=[1,1];
bio(11).sigWidth=1;
bio(11).sigAddress='&bump_stim_B.RelationalOperator_f';
...
bio(12).dim=[1,1];
bio(12).sigWidth=1;
bio(12).sigAddress='&bump_stim_B.RelationalOperator1';
...
bio(13).dim=[1,1];
bio(13).sigWidth=1;
bio(13).sigAddress='&bump_stim_B.RelationalOperator2';
...
bio(14).dim=[1,1];
bio(14).sigWidth=1;
bio(14).sigAddress='&bump_stim_B.RelationalOperator3';
...
bio(15).dim=[1,1];
bio(15).sigWidth=1;
bio(15).sigAddress='&bump_stim_B.Gain_p';
...
bio(16).dim=[2,1];
bio(16).sigWidth=2;
bio(16).sigAddress='&bump_stim_B.LorentzForceGain_p[0]';
...
bio(17).dim=[1,1];
bio(17).sigWidth=1;
bio(17).sigAddress='&bump_stim_B.DynamicAngleSwitch';
...
bio(18).dim=[2,1];
bio(18).sigWidth=2;
bio(18).sigAddress='&bump_stim_B.LoadSelectSwitch[0]';
...
bio(19).dim=[1,1];
bio(19).sigWidth=1;
bio(19).sigAddress='&bump_stim_B.Gain_a';
...
bio(20).dim=[2,1];
bio(20).sigWidth=2;
bio(20).sigAddress='&bump_stim_B.LorentzForceGain[0]';
...
bio(21).dim=[2,1];
bio(21).sigWidth=2;
bio(21).sigAddress='&bump_stim_B.MultiportSwitch[0]';
...
bio(22).dim=[1,1];
bio(22).sigWidth=1;
bio(22).sigAddress='&bump_stim_B.dynamicAngleSwitch';
...
bio(23).dim=[2,1];
bio(23).sigWidth=2;
bio(23).sigAddress='&bump_stim_B.MatrixConcatenation[0]';
...
bio(24).dim=[1,1];
bio(24).sigWidth=1;
bio(24).sigAddress='&bump_stim_B.MG1';
...
bio(25).dim=[1,1];
bio(25).sigWidth=1;
bio(25).sigAddress='&bump_stim_B.MG2';
...
bio(26).dim=[1,1];
bio(26).sigWidth=1;
bio(26).sigAddress='&bump_stim_B.LogicalOperator1_l';
...
bio(27).dim=[1,1];
bio(27).sigWidth=1;
bio(27).sigAddress='&bump_stim_B.Memory_i';
...
bio(28).dim=[2,1];
bio(28).sigWidth=2;
bio(28).sigAddress='&bump_stim_B.Switch1[0]';
...
bio(29).dim=[2,1];
bio(29).sigWidth=2;
bio(29).sigAddress='&bump_stim_B.Switch2[0]';
...
bio(30).dim=[1,1];
bio(30).sigWidth=1;
bio(30).sigAddress='&bump_stim_B.DataTypeConversion1';
...
bio(31).dim=[1,1];
bio(31).sigWidth=1;
bio(31).sigAddress='&bump_stim_B.DataTypeConversion2';
...
bio(32).dim=[2,1];
bio(32).sigWidth=2;
bio(32).sigAddress='&bump_stim_B.BoundingBoxViscosity[0]';
...
bio(33).dim=[1,1];
bio(33).sigWidth=1;
bio(33).sigAddress='&bump_stim_B.InBox';
...
bio(34).dim=[1,1];
bio(34).sigWidth=1;
bio(34).sigAddress='&bump_stim_B.LogicalOperator_k';
...
bio(35).dim=[1,1];
bio(35).sigWidth=1;
bio(35).sigAddress='&bump_stim_B.LogicalOperator1_an';
...
bio(36).dim=[1,1];
bio(36).sigWidth=1;
bio(36).sigAddress='&bump_stim_B.LogicalOperator3_f';
...
bio(37).dim=[1,1];
bio(37).sigWidth=1;
bio(37).sigAddress='&bump_stim_B.LogicalOperator5_i';
...
bio(38).dim=[1,1];
bio(38).sigWidth=1;
bio(38).sigAddress='&bump_stim_B.LogicalOperator6';
...
bio(39).dim=[1,1];
bio(39).sigWidth=1;
bio(39).sigAddress='&bump_stim_B.NOT';
...
bio(40).dim=[2,1];
bio(40).sigWidth=2;
bio(40).sigAddress='&bump_stim_B.Switch_a[0]';
...
bio(41).dim=[1,1];
bio(41).sigWidth=1;
bio(41).sigAddress='&bump_stim_B.DataTypeConversion';
...
bio(42).dim=[1,1];
bio(42).sigWidth=1;
bio(42).sigAddress='&bump_stim_B.RelationalOperator_m';
...
bio(43).dim=[1,1];
bio(43).sigWidth=1;
bio(43).sigAddress='&bump_stim_B.Switch_n';
...
bio(44).dim=[1,1];
bio(44).sigWidth=1;
bio(44).sigAddress='&bump_stim_B.UniformRandomNumber';
...
bio(45).dim=[1,1];
bio(45).sigWidth=1;
bio(45).sigAddress='&bump_stim_B.Gain_i';
...
bio(46).dim=[1,1];
bio(46).sigWidth=1;
bio(46).sigAddress='&bump_stim_B.Gain1_n';
...
bio(47).dim=[1,1];
bio(47).sigWidth=1;
bio(47).sigAddress='&bump_stim_B.Add_o';
...
bio(48).dim=[1,1];
bio(48).sigWidth=1;
bio(48).sigAddress='&bump_stim_B.Add1_a';
...
bio(49).dim=[112,1];
bio(49).sigWidth=112;
bio(49).sigAddress='&bump_stim_B.RateTransition[0]';
...
bio(50).dim=[112,1];
bio(50).sigWidth=112;
bio(50).sigAddress='&bump_stim_B.Pack[0]';
...
bio(51).dim=[1,1];
bio(51).sigWidth=1;
bio(51).sigAddress='&bump_stim_B.TachGain1';
...
bio(52).dim=[1,1];
bio(52).sigWidth=1;
bio(52).sigAddress='&bump_stim_B.TachGain2';
...
bio(53).dim=[2,1];
bio(53).sigWidth=2;
bio(53).sigAddress='&bump_stim_B.MatrixMultiply[0]';
...
bio(54).dim=[1,1];
bio(54).sigWidth=1;
bio(54).sigAddress='&bump_stim_B.PCI6025EAD_o1';
...
bio(55).dim=[1,1];
bio(55).sigWidth=1;
bio(55).sigAddress='&bump_stim_B.PCI6025EAD_o2';
...
bio(56).dim=[2,1];
bio(56).sigWidth=2;
bio(56).sigAddress='&bump_stim_B.Switch[0]';
...
bio(57).dim=[1,1];
bio(57).sigWidth=1;
bio(57).sigAddress='&bump_stim_B.Gain';
...
bio(58).dim=[1,1];
bio(58).sigWidth=1;
bio(58).sigAddress='&bump_stim_B.Gain1';
...
bio(59).dim=[1,1];
bio(59).sigWidth=1;
bio(59).sigAddress='&bump_stim_B.PCIQUAD04';
...
bio(60).dim=[1,1];
bio(60).sigWidth=1;
bio(60).sigAddress='&bump_stim_B.PCIQUAD041';
...
bio(61).dim=[1,1];
bio(61).sigWidth=1;
bio(61).sigAddress='&bump_stim_B.Sum1';
...
bio(62).dim=[1,1];
bio(62).sigWidth=1;
bio(62).sigAddress='&bump_stim_B.Sum3';
...
bio(63).dim=[1,1];
bio(63).sigWidth=1;
bio(63).sigAddress='&bump_stim_B.Add_d';
...
bio(64).dim=[1,1];
bio(64).sigWidth=1;
bio(64).sigAddress='&bump_stim_B.Add1_l2';
...
bio(65).dim=[2,1];
bio(65).sigWidth=2;
bio(65).sigAddress='&bump_stim_B.Gain_ax[0]';
...
bio(66).dim=[2,1];
bio(66).sigWidth=2;
bio(66).sigAddress='&bump_stim_B.Inverter_i[0]';
...
bio(67).dim=[1,1];
bio(67).sigWidth=1;
bio(67).sigAddress='&bump_stim_B.Product_n';
...
bio(68).dim=[1,1];
bio(68).sigWidth=1;
bio(68).sigAddress='&bump_stim_B.Product1_k';
...
bio(69).dim=[1,1];
bio(69).sigWidth=1;
bio(69).sigAddress='&bump_stim_B.Product2_l';
...
bio(70).dim=[1,1];
bio(70).sigWidth=1;
bio(70).sigAddress='&bump_stim_B.Product3_g';
...
bio(71).dim=[1,1];
bio(71).sigWidth=1;
bio(71).sigAddress='&bump_stim_B.Add_lj';
...
bio(72).dim=[1,1];
bio(72).sigWidth=1;
bio(72).sigAddress='&bump_stim_B.Subtract_k';
...
bio(73).dim=[1,1];
bio(73).sigWidth=1;
bio(73).sigAddress='&bump_stim_B.cos_kc';
...
bio(74).dim=[1,1];
bio(74).sigWidth=1;
bio(74).sigAddress='&bump_stim_B.sin_k';
...
bio(75).dim=[1,1];
bio(75).sigWidth=1;
bio(75).sigAddress='&bump_stim_B.Add';
...
bio(76).dim=[1,1];
bio(76).sigWidth=1;
bio(76).sigAddress='&bump_stim_B.Add1_h';
...
bio(77).dim=[2,1];
bio(77).sigWidth=2;
bio(77).sigAddress='&bump_stim_B.Gain_n[0]';
...
bio(78).dim=[2,1];
bio(78).sigWidth=2;
bio(78).sigAddress='&bump_stim_B.Inverter[0]';
...
bio(79).dim=[1,1];
bio(79).sigWidth=1;
bio(79).sigAddress='&bump_stim_B.Product_j';
...
bio(80).dim=[1,1];
bio(80).sigWidth=1;
bio(80).sigAddress='&bump_stim_B.Product1_j';
...
bio(81).dim=[1,1];
bio(81).sigWidth=1;
bio(81).sigAddress='&bump_stim_B.Product2_m';
...
bio(82).dim=[1,1];
bio(82).sigWidth=1;
bio(82).sigAddress='&bump_stim_B.Product3_k';
...
bio(83).dim=[1,1];
bio(83).sigWidth=1;
bio(83).sigAddress='&bump_stim_B.Add_l';
...
bio(84).dim=[1,1];
bio(84).sigWidth=1;
bio(84).sigAddress='&bump_stim_B.Subtract_o';
...
bio(85).dim=[1,1];
bio(85).sigWidth=1;
bio(85).sigAddress='&bump_stim_B.cos_k';
...
bio(86).dim=[1,1];
bio(86).sigWidth=1;
bio(86).sigAddress='&bump_stim_B.sin_l';
...
bio(87).dim=[1,1];
bio(87).sigWidth=1;
bio(87).sigAddress='&bump_stim_B.Compare_o';
...
bio(88).dim=[1,1];
bio(88).sigWidth=1;
bio(88).sigAddress='&bump_stim_B.Compare_h';
...
bio(89).dim=[2,1];
bio(89).sigWidth=2;
bio(89).sigAddress='&bump_stim_B.Gain_g[0]';
...
bio(90).dim=[2,1];
bio(90).sigWidth=2;
bio(90).sigAddress='&bump_stim_B.MatrixMultiply_l[0]';
...
bio(91).dim=[1,1];
bio(91).sigWidth=1;
bio(91).sigAddress='&bump_stim_B.Clock';
...
bio(92).dim=[1,1];
bio(92).sigWidth=1;
bio(92).sigAddress='&bump_stim_B.LogicalOperator';
...
bio(93).dim=[1,1];
bio(93).sigWidth=1;
bio(93).sigAddress='&bump_stim_B.LogicalOperator1';
...
bio(94).dim=[1,1];
bio(94).sigWidth=1;
bio(94).sigAddress='&bump_stim_B.LogicalOperator2';
...
bio(95).dim=[1,1];
bio(95).sigWidth=1;
bio(95).sigAddress='&bump_stim_B.Memory';
...
bio(96).dim=[1,1];
bio(96).sigWidth=1;
bio(96).sigAddress='&bump_stim_B.RelationalOperator';
...
bio(97).dim=[1,1];
bio(97).sigWidth=1;
bio(97).sigAddress='&bump_stim_B.Sum';
...
bio(98).dim=[1,1];
bio(98).sigWidth=1;
bio(98).sigAddress='&bump_stim_B.Compare_b';
...
bio(99).dim=[1,1];
bio(99).sigWidth=1;
bio(99).sigAddress='&bump_stim_B.Compare_m';
...
bio(100).dim=[1,1];
bio(100).sigWidth=1;
bio(100).sigAddress='&bump_stim_B.FixPtRelationalOperator_d';
...
bio(101).dim=[1,1];
bio(101).sigWidth=1;
bio(101).sigAddress='&bump_stim_B.Uk1_d';
...
bio(102).dim=[1,1];
bio(102).sigWidth=1;
bio(102).sigAddress='&bump_stim_B.FixPtRelationalOperator_n';
...
bio(103).dim=[1,1];
bio(103).sigWidth=1;
bio(103).sigAddress='&bump_stim_B.Uk1_p';
...
bio(104).dim=[1,1];
bio(104).sigWidth=1;
bio(104).sigAddress='&bump_stim_B.Abs2';
...
bio(105).dim=[1,1];
bio(105).sigWidth=1;
bio(105).sigAddress='&bump_stim_B.Abs3';
...
bio(106).dim=[1,1];
bio(106).sigWidth=1;
bio(106).sigAddress='&bump_stim_B.LogicalOperator1_a';
...
bio(107).dim=[1,1];
bio(107).sigWidth=1;
bio(107).sigAddress='&bump_stim_B.Gain1_d';
...
bio(108).dim=[1,1];
bio(108).sigWidth=1;
bio(108).sigAddress='&bump_stim_B.Gain2';
...
bio(109).dim=[1,1];
bio(109).sigWidth=1;
bio(109).sigAddress='&bump_stim_B.Gain3';
...
bio(110).dim=[1,1];
bio(110).sigWidth=1;
bio(110).sigAddress='&bump_stim_B.Gain4';
...
bio(111).dim=[1,1];
bio(111).sigWidth=1;
bio(111).sigAddress='&bump_stim_B.Product_i';
...
bio(112).dim=[1,1];
bio(112).sigWidth=1;
bio(112).sigAddress='&bump_stim_B.Product1_o';
...
bio(113).dim=[1,1];
bio(113).sigWidth=1;
bio(113).sigAddress='&bump_stim_B.Saturation';
...
bio(114).dim=[1,1];
bio(114).sigWidth=1;
bio(114).sigAddress='&bump_stim_B.Saturation1';
...
bio(115).dim=[1,1];
bio(115).sigWidth=1;
bio(115).sigAddress='&bump_stim_B.Add_i';
...
bio(116).dim=[1,1];
bio(116).sigWidth=1;
bio(116).sigAddress='&bump_stim_B.Add1_l';
...
bio(117).dim=[2,1];
bio(117).sigWidth=2;
bio(117).sigAddress='&bump_stim_B.Logic[0]';
...
bio(118).dim=[1,1];
bio(118).sigWidth=1;
bio(118).sigAddress='&bump_stim_B.Memory_j';
...
bio(119).dim=[1,1];
bio(119).sigWidth=1;
bio(119).sigAddress='&bump_stim_B.Clock_c';
...
bio(120).dim=[1,1];
bio(120).sigWidth=1;
bio(120).sigAddress='&bump_stim_B.LogicalOperator_g';
...
bio(121).dim=[1,1];
bio(121).sigWidth=1;
bio(121).sigAddress='&bump_stim_B.LogicalOperator1_m';
...
bio(122).dim=[1,1];
bio(122).sigWidth=1;
bio(122).sigAddress='&bump_stim_B.LogicalOperator2_b';
...
bio(123).dim=[1,1];
bio(123).sigWidth=1;
bio(123).sigAddress='&bump_stim_B.Memory_e';
...
bio(124).dim=[1,1];
bio(124).sigWidth=1;
bio(124).sigAddress='&bump_stim_B.RelationalOperator_i';
...
bio(125).dim=[1,1];
bio(125).sigWidth=1;
bio(125).sigAddress='&bump_stim_B.Sum_b';
...
bio(126).dim=[1,1];
bio(126).sigWidth=1;
bio(126).sigAddress='&bump_stim_B.Clock_n';
...
bio(127).dim=[1,1];
bio(127).sigWidth=1;
bio(127).sigAddress='&bump_stim_B.LogicalOperator_f';
...
bio(128).dim=[1,1];
bio(128).sigWidth=1;
bio(128).sigAddress='&bump_stim_B.LogicalOperator1_n';
...
bio(129).dim=[1,1];
bio(129).sigWidth=1;
bio(129).sigAddress='&bump_stim_B.LogicalOperator2_o';
...
bio(130).dim=[1,1];
bio(130).sigWidth=1;
bio(130).sigAddress='&bump_stim_B.Memory_d';
...
bio(131).dim=[1,1];
bio(131).sigWidth=1;
bio(131).sigAddress='&bump_stim_B.RelationalOperator_h';
...
bio(132).dim=[1,1];
bio(132).sigWidth=1;
bio(132).sigAddress='&bump_stim_B.Sum_gv';
...
bio(133).dim=[1,1];
bio(133).sigWidth=1;
bio(133).sigAddress='&bump_stim_B.Clock_a';
...
bio(134).dim=[1,1];
bio(134).sigWidth=1;
bio(134).sigAddress='&bump_stim_B.LogicalOperator_o';
...
bio(135).dim=[1,1];
bio(135).sigWidth=1;
bio(135).sigAddress='&bump_stim_B.LogicalOperator1_e';
...
bio(136).dim=[1,1];
bio(136).sigWidth=1;
bio(136).sigAddress='&bump_stim_B.LogicalOperator2_p';
...
bio(137).dim=[1,1];
bio(137).sigWidth=1;
bio(137).sigAddress='&bump_stim_B.Memory_em';
...
bio(138).dim=[1,1];
bio(138).sigWidth=1;
bio(138).sigAddress='&bump_stim_B.RelationalOperator_p';
...
bio(139).dim=[1,1];
bio(139).sigWidth=1;
bio(139).sigAddress='&bump_stim_B.Sum_k';
...
bio(140).dim=[1,1];
bio(140).sigWidth=1;
bio(140).sigAddress='&bump_stim_B.FixPtRelationalOperator_k';
...
bio(141).dim=[1,1];
bio(141).sigWidth=1;
bio(141).sigAddress='&bump_stim_B.Uk1_h';
...
bio(142).dim=[1,1];
bio(142).sigWidth=1;
bio(142).sigAddress='&bump_stim_B.Clock_d';
...
bio(143).dim=[1,1];
bio(143).sigWidth=1;
bio(143).sigAddress='&bump_stim_B.LogicalOperator_j';
...
bio(144).dim=[1,1];
bio(144).sigWidth=1;
bio(144).sigAddress='&bump_stim_B.LogicalOperator1_f';
...
bio(145).dim=[1,1];
bio(145).sigWidth=1;
bio(145).sigAddress='&bump_stim_B.LogicalOperator2_h';
...
bio(146).dim=[1,1];
bio(146).sigWidth=1;
bio(146).sigAddress='&bump_stim_B.LogicalOperator3';
...
bio(147).dim=[1,1];
bio(147).sigWidth=1;
bio(147).sigAddress='&bump_stim_B.LogicalOperator4';
...
bio(148).dim=[1,1];
bio(148).sigWidth=1;
bio(148).sigAddress='&bump_stim_B.LogicalOperator5';
...
bio(149).dim=[1,1];
bio(149).sigWidth=1;
bio(149).sigAddress='&bump_stim_B.Memory_o';
...
bio(150).dim=[1,1];
bio(150).sigWidth=1;
bio(150).sigAddress='&bump_stim_B.RelationalOperator_a';
...
bio(151).dim=[1,1];
bio(151).sigWidth=1;
bio(151).sigAddress='&bump_stim_B.Sum_g';
...
bio(152).dim=[1,1];
bio(152).sigWidth=1;
bio(152).sigAddress='&bump_stim_B.SampleandHold_a.In';
...
bio(153).dim=[1,1];
bio(153).sigWidth=1;
bio(153).sigAddress='&bump_stim_B.Clock_j';
...
bio(154).dim=[1,1];
bio(154).sigWidth=1;
bio(154).sigAddress='&bump_stim_B.RelationalOperator_f5';
...
bio(155).dim=[1,1];
bio(155).sigWidth=1;
bio(155).sigAddress='&bump_stim_B.Sum_c';
...
bio(156).dim=[1,1];
bio(156).sigWidth=1;
bio(156).sigAddress='&bump_stim_B.Derivative';
...
bio(157).dim=[1,1];
bio(157).sigWidth=1;
bio(157).sigAddress='&bump_stim_B.dG';
...
bio(158).dim=[1,1];
bio(158).sigWidth=1;
bio(158).sigAddress='&bump_stim_B.DigitalFilter';
...
bio(159).dim=[1,1];
bio(159).sigWidth=1;
bio(159).sigAddress='&bump_stim_B.DigitalFilter2';
...
bio(160).dim=[1,1];
bio(160).sigWidth=1;
bio(160).sigAddress='&bump_stim_B.Derivative_k';
...
bio(161).dim=[1,1];
bio(161).sigWidth=1;
bio(161).sigAddress='&bump_stim_B.dG_e';
...
bio(162).dim=[1,1];
bio(162).sigWidth=1;
bio(162).sigAddress='&bump_stim_B.DigitalFilter_j';
...
bio(163).dim=[1,1];
bio(163).sigWidth=1;
bio(163).sigAddress='&bump_stim_B.DigitalFilter2_n';
...
bio(164).dim=[1,1];
bio(164).sigWidth=1;
bio(164).sigAddress='&bump_stim_B.sqrtu1u1u2u2';
...
bio(165).dim=[1,1];
bio(165).sigWidth=1;
bio(165).sigAddress='&bump_stim_B.Product_c';
...
bio(166).dim=[1,1];
bio(166).sigWidth=1;
bio(166).sigAddress='&bump_stim_B.Product1_b';
...
bio(167).dim=[1,1];
bio(167).sigWidth=1;
bio(167).sigAddress='&bump_stim_B.Sum_n';
...
bio(168).dim=[1,1];
bio(168).sigWidth=1;
bio(168).sigAddress='&bump_stim_B.TrigonometricFunction_g';
...
bio(169).dim=[1,1];
bio(169).sigWidth=1;
bio(169).sigAddress='&bump_stim_B.TrigonometricFunction1_k';
...
bio(170).dim=[1,1];
bio(170).sigWidth=1;
bio(170).sigAddress='&bump_stim_B.TrigonometricFunction2_l';
...
bio(171).dim=[1,1];
bio(171).sigWidth=1;
bio(171).sigAddress='&bump_stim_B.ForIterator';
...
bio(172).dim=[1,1];
bio(172).sigWidth=1;
bio(172).sigAddress='&bump_stim_B.SerialConverter';
...
bio(173).dim=[1,1];
bio(173).sigWidth=1;
bio(173).sigAddress='&bump_stim_B.ToBits_o1';
...
bio(174).dim=[1,1];
bio(174).sigWidth=1;
bio(174).sigAddress='&bump_stim_B.ToBits_o2';
...
bio(175).dim=[1,1];
bio(175).sigWidth=1;
bio(175).sigAddress='&bump_stim_B.ToBits_o3';
...
bio(176).dim=[1,1];
bio(176).sigWidth=1;
bio(176).sigAddress='&bump_stim_B.ToBits_o4';
...
bio(177).dim=[1,1];
bio(177).sigWidth=1;
bio(177).sigAddress='&bump_stim_B.ToBits_o5';
...
bio(178).dim=[1,1];
bio(178).sigWidth=1;
bio(178).sigAddress='&bump_stim_B.ToBits_o6';
...
bio(179).dim=[1,1];
bio(179).sigWidth=1;
bio(179).sigAddress='&bump_stim_B.ToBits_o7';
...
bio(180).dim=[1,1];
bio(180).sigWidth=1;
bio(180).sigAddress='&bump_stim_B.ToBits_o8';
...
bio(181).dim=[1,1];
bio(181).sigWidth=1;
bio(181).sigAddress='&bump_stim_B.ToBits1_o1';
...
bio(182).dim=[1,1];
bio(182).sigWidth=1;
bio(182).sigAddress='&bump_stim_B.ToBits1_o2';
...
bio(183).dim=[1,1];
bio(183).sigWidth=1;
bio(183).sigAddress='&bump_stim_B.ToBits1_o3';
...
bio(184).dim=[1,1];
bio(184).sigWidth=1;
bio(184).sigAddress='&bump_stim_B.ToBits1_o4';
...
bio(185).dim=[1,1];
bio(185).sigWidth=1;
bio(185).sigAddress='&bump_stim_B.ToBits1_o5';
...
bio(186).dim=[1,1];
bio(186).sigWidth=1;
bio(186).sigAddress='&bump_stim_B.ToBits1_o6';
...
bio(187).dim=[1,1];
bio(187).sigWidth=1;
bio(187).sigAddress='&bump_stim_B.ToBits1_o7';
...
bio(188).dim=[1,1];
bio(188).sigWidth=1;
bio(188).sigAddress='&bump_stim_B.ToBits1_o8';
...
bio(189).dim=[1,1];
bio(189).sigWidth=1;
bio(189).sigAddress='&bump_stim_B.xPCTargetTime';
...
bio(190).dim=[1,1];
bio(190).sigWidth=1;
bio(190).sigAddress='&bump_stim_B.Add_p';
...
bio(191).dim=[1,1];
bio(191).sigWidth=1;
bio(191).sigAddress='&bump_stim_B.Add1_j';
...
bio(192).dim=[1,1];
bio(192).sigWidth=1;
bio(192).sigAddress='&bump_stim_B.Switch_e';
...
bio(193).dim=[2,2];
bio(193).sigWidth=4;
bio(193).sigAddress='&bump_stim_B.MatrixConcatenate2[0]';
...
bio(194).dim=[2,2];
bio(194).sigWidth=4;
bio(194).sigAddress='&bump_stim_B.MatrixConcatenate2[0]';
...
bio(195).dim=[2,2];
bio(195).sigWidth=4;
bio(195).sigAddress='&bump_stim_B.MatrixConcatenate2[0]';
...
bio(196).dim=[2,2];
bio(196).sigWidth=4;
bio(196).sigAddress='&bump_stim_B.MatrixConcatenate2[0]';
...
bio(197).dim=[2,2];
bio(197).sigWidth=4;
bio(197).sigAddress='&bump_stim_B.MatrixConcatenate2[0]';
...
bio(198).dim=[2,2];
bio(198).sigWidth=4;
bio(198).sigAddress='&bump_stim_B.MatrixConcatenate2[0]';
...
bio(199).dim=[1,1];
bio(199).sigWidth=1;
bio(199).sigAddress='&bump_stim_B.Product';
...
bio(200).dim=[1,1];
bio(200).sigWidth=1;
bio(200).sigAddress='&bump_stim_B.Product1';
...
bio(201).dim=[1,1];
bio(201).sigWidth=1;
bio(201).sigAddress='&bump_stim_B.Product2';
...
bio(202).dim=[1,1];
bio(202).sigWidth=1;
bio(202).sigAddress='&bump_stim_B.Product3';
...
bio(203).dim=[1,1];
bio(203).sigWidth=1;
bio(203).sigAddress='&bump_stim_B.Sum1_o';
...
bio(204).dim=[1,1];
bio(204).sigWidth=1;
bio(204).sigAddress='&bump_stim_B.Sum2';
...
bio(205).dim=[1,1];
bio(205).sigWidth=1;
bio(205).sigAddress='&bump_stim_B.Sum3_l';
...
bio(206).dim=[1,1];
bio(206).sigWidth=1;
bio(206).sigAddress='&bump_stim_B.Sum4';
...
bio(207).dim=[1,1];
bio(207).sigWidth=1;
bio(207).sigAddress='&bump_stim_B.TrigonometricFunction';
...
bio(208).dim=[1,1];
bio(208).sigWidth=1;
bio(208).sigAddress='&bump_stim_B.TrigonometricFunction1';
...
bio(209).dim=[1,1];
bio(209).sigWidth=1;
bio(209).sigAddress='&bump_stim_B.TrigonometricFunction2';
...
bio(210).dim=[1,1];
bio(210).sigWidth=1;
bio(210).sigAddress='&bump_stim_B.TrigonometricFunction3';
...
bio(211).dim=[1,1];
bio(211).sigWidth=1;
bio(211).sigAddress='&bump_stim_B.dX';
...
bio(212).dim=[1,1];
bio(212).sigWidth=1;
bio(212).sigAddress='&bump_stim_B.dY';
...
bio(213).dim=[1,1];
bio(213).sigWidth=1;
bio(213).sigAddress='&bump_stim_B.dZ';
...
bio(214).dim=[1,1];
bio(214).sigWidth=1;
bio(214).sigAddress='&bump_stim_B.product1';
...
bio(215).dim=[1,1];
bio(215).sigWidth=1;
bio(215).sigAddress='&bump_stim_B.product2';
...
bio(216).dim=[1,1];
bio(216).sigWidth=1;
bio(216).sigAddress='&bump_stim_B.product3';
...
bio(217).dim=[1,1];
bio(217).sigWidth=1;
bio(217).sigAddress='&bump_stim_B.product4';
...
bio(218).dim=[1,1];
bio(218).sigWidth=1;
bio(218).sigAddress='&bump_stim_B.Add1';
...
bio(219).dim=[1,1];
bio(219).sigWidth=1;
bio(219).sigAddress='&bump_stim_B.Add2';
...
bio(220).dim=[1,1];
bio(220).sigWidth=1;
bio(220).sigAddress='&bump_stim_B.Add3';
...
bio(221).dim=[1,1];
bio(221).sigWidth=1;
bio(221).sigAddress='&bump_stim_B.Add4';
...
bio(222).dim=[1,1];
bio(222).sigWidth=1;
bio(222).sigAddress='&bump_stim_B.AddX';
...
bio(223).dim=[1,1];
bio(223).sigWidth=1;
bio(223).sigAddress='&bump_stim_B.AddX1';
...
bio(224).dim=[1,1];
bio(224).sigWidth=1;
bio(224).sigAddress='&bump_stim_B.AddX2';
...
bio(225).dim=[1,1];
bio(225).sigWidth=1;
bio(225).sigAddress='&bump_stim_B.x_e';
...
bio(226).dim=[1,1];
bio(226).sigWidth=1;
bio(226).sigAddress='&bump_stim_B.y';
...
bio(227).dim=[1,1];
bio(227).sigWidth=1;
bio(227).sigAddress='&bump_stim_B.z';
...
bio(228).dim=[1,1];
bio(228).sigWidth=1;
bio(228).sigAddress='&bump_stim_B.dX_b';
...
bio(229).dim=[1,1];
bio(229).sigWidth=1;
bio(229).sigAddress='&bump_stim_B.dY_a';
...
bio(230).dim=[1,1];
bio(230).sigWidth=1;
bio(230).sigAddress='&bump_stim_B.dZ_f';
...
bio(231).dim=[1,1];
bio(231).sigWidth=1;
bio(231).sigAddress='&bump_stim_B.product1_o';
...
bio(232).dim=[1,1];
bio(232).sigWidth=1;
bio(232).sigAddress='&bump_stim_B.product2_i';
...
bio(233).dim=[1,1];
bio(233).sigWidth=1;
bio(233).sigAddress='&bump_stim_B.product3_g';
...
bio(234).dim=[1,1];
bio(234).sigWidth=1;
bio(234).sigAddress='&bump_stim_B.product4_g';
...
bio(235).dim=[1,1];
bio(235).sigWidth=1;
bio(235).sigAddress='&bump_stim_B.Add1_m';
...
bio(236).dim=[1,1];
bio(236).sigWidth=1;
bio(236).sigAddress='&bump_stim_B.Add2_h';
...
bio(237).dim=[1,1];
bio(237).sigWidth=1;
bio(237).sigAddress='&bump_stim_B.Add3_b';
...
bio(238).dim=[1,1];
bio(238).sigWidth=1;
bio(238).sigAddress='&bump_stim_B.Add4_i';
...
bio(239).dim=[1,1];
bio(239).sigWidth=1;
bio(239).sigAddress='&bump_stim_B.AddX_d';
...
bio(240).dim=[1,1];
bio(240).sigWidth=1;
bio(240).sigAddress='&bump_stim_B.AddX1_f';
...
bio(241).dim=[1,1];
bio(241).sigWidth=1;
bio(241).sigAddress='&bump_stim_B.AddX2_b';
...
bio(242).dim=[1,1];
bio(242).sigWidth=1;
bio(242).sigAddress='&bump_stim_B.x_hx';
...
bio(243).dim=[1,1];
bio(243).sigWidth=1;
bio(243).sigAddress='&bump_stim_B.y_o';
...
bio(244).dim=[1,1];
bio(244).sigWidth=1;
bio(244).sigAddress='&bump_stim_B.z_e';
...
bio(245).dim=[1,1];
bio(245).sigWidth=1;
bio(245).sigAddress='&bump_stim_B.dX_g';
...
bio(246).dim=[1,1];
bio(246).sigWidth=1;
bio(246).sigAddress='&bump_stim_B.dY_k';
...
bio(247).dim=[1,1];
bio(247).sigWidth=1;
bio(247).sigAddress='&bump_stim_B.dZ_p';
...
bio(248).dim=[1,1];
bio(248).sigWidth=1;
bio(248).sigAddress='&bump_stim_B.product1_b';
...
bio(249).dim=[1,1];
bio(249).sigWidth=1;
bio(249).sigAddress='&bump_stim_B.product2_io';
...
bio(250).dim=[1,1];
bio(250).sigWidth=1;
bio(250).sigAddress='&bump_stim_B.product3_i';
...
bio(251).dim=[1,1];
bio(251).sigWidth=1;
bio(251).sigAddress='&bump_stim_B.product4_m';
...
bio(252).dim=[1,1];
bio(252).sigWidth=1;
bio(252).sigAddress='&bump_stim_B.Add1_e';
...
bio(253).dim=[1,1];
bio(253).sigWidth=1;
bio(253).sigAddress='&bump_stim_B.Add2_l';
...
bio(254).dim=[1,1];
bio(254).sigWidth=1;
bio(254).sigAddress='&bump_stim_B.Add3_c';
...
bio(255).dim=[1,1];
bio(255).sigWidth=1;
bio(255).sigAddress='&bump_stim_B.Add4_m';
...
bio(256).dim=[1,1];
bio(256).sigWidth=1;
bio(256).sigAddress='&bump_stim_B.AddX_b';
...
bio(257).dim=[1,1];
bio(257).sigWidth=1;
bio(257).sigAddress='&bump_stim_B.AddX1_h';
...
bio(258).dim=[1,1];
bio(258).sigWidth=1;
bio(258).sigAddress='&bump_stim_B.AddX2_bo';
...
bio(259).dim=[1,1];
bio(259).sigWidth=1;
bio(259).sigAddress='&bump_stim_B.x_ei';
...
bio(260).dim=[1,1];
bio(260).sigWidth=1;
bio(260).sigAddress='&bump_stim_B.y_g';
...
bio(261).dim=[1,1];
bio(261).sigWidth=1;
bio(261).sigAddress='&bump_stim_B.z_p';
...
bio(262).dim=[1,1];
bio(262).sigWidth=1;
bio(262).sigAddress='&bump_stim_B.dX_e';
...
bio(263).dim=[1,1];
bio(263).sigWidth=1;
bio(263).sigAddress='&bump_stim_B.dY_c';
...
bio(264).dim=[1,1];
bio(264).sigWidth=1;
bio(264).sigAddress='&bump_stim_B.dZ_h';
...
bio(265).dim=[1,1];
bio(265).sigWidth=1;
bio(265).sigAddress='&bump_stim_B.product1_j';
...
bio(266).dim=[1,1];
bio(266).sigWidth=1;
bio(266).sigAddress='&bump_stim_B.product2_f';
...
bio(267).dim=[1,1];
bio(267).sigWidth=1;
bio(267).sigAddress='&bump_stim_B.product3_c';
...
bio(268).dim=[1,1];
bio(268).sigWidth=1;
bio(268).sigAddress='&bump_stim_B.product4_h';
...
bio(269).dim=[1,1];
bio(269).sigWidth=1;
bio(269).sigAddress='&bump_stim_B.Add1_f';
...
bio(270).dim=[1,1];
bio(270).sigWidth=1;
bio(270).sigAddress='&bump_stim_B.Add2_m';
...
bio(271).dim=[1,1];
bio(271).sigWidth=1;
bio(271).sigAddress='&bump_stim_B.Add3_e';
...
bio(272).dim=[1,1];
bio(272).sigWidth=1;
bio(272).sigAddress='&bump_stim_B.Add4_l';
...
bio(273).dim=[1,1];
bio(273).sigWidth=1;
bio(273).sigAddress='&bump_stim_B.AddX_i';
...
bio(274).dim=[1,1];
bio(274).sigWidth=1;
bio(274).sigAddress='&bump_stim_B.AddX1_l';
...
bio(275).dim=[1,1];
bio(275).sigWidth=1;
bio(275).sigAddress='&bump_stim_B.AddX2_a';
...
bio(276).dim=[1,1];
bio(276).sigWidth=1;
bio(276).sigAddress='&bump_stim_B.x_j';
...
bio(277).dim=[1,1];
bio(277).sigWidth=1;
bio(277).sigAddress='&bump_stim_B.y_h';
...
bio(278).dim=[1,1];
bio(278).sigWidth=1;
bio(278).sigAddress='&bump_stim_B.z_k';
...
bio(279).dim=[1,1];
bio(279).sigWidth=1;
bio(279).sigAddress='&bump_stim_B.dX_k';
...
bio(280).dim=[1,1];
bio(280).sigWidth=1;
bio(280).sigAddress='&bump_stim_B.dY_p';
...
bio(281).dim=[1,1];
bio(281).sigWidth=1;
bio(281).sigAddress='&bump_stim_B.dZ_n';
...
bio(282).dim=[1,1];
bio(282).sigWidth=1;
bio(282).sigAddress='&bump_stim_B.product1_g';
...
bio(283).dim=[1,1];
bio(283).sigWidth=1;
bio(283).sigAddress='&bump_stim_B.product2_ft';
...
bio(284).dim=[1,1];
bio(284).sigWidth=1;
bio(284).sigAddress='&bump_stim_B.product3_a';
...
bio(285).dim=[1,1];
bio(285).sigWidth=1;
bio(285).sigAddress='&bump_stim_B.product4_b';
...
bio(286).dim=[1,1];
bio(286).sigWidth=1;
bio(286).sigAddress='&bump_stim_B.Add1_n';
...
bio(287).dim=[1,1];
bio(287).sigWidth=1;
bio(287).sigAddress='&bump_stim_B.Add2_i';
...
bio(288).dim=[1,1];
bio(288).sigWidth=1;
bio(288).sigAddress='&bump_stim_B.Add3_p';
...
bio(289).dim=[1,1];
bio(289).sigWidth=1;
bio(289).sigAddress='&bump_stim_B.Add4_h';
...
bio(290).dim=[1,1];
bio(290).sigWidth=1;
bio(290).sigAddress='&bump_stim_B.AddX_k';
...
bio(291).dim=[1,1];
bio(291).sigWidth=1;
bio(291).sigAddress='&bump_stim_B.AddX1_a';
...
bio(292).dim=[1,1];
bio(292).sigWidth=1;
bio(292).sigAddress='&bump_stim_B.AddX2_n';
...
bio(293).dim=[1,1];
bio(293).sigWidth=1;
bio(293).sigAddress='&bump_stim_B.x';
...
bio(294).dim=[1,1];
bio(294).sigWidth=1;
bio(294).sigAddress='&bump_stim_B.y_l';
...
bio(295).dim=[1,1];
bio(295).sigWidth=1;
bio(295).sigAddress='&bump_stim_B.z_o';
...
bio(296).dim=[1,1];
bio(296).sigWidth=1;
bio(296).sigAddress='&bump_stim_B.dX_f';
...
bio(297).dim=[1,1];
bio(297).sigWidth=1;
bio(297).sigAddress='&bump_stim_B.dY_h';
...
bio(298).dim=[1,1];
bio(298).sigWidth=1;
bio(298).sigAddress='&bump_stim_B.dZ_nw';
...
bio(299).dim=[1,1];
bio(299).sigWidth=1;
bio(299).sigAddress='&bump_stim_B.product1_k';
...
bio(300).dim=[1,1];
bio(300).sigWidth=1;
bio(300).sigAddress='&bump_stim_B.product2_j';
...
bio(301).dim=[1,1];
bio(301).sigWidth=1;
bio(301).sigAddress='&bump_stim_B.product3_m';
...
bio(302).dim=[1,1];
bio(302).sigWidth=1;
bio(302).sigAddress='&bump_stim_B.product4_f';
...
bio(303).dim=[1,1];
bio(303).sigWidth=1;
bio(303).sigAddress='&bump_stim_B.Add1_b';
...
bio(304).dim=[1,1];
bio(304).sigWidth=1;
bio(304).sigAddress='&bump_stim_B.Add2_d';
...
bio(305).dim=[1,1];
bio(305).sigWidth=1;
bio(305).sigAddress='&bump_stim_B.Add3_cz';
...
bio(306).dim=[1,1];
bio(306).sigWidth=1;
bio(306).sigAddress='&bump_stim_B.Add4_c';
...
bio(307).dim=[1,1];
bio(307).sigWidth=1;
bio(307).sigAddress='&bump_stim_B.AddX_p';
...
bio(308).dim=[1,1];
bio(308).sigWidth=1;
bio(308).sigAddress='&bump_stim_B.AddX1_p';
...
bio(309).dim=[1,1];
bio(309).sigWidth=1;
bio(309).sigAddress='&bump_stim_B.AddX2_g';
...
bio(310).dim=[1,1];
bio(310).sigWidth=1;
bio(310).sigAddress='&bump_stim_B.x_p';
...
bio(311).dim=[1,1];
bio(311).sigWidth=1;
bio(311).sigAddress='&bump_stim_B.y_m';
...
bio(312).dim=[1,1];
bio(312).sigWidth=1;
bio(312).sigAddress='&bump_stim_B.z_pl';
...
bio(313).dim=[1,1];
bio(313).sigWidth=1;
bio(313).sigAddress='&bump_stim_B.dX_kk';
...
bio(314).dim=[1,1];
bio(314).sigWidth=1;
bio(314).sigAddress='&bump_stim_B.dY_l';
...
bio(315).dim=[1,1];
bio(315).sigWidth=1;
bio(315).sigAddress='&bump_stim_B.dZ_m';
...
bio(316).dim=[1,1];
bio(316).sigWidth=1;
bio(316).sigAddress='&bump_stim_B.product1_p';
...
bio(317).dim=[1,1];
bio(317).sigWidth=1;
bio(317).sigAddress='&bump_stim_B.product2_e';
...
bio(318).dim=[1,1];
bio(318).sigWidth=1;
bio(318).sigAddress='&bump_stim_B.product3_au';
...
bio(319).dim=[1,1];
bio(319).sigWidth=1;
bio(319).sigAddress='&bump_stim_B.product4_i';
...
bio(320).dim=[1,1];
bio(320).sigWidth=1;
bio(320).sigAddress='&bump_stim_B.Add1_p';
...
bio(321).dim=[1,1];
bio(321).sigWidth=1;
bio(321).sigAddress='&bump_stim_B.Add2_dx';
...
bio(322).dim=[1,1];
bio(322).sigWidth=1;
bio(322).sigAddress='&bump_stim_B.Add3_bv';
...
bio(323).dim=[1,1];
bio(323).sigWidth=1;
bio(323).sigAddress='&bump_stim_B.Add4_a';
...
bio(324).dim=[1,1];
bio(324).sigWidth=1;
bio(324).sigAddress='&bump_stim_B.AddX_e';
...
bio(325).dim=[1,1];
bio(325).sigWidth=1;
bio(325).sigAddress='&bump_stim_B.AddX1_e';
...
bio(326).dim=[1,1];
bio(326).sigWidth=1;
bio(326).sigAddress='&bump_stim_B.AddX2_c';
...
bio(327).dim=[1,1];
bio(327).sigWidth=1;
bio(327).sigAddress='&bump_stim_B.x_b';
...
bio(328).dim=[1,1];
bio(328).sigWidth=1;
bio(328).sigAddress='&bump_stim_B.y_d';
...
bio(329).dim=[1,1];
bio(329).sigWidth=1;
bio(329).sigAddress='&bump_stim_B.z_m';
...
bio(330).dim=[1,1];
bio(330).sigWidth=1;
bio(330).sigAddress='&bump_stim_B.dX_fv';
...
bio(331).dim=[1,1];
bio(331).sigWidth=1;
bio(331).sigAddress='&bump_stim_B.dY_d';
...
bio(332).dim=[1,1];
bio(332).sigWidth=1;
bio(332).sigAddress='&bump_stim_B.dZ_g';
...
bio(333).dim=[1,1];
bio(333).sigWidth=1;
bio(333).sigAddress='&bump_stim_B.product1_gt';
...
bio(334).dim=[1,1];
bio(334).sigWidth=1;
bio(334).sigAddress='&bump_stim_B.product2_iv';
...
bio(335).dim=[1,1];
bio(335).sigWidth=1;
bio(335).sigAddress='&bump_stim_B.product3_n';
...
bio(336).dim=[1,1];
bio(336).sigWidth=1;
bio(336).sigAddress='&bump_stim_B.product4_n';
...
bio(337).dim=[1,1];
bio(337).sigWidth=1;
bio(337).sigAddress='&bump_stim_B.Add1_d';
...
bio(338).dim=[1,1];
bio(338).sigWidth=1;
bio(338).sigAddress='&bump_stim_B.Add2_j';
...
bio(339).dim=[1,1];
bio(339).sigWidth=1;
bio(339).sigAddress='&bump_stim_B.Add3_l';
...
bio(340).dim=[1,1];
bio(340).sigWidth=1;
bio(340).sigAddress='&bump_stim_B.Add4_c0';
...
bio(341).dim=[1,1];
bio(341).sigWidth=1;
bio(341).sigAddress='&bump_stim_B.AddX_g';
...
bio(342).dim=[1,1];
bio(342).sigWidth=1;
bio(342).sigAddress='&bump_stim_B.AddX1_c';
...
bio(343).dim=[1,1];
bio(343).sigWidth=1;
bio(343).sigAddress='&bump_stim_B.AddX2_h';
...
bio(344).dim=[1,1];
bio(344).sigWidth=1;
bio(344).sigAddress='&bump_stim_B.x_h';
...
bio(345).dim=[1,1];
bio(345).sigWidth=1;
bio(345).sigAddress='&bump_stim_B.y_e';
...
bio(346).dim=[1,1];
bio(346).sigWidth=1;
bio(346).sigAddress='&bump_stim_B.z_h';
...
bio(347).dim=[2,2];
bio(347).sigWidth=4;
bio(347).sigAddress='&bump_stim_B.MathFunction[0]';
...
bio(348).dim=[1,1];
bio(348).sigWidth=1;
bio(348).sigAddress='&bump_stim_B.Compare';
...
bio(349).dim=[1,1];
bio(349).sigWidth=1;
bio(349).sigAddress='&bump_stim_B.EnabledSubsystem.In1';
...
bio(350).dim=[1,1];
bio(350).sigWidth=1;
bio(350).sigAddress='&bump_stim_B.Compare_mv';
...
bio(351).dim=[1,1];
bio(351).sigWidth=1;
bio(351).sigAddress='&bump_stim_B.Compare_l';
...
bio(352).dim=[1,1];
bio(352).sigWidth=1;
bio(352).sigAddress='&bump_stim_B.Compare_p';
...
bio(353).dim=[1,1];
bio(353).sigWidth=1;
bio(353).sigAddress='&bump_stim_B.Compare_mc';
...
bio(354).dim=[1,1];
bio(354).sigWidth=1;
bio(354).sigAddress='&bump_stim_B.Compare_n';
...
bio(355).dim=[1,1];
bio(355).sigWidth=1;
bio(355).sigAddress='&bump_stim_B.EnabledSubsystem_c.In1';
...
bio(356).dim=[1,1];
bio(356).sigWidth=1;
bio(356).sigAddress='&bump_stim_B.Compare_b1';
...
bio(357).dim=[1,1];
bio(357).sigWidth=1;
bio(357).sigAddress='&bump_stim_B.EnabledSubsystem_f.In1';
...
bio(358).dim=[1,1];
bio(358).sigWidth=1;
bio(358).sigAddress='&bump_stim_B.Compare_k';
...
bio(359).dim=[1,1];
bio(359).sigWidth=1;
bio(359).sigAddress='&bump_stim_B.EnabledSubsystem_o.In1';
...
bio(360).dim=[1,1];
bio(360).sigWidth=1;
bio(360).sigAddress='&bump_stim_B.Compare_g';
...
bio(361).dim=[1,1];
bio(361).sigWidth=1;
bio(361).sigAddress='&bump_stim_B.Compare_m5';
...
bio(362).dim=[1,1];
bio(362).sigWidth=1;
bio(362).sigAddress='&bump_stim_B.FixPtRelationalOperator';
...
bio(363).dim=[1,1];
bio(363).sigWidth=1;
bio(363).sigAddress='&bump_stim_B.Uk1';
...
bio(364).dim=[1,1];
bio(364).sigWidth=1;
bio(364).sigAddress='&bump_stim_B.EnabledSubsystem_l.In1';
...
bio(365).dim=[1,1];
bio(365).sigWidth=1;
bio(365).sigAddress='&bump_stim_B.SampleandHold.In';
...
bio(366).dim=[1,1];
bio(366).sigWidth=1;
bio(366).sigAddress='&bump_stim_B.ScaleTouSec';
...
bio(367).dim=[1,1];
bio(367).sigWidth=1;
bio(367).sigAddress='&bump_stim_B.xPCTargetTime_c';
...
bio(368).dim=[1,1];
bio(368).sigWidth=1;
bio(368).sigAddress='&bump_stim_B.Subtract';
...
bio(369).dim=[1,1];
bio(369).sigWidth=1;
bio(369).sigAddress='&bump_stim_B.Switch_j';
...
bio(370).dim=[1,1];
bio(370).sigWidth=1;
bio(370).sigAddress='&bump_stim_B.Compare_me';
...
bio(371).dim=[1,1];
bio(371).sigWidth=1;
bio(371).sigAddress='&bump_stim_B.Compare_c';
...
bio(372).dim=[1,1];
bio(372).sigWidth=1;
bio(372).sigAddress='&bump_stim_B.Compare_a';
