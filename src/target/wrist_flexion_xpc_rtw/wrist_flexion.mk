...
MODEL           = wrist_flexion
MODULES         = rt_atan2.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c wrist_flexion_capi.c wrist_flexion_data.c 
MAKEFILE        = wrist_flexion.mk
...
S_FUNCTIONS     = xpctimeinfo.c donipcie.c Byte2Bits.c dopci8255.c serPos.c adnipcie.c xpcudpbytereceive.c mastercon_wf.c xpcudpbytesend.c
S_FUNCTIONS_LIB = 
NUMST           = 4
TID01EQ         = 1
NCSTATES        = 18
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\David\Desktop\Behavior\trunk\src\target\WRIST_~1
