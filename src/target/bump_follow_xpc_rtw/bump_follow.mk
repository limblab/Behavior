...
MODEL           = bump_follow
MODULES         = bump_follow_capi.c bump_follow_data.c rt_atan2.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c 
MAKEFILE        = bump_follow.mk
...
S_FUNCTIONS     = xpctimeinfo.c donipcie.c Byte2Bits.c dopci8255.c serPos.c enccbcioquadcount.c adnipcie.c mastercon_bf.c danipcie.c xpcudpbytesend.c
S_FUNCTIONS_LIB = 
NUMST           = 3
TID01EQ         = 1
NCSTATES        = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\MATTHE~1\Desktop\RICARD~3\trunk\src\target\BUMP_F~1
