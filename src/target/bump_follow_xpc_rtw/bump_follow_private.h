 ...
 */
#ifndef _RTW_HEADER_bump_follow_private_h_
#define _RTW_HEADER_bump_follow_private_h_
#include "rtwtypes.h"
...
extern void mastercon_bf(SimStruct *rts);
...
#endif                                 /* _RTW_HEADER_bump_follow_private_h_ */
