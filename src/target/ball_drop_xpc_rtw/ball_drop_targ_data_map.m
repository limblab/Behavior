  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(66).dtTransOffset = 117;
	  ...
	  ;% ball_drop_P.Constant_Value_f
	  section.data(74).logicalSrcIdx = 73;
	  section.data(74).dtTransOffset = 126;
	
	  ;% ball_drop_P.Constant1_Value_h
	  section.data(75).logicalSrcIdx = 74;
	  section.data(75).dtTransOffset = 127;
	
	  ;% ball_drop_P.xPCTargetTime_P1_Size
	  section.data(76).logicalSrcIdx = 75;
	  section.data(76).dtTransOffset = 128;
	
	  ;% ball_drop_P.xPCTargetTime_P1
	  section.data(77).logicalSrcIdx = 76;
	  section.data(77).dtTransOffset = 130;
	
	  ;% ball_drop_P.xPCTargetTime_P2_Size
	  section.data(78).logicalSrcIdx = 77;
	  section.data(78).dtTransOffset = 131;
	
	  ;% ball_drop_P.xPCTargetTime_P2
	  section.data(79).logicalSrcIdx = 78;
	  section.data(79).dtTransOffset = 133;
	
	  ;% ball_drop_P.ScaleTouSec_Gain
	  ...
	  ;% ball_drop_P.PCI6025E_P1_Size
	  section.data(82).logicalSrcIdx = 81;
	  section.data(82).dtTransOffset = 136;
	
	  ;% ball_drop_P.PCI6025E_P1
	  section.data(83).logicalSrcIdx = 82;
	  section.data(83).dtTransOffset = 138;
	
	  ;% ball_drop_P.PCI6025E_P2_Size
	  section.data(84).logicalSrcIdx = 83;
	  section.data(84).dtTransOffset = 140;
	
	  ;% ball_drop_P.PCI6025E_P2
	  section.data(85).logicalSrcIdx = 84;
	  section.data(85).dtTransOffset = 142;
	
	  ;% ball_drop_P.PCI6025E_P3_Size
	  section.data(86).logicalSrcIdx = 85;
	  section.data(86).dtTransOffset = 144;
	
	  ;% ball_drop_P.PCI6025E_P3
	  section.data(87).logicalSrcIdx = 86;
	  section.data(87).dtTransOffset = 146;
	
	  ;% ball_drop_P.PCI6025E_P4_Size
	  section.data(88).logicalSrcIdx = 87;
	  section.data(88).dtTransOffset = 148;
	
	  ;% ball_drop_P.PCI6025E_P4
	  section.data(89).logicalSrcIdx = 88;
	  section.data(89).dtTransOffset = 150;
	
	  ;% ball_drop_P.PCI6025E_P5_Size
	  section.data(90).logicalSrcIdx = 89;
	  section.data(90).dtTransOffset = 151;
	
	  ;% ball_drop_P.PCI6025E_P5
	  section.data(91).logicalSrcIdx = 90;
	  section.data(91).dtTransOffset = 153;
	
	  ;% ball_drop_P.PCI6025E_P6_Size
	  section.data(92).logicalSrcIdx = 91;
	  section.data(92).dtTransOffset = 154;
	
	  ;% ball_drop_P.PCI6025E_P6
	  section.data(93).logicalSrcIdx = 92;
	  section.data(93).dtTransOffset = 156;
	
	  ;% ball_drop_P.PCI6025E_P7_Size
	  section.data(94).logicalSrcIdx = 93;
	  section.data(94).dtTransOffset = 157;
	
	  ;% ball_drop_P.PCI6025E_P7
	  ...
	  ;% ball_drop_P.Switch_Threshold_j
	  ...
	  section.data(99).dtTransOffset = 164;
	  ...
	  section.data(103).dtTransOffset = 177;
	
	  ;% ball_drop_P.PortA_P4_Size
	  section.data(104).logicalSrcIdx = 103;
	  section.data(104).dtTransOffset = 185;
	  ...
	  section.data(106).dtTransOffset = 195;
	  ...
	  section.data(109).dtTransOffset = 200;
	
	  ;% ball_drop_P.PortA_P7_Size
	  section.data(110).logicalSrcIdx = 109;
	  section.data(110).dtTransOffset = 201;
	  ...
	  section.data(115).dtTransOffset = 209;
	
	  ;% ball_drop_P.xPCTargetTime_P1_Size_a
	  section.data(116).logicalSrcIdx = 115;
	  section.data(116).dtTransOffset = 210;
	
	  ;% ball_drop_P.xPCTargetTime_P1_f
	  section.data(117).logicalSrcIdx = 116;
	  section.data(117).dtTransOffset = 212;
	
	  ;% ball_drop_P.xPCTargetTime_P2_Size_c
	  section.data(118).logicalSrcIdx = 117;
	  section.data(118).dtTransOffset = 213;
	
	  ;% ball_drop_P.xPCTargetTime_P2_c
	  section.data(119).logicalSrcIdx = 118;
	  section.data(119).dtTransOffset = 215;
	
	  ;% ball_drop_P.DelayInput1_X0
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% ball_drop_B.ForIterator
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 46;
	
	  ;% ball_drop_B.Switch_e
	  section.data(31).logicalSrcIdx = 30;
	  ...
	  ;% ball_drop_B.ScaleTouSec
	  section.data(44).logicalSrcIdx = 43;
	  section.data(44).dtTransOffset = 60;
	
	  ;% ball_drop_B.Switch_g
	  section.data(45).logicalSrcIdx = 44;
	  section.data(45).dtTransOffset = 61;
	
	  ;% ball_drop_B.DataTypeConversion_g
	  section.data(46).logicalSrcIdx = 45;
	  ...
	  section.data(3).dtTransOffset = 224;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% ball_drop_DWork.DelayInput1_DSTATE
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	  ...
	  ;% ball_drop_DWork.BehaviorBD_PWORK
	  ...
	  section.data(5).dtTransOffset = 81;
	  ...
	  section.data(7).dtTransOffset = 83;
	  ...
	  ;% ball_drop_DWork.PCI6025E_IWORK
  ...
  targMap.checksum0 = 3333319913;
  targMap.checksum1 = 1643193060;
  targMap.checksum2 = 1574781285;
  targMap.checksum3 = 2099261527;
