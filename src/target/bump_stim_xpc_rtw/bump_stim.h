 ...
 */
#ifndef _RTW_HEADER_bump_stim_h_
#define _RTW_HEADER_bump_stim_h_
#include "rtw_modelmap.h"
#ifndef _bump_stim_COMMON_INCLUDES_
# define _bump_stim_COMMON_INCLUDES_
#include <stddef.h>
#include <math.h>
#include <windows.h>
...
#endif                                 /* _bump_stim_COMMON_INCLUDES_ */

#include "bump_stim_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define bump_stim_M                    bump_stim_rtM

/* Definition for use in the target main file */
#define bump_stim_rtModel              rtModel_bump_stim

/* Block signals for system '<S31>/Enabled Subsystem' */
typedef struct {
  real_T In1;                          /* '<S35>/In1' */
} rtB_EnabledSubsystem_bump_stim;
...
typedef struct {
  ...
  real_T Sum3_l;                       /* '<S71>/Sum3' */
  real_T Sum1_o;                       /* '<S71>/Sum1' */
  real_T TrigonometricFunction1_k;     /* '<S69>/Trigonometric Function1' */
  real_T Sum_n;                        /* '<S69>/Sum' */
  real_T TrigonometricFunction2_l;     /* '<S69>/Trigonometric Function2' */
  real_T sqrtu1u1u2u2;                 /* '<S69>/sqrt(u[1]*u[1] + u[2]*u[2])' */
  real_T Product1_b;                   /* '<S69>/Product1' */
  real_T DigitalFilter2;               /* '<S67>/Digital Filter2' */
  real_T Derivative;                   /* '<S67>/Derivative' */
  real_T dG;                           /* '<S67>/dG' */
  real_T DigitalFilter;                /* '<S67>/Digital Filter' */
  real_T TrigonometricFunction_g;      /* '<S69>/Trigonometric Function' */
  real_T Product_c;                    /* '<S69>/Product' */
  real_T DigitalFilter2_n;             /* '<S68>/Digital Filter2' */
  real_T Derivative_k;                 /* '<S68>/Derivative' */
  real_T dG_e;                         /* '<S68>/dG' */
  real_T DigitalFilter_j;              /* '<S68>/Digital Filter' */
  real_T Switch[2];                    /* '<S10>/Switch' */
  real_T Clock_c;                      /* '<S43>/Clock' */
  real_T Clock_d;                      /* '<S47>/Clock' */
  real_T Sum_g;                        /* '<S47>/Sum' */
  real_T Sum_b;                        /* '<S43>/Sum' */
  real_T Abs2;                         /* '<S40>/Abs2' */
  real_T Abs3;                         /* '<S40>/Abs3' */
  real_T Clock_a;                      /* '<S45>/Clock' */
  real_T Sum_k;                        /* '<S45>/Sum' */
  real_T Clock_n;                      /* '<S44>/Clock' */
  real_T Sum_gv;                       /* '<S44>/Sum' */
  real_T x;                            /* '<S23>/x' */
  real_T x_p;                          /* '<S24>/x' */
  real_T Add;                          /* '<S21>/Add' */
  real_T x_b;                          /* '<S25>/x' */
  ...
  real_T x_e;                          /* '<S17>/x' */
  real_T x_hx;                         /* '<S18>/x' */
  real_T Add_d;                        /* '<S15>/Add' */
  real_T x_ei;                         /* '<S19>/x' */
  real_T x_j;                          /* '<S20>/x' */
  real_T LoadSelectSwitch[2];          /* '<S2>/LoadSelect Switch' */
  real_T BehaviorBS_o1[2];             /* '<Root>/Behavior BS' */
  real_T BehaviorBS_o2[5];             /* '<Root>/Behavior BS' */
  real_T BehaviorBS_o3;                /* '<Root>/Behavior BS' */
  real_T BehaviorBS_o4[10];            /* '<Root>/Behavior BS' */
  real_T BehaviorBS_o5;                /* '<Root>/Behavior BS' */
  real_T BehaviorBS_o6[2];             /* '<Root>/Behavior BS' */
  real_T BehaviorBS_o7[4];             /* '<Root>/Behavior BS' */
  real_T BehaviorBS_o8[2];             /* '<Root>/Behavior BS' */
  real_T Switch2[2];                   /* '<S4>/Switch2' */
  real_T MG1;                          /* '<S4>/MG1' */
  real_T MG2;                          /* '<S4>/MG2' */
  real_T Clock_j;                      /* '<S65>/Clock' */
  ...
  real_T Switch_n;                     /* '<S6>/Switch' */
  real_T HiddenBuf_InsertedFor_Samplea_j;/* 'synthesized block' */
  ...
  real_T z_e;                          /* '<S18>/z' */
  real_T Add3_b;                       /* '<S18>/Add3' */
  real_T product2_i;                   /* '<S18>/product2' */
  real_T Add2_h;                       /* '<S18>/Add2' */
  real_T product3_g;                   /* '<S18>/product3' */
  real_T product4_g;                   /* '<S18>/product4' */
  real_T Add4_i;                       /* '<S18>/Add4' */
  real_T product1_o;                   /* '<S18>/product1' */
  real_T dX_b;                         /* '<S18>/dX' */
  real_T AddX_d;                       /* '<S18>/AddX' */
  real_T dY_a;                         /* '<S18>/dY' */
  real_T AddX1_f;                      /* '<S18>/AddX1' */
  real_T dZ_f;                         /* '<S18>/dZ' */
  ...
  real_T product2_io;                  /* '<S19>/product2' */
  real_T Add2_l;                       /* '<S19>/Add2' */
  real_T product3_i;                   /* '<S19>/product3' */
  real_T product4_m;                   /* '<S19>/product4' */
  real_T Add4_m;                       /* '<S19>/Add4' */
  real_T product1_b;                   /* '<S19>/product1' */
  real_T dX_g;                         /* '<S19>/dX' */
  real_T AddX_b;                       /* '<S19>/AddX' */
  real_T dY_k;                         /* '<S19>/dY' */
  real_T AddX1_h;                      /* '<S19>/AddX1' */
  real_T dZ_p;                         /* '<S19>/dZ' */
  real_T AddX2_bo;                     /* '<S19>/AddX2' */
  real_T y_h;                          /* '<S20>/y' */
  real_T Add1_f;                       /* '<S20>/Add1' */
  real_T z_k;                          /* '<S20>/z' */
  real_T Add3_e;                       /* '<S20>/Add3' */
  real_T product2_f;                   /* '<S20>/product2' */
  real_T Add2_m;                       /* '<S20>/Add2' */
  real_T product3_c;                   /* '<S20>/product3' */
  real_T product4_h;                   /* '<S20>/product4' */
  real_T Add4_l;                       /* '<S20>/Add4' */
  real_T product1_j;                   /* '<S20>/product1' */
  real_T dX_e;                         /* '<S20>/dX' */
  real_T AddX_i;                       /* '<S20>/AddX' */
  real_T dY_c;                         /* '<S20>/dY' */
  real_T AddX1_l;                      /* '<S20>/AddX1' */
  real_T dZ_h;                         /* '<S20>/dZ' */
  real_T AddX2_a;                      /* '<S20>/AddX2' */
  real_T y_l;                          /* '<S23>/y' */
  real_T Add1_n;                       /* '<S23>/Add1' */
  real_T z_o;                          /* '<S23>/z' */
  real_T Add3_p;                       /* '<S23>/Add3' */
  real_T product2_ft;                  /* '<S23>/product2' */
  real_T Add2_i;                       /* '<S23>/Add2' */
  real_T product3_a;                   /* '<S23>/product3' */
  real_T product4_b;                   /* '<S23>/product4' */
  real_T Add4_h;                       /* '<S23>/Add4' */
  real_T product1_g;                   /* '<S23>/product1' */
  real_T dX_k;                         /* '<S23>/dX' */
  real_T AddX_k;                       /* '<S23>/AddX' */
  real_T dY_p;                         /* '<S23>/dY' */
  real_T AddX1_a;                      /* '<S23>/AddX1' */
  real_T dZ_n;                         /* '<S23>/dZ' */
  real_T AddX2_n;                      /* '<S23>/AddX2' */
  real_T y_m;                          /* '<S24>/y' */
  real_T Add1_b;                       /* '<S24>/Add1' */
  real_T z_pl;                         /* '<S24>/z' */
  real_T Add3_cz;                      /* '<S24>/Add3' */
  real_T product2_j;                   /* '<S24>/product2' */
  real_T Add2_d;                       /* '<S24>/Add2' */
  real_T product3_m;                   /* '<S24>/product3' */
  real_T product4_f;                   /* '<S24>/product4' */
  real_T Add4_c;                       /* '<S24>/Add4' */
  real_T product1_k;                   /* '<S24>/product1' */
  real_T dX_f;                         /* '<S24>/dX' */
  real_T AddX_p;                       /* '<S24>/AddX' */
  real_T dY_h;                         /* '<S24>/dY' */
  real_T AddX1_p;                      /* '<S24>/AddX1' */
  real_T dZ_nw;                        /* '<S24>/dZ' */
  real_T AddX2_g;                      /* '<S24>/AddX2' */
  real_T y_d;                          /* '<S25>/y' */
  real_T Add1_p;                       /* '<S25>/Add1' */
  real_T z_m;                          /* '<S25>/z' */
  real_T Add3_bv;                      /* '<S25>/Add3' */
  real_T product2_e;                   /* '<S25>/product2' */
  real_T Add2_dx;                      /* '<S25>/Add2' */
  real_T product3_au;                  /* '<S25>/product3' */
  real_T product4_i;                   /* '<S25>/product4' */
  real_T Add4_a;                       /* '<S25>/Add4' */
  real_T product1_p;                   /* '<S25>/product1' */
  real_T dX_kk;                        /* '<S25>/dX' */
  real_T AddX_e;                       /* '<S25>/AddX' */
  real_T dY_l;                         /* '<S25>/dY' */
  real_T AddX1_e;                      /* '<S25>/AddX1' */
  real_T dZ_m;                         /* '<S25>/dZ' */
  real_T AddX2_c;                      /* '<S25>/AddX2' */
  real_T y_e;                          /* '<S26>/y' */
  real_T Add1_d;                       /* '<S26>/Add1' */
  real_T z_h;                          /* '<S26>/z' */
  real_T Add3_l;                       /* '<S26>/Add3' */
  real_T product2_iv;                  /* '<S26>/product2' */
  real_T Add2_j;                       /* '<S26>/Add2' */
  real_T product3_n;                   /* '<S26>/product3' */
  real_T product4_n;                   /* '<S26>/product4' */
  real_T Add4_c0;                      /* '<S26>/Add4' */
  real_T product1_gt;                  /* '<S26>/product1' */
  real_T dX_fv;                        /* '<S26>/dX' */
  real_T AddX_g;                       /* '<S26>/AddX' */
  real_T dY_d;                         /* '<S26>/dY' */
  real_T AddX1_c;                      /* '<S26>/AddX1' */
  real_T dZ_g;                         /* '<S26>/dZ' */
  real_T AddX2_h;                      /* '<S26>/AddX2' */
  real_T MatrixConcatenation1[4];      /* '<Root>/Matrix Concatenation1' */
  real_T Add_o;                        /* '<S8>/Add' */
  real_T Add1_a;                       /* '<S8>/Add1' */
  real_T Gain_i;                       /* '<S8>/Gain' */
  real_T Gain1_n;                      /* '<S8>/Gain1' */
  ...
  real_T Add_p;                        /* '<S70>/Add' */
  real_T Add1_j;                       /* '<S70>/Add1' */
  ...
  real_T xPCTargetTime_c;              /* '<S72>/xPC Target  Time ' */
  real_T Subtract;                     /* '<S72>/Subtract' */
  real_T ScaleTouSec;                  /* '<S72>/ScaleTouSec' */
  real_T Switch_j;                     /* '<S72>/Switch' */
  ...
  real_T Gain_g[2];                    /* '<S29>/Gain' */
  real_T MathFunction[4];              /* '<S33>/Math Function' */
  real_T MatrixMultiply_l[2];          /* '<S29>/Matrix Multiply' */
  real_T Switch1[2];                   /* '<S4>/Switch1' */
  real_T Switch_a[2];                  /* '<S5>/Switch' */
  real_T BoundingBoxViscosity[2];      /* '<S5>/Bounding Box Viscosity' */
  real_T Product_i;                    /* '<S41>/Product' */
  real_T Gain1_d;                      /* '<S41>/Gain1' */
  real_T Gain3;                        /* '<S41>/Gain3' */
  real_T Add_i;                        /* '<S41>/Add' */
  real_T Saturation;                   /* '<S41>/Saturation' */
  real_T Gain4;                        /* '<S41>/Gain4' */
  real_T Product1_o;                   /* '<S41>/Product1' */
  real_T Gain2;                        /* '<S41>/Gain2' */
  real_T Add1_l;                       /* '<S41>/Add1' */
  real_T Saturation1;                  /* '<S41>/Saturation1' */
  real_T Add1_h;                       /* '<S21>/Add1' */
  real_T LorentzForceGain[2];          /* '<S3>/LorentzForceGain' */
  real_T dynamicAngleSwitch;           /* '<S3>/dynamicAngle Switch' */
  real_T sin_l;                        /* '<S22>/sin' */
  real_T Inverter[2];                  /* '<S22>/Inverter' */
  real_T Product3_k;                   /* '<S22>/Product3' */
  real_T cos_k;                        /* '<S22>/cos' */
  real_T Product2_m;                   /* '<S22>/Product2' */
  real_T Subtract_o;                   /* '<S22>/Subtract' */
  real_T Product1_j;                   /* '<S22>/Product1' */
  real_T Product_j;                    /* '<S22>/Product' */
  real_T Add_l;                        /* '<S22>/Add' */
  real_T Gain_n[2];                    /* '<S22>/Gain' */
  real_T Gain_a;                       /* '<S3>/Gain' */
  real_T Add1_l2;                      /* '<S15>/Add1' */
  real_T LorentzForceGain_p[2];        /* '<S2>/LorentzForceGain' */
  real_T DynamicAngleSwitch;           /* '<S2>/DynamicAngle Switch' */
  real_T sin_k;                        /* '<S16>/sin' */
  real_T Inverter_i[2];                /* '<S16>/Inverter' */
  real_T Product3_g;                   /* '<S16>/Product3' */
  real_T cos_kc;                       /* '<S16>/cos' */
  real_T Product2_l;                   /* '<S16>/Product2' */
  real_T Subtract_k;                   /* '<S16>/Subtract' */
  real_T Product1_k;                   /* '<S16>/Product1' */
  real_T Product_n;                    /* '<S16>/Product' */
  real_T Add_lj;                       /* '<S16>/Add' */
  real_T Gain_ax[2];                   /* '<S16>/Gain' */
  real_T Gain_p;                       /* '<S2>/Gain' */
  uint8_T Compare;                     /* '<S34>/Compare' */
  uint8_T Compare_b;                   /* '<S36>/Compare' */
  uint8_T Compare_m;                   /* '<S37>/Compare' */
  uint8_T Compare_m5;                  /* '<S60>/Compare' */
  uint8_T Compare_me;                  /* '<S63>/Compare' */
  uint8_T Uk1;                         /* '<S61>/Delay Input1' */
  uint8_T FixPtRelationalOperator;     /* '<S61>/FixPt Relational Operator' */
  uint8_T Compare_n;                   /* '<S53>/Compare' */
  uint8_T Compare_p;                   /* '<S51>/Compare' */
  uint8_T Compare_mc;                  /* '<S52>/Compare' */
  uint8_T Compare_g;                   /* '<S59>/Compare' */
  uint8_T Uk1_h;                       /* '<S46>/Delay Input1' */
  uint8_T FixPtRelationalOperator_k;   /* '<S46>/FixPt Relational Operator' */
  uint8_T Compare_k;                   /* '<S57>/Compare' */
  uint8_T Compare_l;                   /* '<S50>/Compare' */
  uint8_T Uk1_p;                       /* '<S39>/Delay Input1' */
  uint8_T FixPtRelationalOperator_n;   /* '<S39>/FixPt Relational Operator' */
  uint8_T Compare_b1;                  /* '<S55>/Compare' */
  uint8_T Compare_mv;                  /* '<S49>/Compare' */
  uint8_T Uk1_d;                       /* '<S38>/Delay Input1' */
  uint8_T FixPtRelationalOperator_d;   /* '<S38>/FixPt Relational Operator' */
  uint8_T Compare_o;                   /* '<S27>/Compare' */
  uint8_T Compare_h;                   /* '<S28>/Compare' */
  ...
  boolean_T Memory_e;                  /* '<S43>/Memory' */
  boolean_T RelationalOperator_f;      /* '<S1>/Relational Operator' */
  ...
  boolean_T Memory_o;                  /* '<S47>/Memory' */
  boolean_T LogicalOperator4;          /* '<S47>/Logical Operator4' */
  boolean_T LogicalOperator_k;         /* '<S5>/Logical Operator' */
  boolean_T LogicalOperator2_h;        /* '<S47>/Logical Operator2' */
  boolean_T LogicalOperator1_f;        /* '<S47>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_p;/* '<S47>/Logical Operator1' */
  boolean_T RelationalOperator_a;      /* '<S47>/Relational Operator' */
  boolean_T LogicalOperator_j;         /* '<S47>/Logical Operator' */
  boolean_T LogicalOperator5;          /* '<S47>/Logical Operator5' */
  boolean_T LogicalOperator2_b;        /* '<S43>/Logical Operator2' */
  boolean_T LogicalOperator1_m;        /* '<S43>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_e;/* '<S43>/Logical Operator1' */
  boolean_T RelationalOperator_i;      /* '<S43>/Relational Operator' */
  boolean_T LogicalOperator_g;         /* '<S43>/Logical Operator' */
  boolean_T LogicalOperator1_a;        /* '<S40>/Logical Operator1' */
  boolean_T NOT;                       /* '<S5>/NOT' */
  boolean_T Memory_em;                 /* '<S45>/Memory' */
  boolean_T LogicalOperator2_p;        /* '<S45>/Logical Operator2' */
  boolean_T LogicalOperator1_e;        /* '<S45>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_j;/* '<S45>/Logical Operator1' */
  boolean_T RelationalOperator_p;      /* '<S45>/Relational Operator' */
  boolean_T LogicalOperator_o;         /* '<S45>/Logical Operator' */
  boolean_T DataTypeConversion2;       /* '<S5>/Data Type Conversion2' */
  boolean_T LogicalOperator1_an;       /* '<S5>/Logical Operator1' */
  boolean_T Memory_d;                  /* '<S44>/Memory' */
  boolean_T LogicalOperator2_o;        /* '<S44>/Logical Operator2' */
  boolean_T LogicalOperator1_n;        /* '<S44>/Logical Operator1' */
  boolean_T HiddenBuf_InsertedFor_Enabled_b;/* '<S44>/Logical Operator1' */
  boolean_T RelationalOperator_h;      /* '<S44>/Relational Operator' */
  boolean_T LogicalOperator_f;         /* '<S44>/Logical Operator' */
  boolean_T DataTypeConversion1;       /* '<S5>/Data Type Conversion1' */
  boolean_T Memory_j;                  /* '<S42>/Memory' */
  boolean_T Logic[2];                  /* '<S42>/Logic' */
  boolean_T LogicalOperator5_i;        /* '<S5>/Logical Operator5' */
  boolean_T LogicalOperator1_l;        /* '<S4>/Logical Operator1' */
  boolean_T MatrixConcatenation[2];    /* '<S4>/Matrix Concatenation' */
  boolean_T RelationalOperator_m;      /* '<S6>/Relational Operator' */
  boolean_T RelationalOperator_f5;     /* '<S65>/Relational Operator' */
  boolean_T Compare_a;                 /* '<S74>/Compare' */
  boolean_T Compare_c;                 /* '<S73>/Compare' */
  boolean_T LogicalOperator6;          /* '<S5>/Logical Operator6' */
  boolean_T LogicalOperator3_f;        /* '<S5>/Logical Operator3' */
  rtB_SampleandHold_bump_stim SampleandHold;/* '<S65>/Sample and Hold' */
  rtB_SampleandHold_bump_stim SampleandHold_a;/* '<S6>/Sample and Hold' */
  rtB_EnabledSubsystem_bump_stim EnabledSubsystem_l;/* '<S47>/Enabled Subsystem' */
  rtB_EnabledSubsystem_bump_stim EnabledSubsystem_o;/* '<S45>/Enabled Subsystem' */
  rtB_EnabledSubsystem_bump_stim EnabledSubsystem_f;/* '<S44>/Enabled Subsystem' */
  rtB_EnabledSubsystem_bump_stim EnabledSubsystem_c;/* '<S43>/Enabled Subsystem' */
  rtB_EnabledSubsystem_bump_stim EnabledSubsystem;/* '<S31>/Enabled Subsystem' */
} BlockIO_bump_stim;
...
typedef struct {
  ...
  real_T DigitalFilter2_FILT_STATES_c[11];/* '<S68>/Digital Filter2' */
  real_T DigitalFilter_FILT_STATES_g[11];/* '<S68>/Digital Filter' */
  real_T x_DSTATE;                     /* '<S23>/x' */
  real_T x_DSTATE_a;                   /* '<S24>/x' */
  real_T x_DSTATE_ab;                  /* '<S25>/x' */
  real_T x_DSTATE_j;                   /* '<S26>/x' */
  real_T x_DSTATE_g;                   /* '<S17>/x' */
  real_T x_DSTATE_o;                   /* '<S18>/x' */
  real_T x_DSTATE_c;                   /* '<S19>/x' */
  real_T x_DSTATE_n;                   /* '<S20>/x' */
  real_T BehaviorBS_DSTATE[2];         /* '<Root>/Behavior BS' */
  real_T y_DSTATE;                     /* '<S17>/y' */
  real_T z_DSTATE;                     /* '<S17>/z' */
  real_T y_DSTATE_d;                   /* '<S18>/y' */
  real_T z_DSTATE_b;                   /* '<S18>/z' */
  real_T y_DSTATE_h;                   /* '<S19>/y' */
  real_T z_DSTATE_i;                   /* '<S19>/z' */
  real_T y_DSTATE_o;                   /* '<S20>/y' */
  real_T z_DSTATE_c;                   /* '<S20>/z' */
  real_T y_DSTATE_g;                   /* '<S23>/y' */
  real_T z_DSTATE_p;                   /* '<S23>/z' */
  real_T y_DSTATE_gv;                  /* '<S24>/y' */
  real_T z_DSTATE_h;                   /* '<S24>/z' */
  real_T y_DSTATE_b;                   /* '<S25>/y' */
  real_T z_DSTATE_n;                   /* '<S25>/z' */
  real_T y_DSTATE_m;                   /* '<S26>/y' */
  real_T z_DSTATE_g;                   /* '<S26>/z' */
  ...
  struct {
    ...
    real_T TimeStampB;
    real_T LastUAtTimeB;
  } Derivative_RWORK_l;                /* '<S68>/Derivative' */

  real_T BehaviorBS_RWORK[6];          /* '<Root>/Behavior BS' */
  real_T PCI6025E_RWORK[6];            /* '<S4>/PCI-6025E ' */
  struct {
    real_T NextOutput;
  } UniformRandomNumber_RWORK;         /* '<S6>/Uniform Random Number' */

  void *BehaviorBS_PWORK;              /* '<Root>/Behavior BS' */
  ...
  int32_T DigitalFilter2_CIRCBUFFIDX_k;/* '<S68>/Digital Filter2' */
  int32_T DigitalFilter_CIRCBUFFIDX_k; /* '<S68>/Digital Filter' */
  int_T PCIQUAD04_IWORK;               /* '<S13>/PCI-QUAD04 ' */
  int_T PCIQUAD041_IWORK;              /* '<S13>/PCI-QUAD04 1' */
  int_T PCI6025EAD_IWORK[66];          /* '<S10>/PCI-6025E AD' */
  int_T BehaviorBS_IWORK[75];          /* '<Root>/Behavior BS' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_g;                 /* '<S32>/S-Function' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_n;                 /* '<S48>/S-Function' */
  ...
  int_T PCI6025E_IWORK_m[3];           /* '<S72>/PCI-6025E ' */
  uint8_T DelayInput1_DSTATE;          /* '<S61>/Delay Input1' */
  uint8_T DelayInput1_DSTATE_a;        /* '<S46>/Delay Input1' */
  uint8_T DelayInput1_DSTATE_n;        /* '<S39>/Delay Input1' */
  uint8_T DelayInput1_DSTATE_f;        /* '<S38>/Delay Input1' */
  boolean_T Memory_PreviousInput;      /* '<S31>/Memory' */
  boolean_T Memory_PreviousInput_b;    /* '<S4>/Memory' */
  boolean_T Memory_PreviousInput_c;    /* '<S43>/Memory' */
  boolean_T Memory_PreviousInput_g;    /* '<S47>/Memory' */
  boolean_T Memory_PreviousInput_bt;   /* '<S45>/Memory' */
  boolean_T Memory_PreviousInput_n;    /* '<S44>/Memory' */
  boolean_T Memory_PreviousInput_cq;   /* '<S42>/Memory' */
  rtDW_SampleandHold_bump_stim SampleandHold;/* '<S65>/Sample and Hold' */
  rtDW_SampleandHold_bump_stim SampleandHold_a;/* '<S6>/Sample and Hold' */
  rtDW_EnabledSubsystem_bump_stim EnabledSubsystem_l;/* '<S47>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_bump_stim EnabledSubsystem_o;/* '<S45>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_bump_stim EnabledSubsystem_f;/* '<S44>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_bump_stim EnabledSubsystem_c;/* '<S43>/Enabled Subsystem' */
  rtDW_EnabledSubsystem_bump_stim EnabledSubsystem;/* '<S31>/Enabled Subsystem' */
} D_Work_bump_stim;

/* Zero-crossing (trigger) state */
typedef struct {
  rtZCE_SampleandHold_bump_stim SampleandHold;/* '<S6>/Sample and Hold' */
  rtZCE_SampleandHold_bump_stim SampleandHold_a;/* '<S6>/Sample and Hold' */
} PrevZCSigStates_bump_stim;

/* Backward compatible GRT Identifiers */
#define rtB                            bump_stim_B
#define BlockIO                        BlockIO_bump_stim
#define rtXdot                         bump_stim_Xdot
#define StateDerivatives               StateDerivatives_bump_stim
#define tXdis                          bump_stim_Xdis
#define StateDisabled                  StateDisabled_bump_stim
#define rtP                            bump_stim_P
#define Parameters                     Parameters_bump_stim
#define rtDWork                        bump_stim_DWork
#define D_Work                         D_Work_bump_stim
#define rtPrevZCSigState               bump_stim_PrevZCSigState
#define PrevZCSigStates                PrevZCSigStates_bump_stim

/* Parameters for system: '<S6>/Sample and Hold' */
struct rtP_SampleandHold_bump_stim {
...
struct Parameters_bump_stim {
  ...
  real_T DigitalFilter_RTP1COEFF[11];  /* Expression: NumCoeffs
                                        * '<S67>/Digital Filter'
                                        */
  real_T DigitalFilter2_ICRTP_e;       /* Expression: a.IC
                                        * '<S68>/Digital Filter2'
                                        */
  real_T DigitalFilter2_RTP1COEFF_d[11];/* Expression: NumCoeffs
                                         * '<S68>/Digital Filter2'
                                         */
  real_T dG_Gain_d;                    /* Expression: 1
                                        * '<S68>/dG'
                                        */
  real_T DigitalFilter_ICRTP_l;        /* Expression: a.IC
                                        * '<S68>/Digital Filter'
                                        */
  real_T DigitalFilter_RTP1COEFF_o[11];/* Expression: NumCoeffs
                                        * '<S68>/Digital Filter'
                                        */
  ...
  real_T RecenterFlag_Value;           /* Expression: 1
                                        * '<S5>/RecenterFlag'
                                        */
  real_T Time_Value_j;                 /* Expression: Time
                                        * '<S47>/Time'
                                        */
  ...
  real_T x_X0_i;                       /* Expression: .1
                                        * '<S26>/x'
                                        */
  real_T Load_Value_n;                 /* Expression: 0
                                        * '<S2>/Load'
                                        */
  real_T x_X0_b;                       /* Expression: .1
                                        * '<S17>/x'
                                        */
  real_T x_X0_d;                       /* Expression: .1
                                        * '<S18>/x'
                                        */
  real_T x_X0_e;                       /* Expression: .1
                                        * '<S19>/x'
                                        */
  real_T x_X0_m;                       /* Expression: .1
                                        * '<S20>/x'
                                        */
  real_T BehaviorBS_P1_Size[2];        /* Computed Parameter: P1Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P1;                /* Expression: 8
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P2_Size[2];        /* Computed Parameter: P2Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P2;                /* Expression: 10
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P3_Size[2];        /* Computed Parameter: P3Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P3;                /* Expression: 2.5
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P4_Size[2];        /* Computed Parameter: P4Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P4;                /* Expression: 1
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P5_Size[2];        /* Computed Parameter: P5Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P5;                /* Expression: 1
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P6_Size[2];        /* Computed Parameter: P6Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P6;                /* Expression: .5
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P7_Size[2];        /* Computed Parameter: P7Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P7;                /* Expression: 1.5
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P8_Size[2];        /* Computed Parameter: P8Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P8;                /* Expression: .75
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P9_Size[2];        /* Computed Parameter: P9Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P9;                /* Expression: .25
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P10_Size[2];       /* Computed Parameter: P10Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P10;               /* Expression: 1
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P11_Size[2];       /* Computed Parameter: P11Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P11;               /* Expression: 1
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P12_Size[2];       /* Computed Parameter: P12Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P12;               /* Expression: 2
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P13_Size[2];       /* Computed Parameter: P13Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P13;               /* Expression: 1
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P14_Size[2];       /* Computed Parameter: P14Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P14;               /* Expression: .02
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P15_Size[2];       /* Computed Parameter: P15Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P15;               /* Expression: 125
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P16_Size[2];       /* Computed Parameter: P16Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P16;               /* Expression: 1
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P17_Size[2];       /* Computed Parameter: P17Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P17;               /* Expression: 1
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P18_Size[2];       /* Computed Parameter: P18Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P18;               /* Expression: 0
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P19_Size[2];       /* Computed Parameter: P19Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P19;               /* Expression: 0
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P20_Size[2];       /* Computed Parameter: P20Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P20;               /* Expression: 0
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P21_Size[2];       /* Computed Parameter: P21Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P21;               /* Expression: 0
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P22_Size[2];       /* Computed Parameter: P22Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P22;               /* Expression: 0
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P23_Size[2];       /* Computed Parameter: P23Size
                                        * '<Root>/Behavior BS'
                                        */
  real_T BehaviorBS_P23;               /* Expression: 0
                                        * '<Root>/Behavior BS'
                                        */
  ...
  real_T rho_Value_p;                  /* Expression: 28
                                        * '<S18>/rho'
                                        */
  real_T z_X0_k;                       /* Expression: .1
                                        * '<S18>/z'
                                        */
  real_T beta_Value_f;                 /* Expression: 8/3
                                        * '<S18>/beta'
                                        */
  ...
  real_T rho_Value_c;                  /* Expression: 28
                                        * '<S19>/rho'
                                        */
  real_T z_X0_kn;                      /* Expression: .1
                                        * '<S19>/z'
                                        */
  real_T beta_Value_n;                 /* Expression: 8/3
                                        * '<S19>/beta'
                                        */
  real_T timescale_Value_n;            /* Expression: .0001
                                        * '<S19>/timescale'
                                        */
  ...
  real_T y_X0_g;                       /* Expression: y0
                                        * '<S23>/y'
                                        */
  real_T rho_Value_pi;                 /* Expression: 28
                                        * '<S23>/rho'
                                        */
  ...
  real_T y_X0_k;                       /* Expression: y0
                                        * '<S24>/y'
                                        */
  real_T rho_Value_l;                  /* Expression: 28
                                        * '<S24>/rho'
                                        */
  ...
  real_T timescale_Value_p;            /* Expression: .0001
                                        * '<S24>/timescale'
                                        */
  real_T sigma_Value_d;                /* Expression: 10
                                        * '<S24>/sigma'
                                        */
  ...
  real_T z_X0_l;                       /* Expression: .1
                                        * '<S25>/z'
                                        */
  real_T beta_Value_gu;                /* Expression: 8/3
                                        * '<S25>/beta'
                                        */
  real_T timescale_Value_b;            /* Expression: .0001
                                        * '<S25>/timescale'
                                        */
  real_T sigma_Value_dt;               /* Expression: 10
                                        * '<S25>/sigma'
                                        */
  real_T y_X0_e;                       /* Expression: y0
                                        * '<S26>/y'
                                        */
  real_T rho_Value_i;                  /* Expression: 28
                                        * '<S26>/rho'
                                        */
  real_T z_X0_o;                       /* Expression: .1
                                        * '<S26>/z'
                                        */
  real_T beta_Value_c;                 /* Expression: 8/3
                                        * '<S26>/beta'
                                        */
  real_T timescale_Value_oi;           /* Expression: .0001
                                        * '<S26>/timescale'
                                        */
  ...
  real_T Gain_Gain_p;                  /* Expression: .5
                                        * '<S8>/Gain'
                                        */
  real_T Gain1_Gain_a;                 /* Expression: .5
                                        * '<S8>/Gain1'
                                        */
  real_T Gain_Gain_j;                  /* Expression: 0.0367
                                        * '<S2>/Gain'
                                        */
  ...
  real_T Off_Value;                    /* Expression: 0
                                        * '<S2>/Off'
                                        */
  real_T Gain_Gain_f;                  /* Expression: 0.0367
                                        * '<S3>/Gain'
                                        */
  real_T visAngle_Value_p;             /* Expression: 0
                                        * '<S3>/visAngle'
                                        */
  real_T DynamicAngle_Value_i;         /* Expression: 0
                                        * '<S3>/DynamicAngle'
                                        */
  real_T Inverter_Gain_d;              /* Expression: -1
                                        * '<S22>/Inverter'
                                        */
  ...
  real_T LorentzForceGain_Gain_l;      /* Expression: .0005
                                        * '<S3>/LorentzForceGain'
                                        */
  real_T staticX_Value_j;              /* Expression: 0
                                        * '<S3>/staticX'
                                        */
  real_T staticY_Value_g;              /* Expression: 0
                                        * '<S3>/staticY'
                                        */
  real_T Off_Value_d;                  /* Expression: 0
                                        * '<S3>/Off'
                                        */
  ...
  real_T Constant_Value_d;             /* Expression: const
                                        * '<S74>/Constant'
                                        */
  real_T PCI6025E_P1_Size_m[2];        /* Computed Parameter: P1Size
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P1_j[2];             /* Expression: channel
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P2_Size_d[2];        /* Computed Parameter: P2Size
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P2_j[2];             /* Expression: reset
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P3_Size_m[2];        /* Computed Parameter: P3Size
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P3_k[2];             /* Expression: initValue
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P4_Size_k[2];        /* Computed Parameter: P4Size
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P4_k;                /* Expression: sampletime
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P5_Size_i[2];        /* Computed Parameter: P5Size
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P5_m;                /* Expression: slot
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P6_Size_m[2];        /* Computed Parameter: P6Size
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P6_m;                /* Expression: control
                                        * '<S72>/PCI-6025E '
                                        */
  real_T PCI6025E_P7_Size_p[2];        /* Computed Parameter: P7Size
                                        * '<S72>/PCI-6025E '
                                        */
  ...
  real_T PortA_P9;                     /* Expression: boardType
                                        * '<S70>/Port A'
                                        */
  real_T Constant_Value_p;             /* Expression: 32768
                                        * '<S70>/Constant'
                                        */
  ...
  real_T PortB_P9;                     /* Expression: boardType
                                        * '<S70>/Port B'
                                        */
  real_T xPCTargetTime_P1_Size_h[2];   /* Computed Parameter: P1Size
                                        * '<S70>/xPC Target  Time '
                                        */
  real_T xPCTargetTime_P1_k;           /* Expression: func
                                        * '<S70>/xPC Target  Time '
                                        */
  real_T xPCTargetTime_P2_Size_b[2];   /* Computed Parameter: P2Size
                                        * '<S70>/xPC Target  Time '
                                        */
  real_T xPCTargetTime_P2_a;           /* Expression: ts
                                        * '<S70>/xPC Target  Time '
                                        */
  ...
  uint8_T DelayInput1_X0_f;            /* Computed Parameter: X0
                                        * '<S46>/Delay Input1'
                                        */
  uint8_T DelayInput1_X0_c;            /* Computed Parameter: X0
                                        * '<S39>/Delay Input1'
                                        */
  uint8_T DelayInput1_X0_fl;           /* Computed Parameter: X0
                                        * '<S38>/Delay Input1'
                                        */
  ...
  boolean_T Memory_X0_l;               /* Computed Parameter: X0
                                        * '<S43>/Memory'
                                        */
  boolean_T Memory_X0_h;               /* Computed Parameter: X0
                                        * '<S47>/Memory'
                                        */
  boolean_T Memory_X0_ll;              /* Computed Parameter: X0
                                        * '<S45>/Memory'
                                        */
  boolean_T Memory_X0_nn;              /* Computed Parameter: X0
                                        * '<S44>/Memory'
                                        */
  boolean_T Memory_X0_nr;              /* Computed Parameter: X0
                                        * '<S42>/Memory'
                                        */
  boolean_T Logic_table[16];           /* Computed Parameter: TruthTable
                                        * '<S42>/Logic'
                                        */
  rtP_SampleandHold_bump_stim SampleandHold;/* '<S6>/Sample and Hold' */
  rtP_SampleandHold_bump_stim SampleandHold_a;/* '<S6>/Sample and Hold' */
};

/* Real-time Model Data Structure */
struct rtModel_bump_stim {
  const char_T *path;
...
extern Parameters_bump_stim bump_stim_P;

/* Block signals (auto storage) */
extern BlockIO_bump_stim bump_stim_B;

/* Block states (auto storage) */
extern D_Work_bump_stim bump_stim_DWork;

/* External data declarations for dependent source files */

/* Zero-crossing (trigger) state */
extern PrevZCSigStates_bump_stim bump_stim_PrevZCSigState;

/* Model entry point functions */
extern void bump_stim_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void bump_stim_initialize(boolean_T firstTime);
extern void bump_stim_output(int_T tid);
extern void bump_stim_update(int_T tid);
extern void bump_stim_terminate(void);

/* Real-time Model object */
extern rtModel_bump_stim *bump_stim_rtM;
 ...
 *
 * '<Root>' : bump_stim
 * '<S1>'   : bump_stim/BoundingBox
 * '<S2>'   : bump_stim/Catch Force Generator
 * '<S3>'   : bump_stim/Force Generator
 * '<S4>'   : bump_stim/Motor Control
 * '<S5>'   : bump_stim/Recentering Subsystem
 * '<S6>'   : bump_stim/RewardSbs
 * '<S7>'   : bump_stim/Status
 * '<S8>'   : bump_stim/Target Peek
 * '<S9>'   : bump_stim/UDPXmit
 * '<S10>'  : bump_stim/Velocity Calculation
 * '<S11>'  : bump_stim/Version Display
 * '<S12>'  : bump_stim/WordSbs
 * '<S13>'  : bump_stim/XY Position Subsystem
 * '<S14>'  : bump_stim/Xpos
 * '<S15>'  : bump_stim/Catch Force Generator/LorentzForce
 * '<S16>'  : bump_stim/Catch Force Generator/ViscLoadSubsystem
 * '<S17>'  : bump_stim/Catch Force Generator/LorentzForce/Lorentz
 * '<S18>'  : bump_stim/Catch Force Generator/LorentzForce/Lorentz1
 * '<S19>'  : bump_stim/Catch Force Generator/LorentzForce/Lorentz2
 * '<S20>'  : bump_stim/Catch Force Generator/LorentzForce/Lorentz3
 * '<S21>'  : bump_stim/Force Generator/LorentzForce
 * '<S22>'  : bump_stim/Force Generator/ViscLoadSubsystem
 * '<S23>'  : bump_stim/Force Generator/LorentzForce/Lorentz
 * '<S24>'  : bump_stim/Force Generator/LorentzForce/Lorentz1
 * '<S25>'  : bump_stim/Force Generator/LorentzForce/Lorentz2
 * '<S26>'  : bump_stim/Force Generator/LorentzForce/Lorentz3
 * '<S27>'  : bump_stim/Motor Control/Compare To Constant
 * '<S28>'  : bump_stim/Motor Control/Compare To Constant1
 * '<S29>'  : bump_stim/Motor Control/Force//Torque Transform
 * '<S30>'  : bump_stim/Motor Control/Recenter//ServoKill
 * '<S31>'  : bump_stim/Motor Control/Schmidt
 * '<S32>'  : bump_stim/Motor Control/Xpos
 * '<S33>'  : bump_stim/Motor Control/Force//Torque Transform/Transpose
 * '<S34>'  : bump_stim/Motor Control/Schmidt/Compare To Zero
 * '<S35>'  : bump_stim/Motor Control/Schmidt/Enabled Subsystem
 * '<S36>'  : bump_stim/Recentering Subsystem/Compare To Zero
 * '<S37>'  : bump_stim/Recentering Subsystem/Compare To Zero1
 * '<S38>'  : bump_stim/Recentering Subsystem/Falling Edge
 * '<S39>'  : bump_stim/Recentering Subsystem/Falling Edge1
 * '<S40>'  : bump_stim/Recentering Subsystem/No Movement
 * '<S41>'  : bump_stim/Recentering Subsystem/PD Controller
 * '<S42>'  : bump_stim/Recentering Subsystem/S-R Flip-Flop
 * '<S43>'  : bump_stim/Recentering Subsystem/Schmidt1
 * '<S44>'  : bump_stim/Recentering Subsystem/Schmidt2
 * '<S45>'  : bump_stim/Recentering Subsystem/Schmidt3
 * '<S46>'  : bump_stim/Recentering Subsystem/Start Moving
 * '<S47>'  : bump_stim/Recentering Subsystem/Timer
 * '<S48>'  : bump_stim/Recentering Subsystem/Xpos1
 * '<S49>'  : bump_stim/Recentering Subsystem/Falling Edge/Nonpositive
 * '<S50>'  : bump_stim/Recentering Subsystem/Falling Edge1/Nonpositive
 * '<S51>'  : bump_stim/Recentering Subsystem/No Movement/Compare To Constant2
 * '<S52>'  : bump_stim/Recentering Subsystem/No Movement/Compare To Constant3
 * '<S53>'  : bump_stim/Recentering Subsystem/Schmidt1/Compare To Zero
 * '<S54>'  : bump_stim/Recentering Subsystem/Schmidt1/Enabled Subsystem
 * '<S55>'  : bump_stim/Recentering Subsystem/Schmidt2/Compare To Zero
 * '<S56>'  : bump_stim/Recentering Subsystem/Schmidt2/Enabled Subsystem
 * '<S57>'  : bump_stim/Recentering Subsystem/Schmidt3/Compare To Zero
 * '<S58>'  : bump_stim/Recentering Subsystem/Schmidt3/Enabled Subsystem
 * '<S59>'  : bump_stim/Recentering Subsystem/Start Moving/Nonpositive
 * '<S60>'  : bump_stim/Recentering Subsystem/Timer/Compare To Zero
 * '<S61>'  : bump_stim/Recentering Subsystem/Timer/Detect Fall Nonpositive
 * '<S62>'  : bump_stim/Recentering Subsystem/Timer/Enabled Subsystem
 * '<S63>'  : bump_stim/Recentering Subsystem/Timer/Detect Fall Nonpositive/Nonpositive
 * '<S64>'  : bump_stim/RewardSbs/Sample and Hold
 * '<S65>'  : bump_stim/RewardSbs/Schmidt
 * '<S66>'  : bump_stim/RewardSbs/Schmidt/Sample and Hold
 * '<S67>'  : bump_stim/Velocity Calculation/Pos2VelX
 * '<S68>'  : bump_stim/Velocity Calculation/Pos2VelY
 * '<S69>'  : bump_stim/XY Position Subsystem/Cursor Rotation
 * '<S70>'  : bump_stim/XY Position Subsystem/For Iterator Subsystem
 * '<S71>'  : bump_stim/XY Position Subsystem/Jacobian-Cartesian Transformation
 * '<S72>'  : bump_stim/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem
 * '<S73>'  : bump_stim/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem/Compare To Constant
 * '<S74>'  : bump_stim/XY Position Subsystem/For Iterator Subsystem/While Iterator Subsystem/Compare To Constant1
 */
#endif                                 /* _RTW_HEADER_bump_stim_h_ */
