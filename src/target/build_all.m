...
T = {...
  ...
  {'uncertainty.dlm', 'mastercon_un.mexw32','serPos.mexw32','Byte2Bits.mexw32'}, ...
  {'random_walk.dlm', 'mastercon_rw.mexw32', 'serPos.mexw32', 'Byte2Bits.mexw32'}, ...
  {'attention.dlm', 'mastercon_at.mexw32','serPos.mexw32','Byte2Bits.mexw32'}, ...
  {'mastercon_at.mexw32','targets.obj'} ...
};
