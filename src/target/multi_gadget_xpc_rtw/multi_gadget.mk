...
MODEL           = multi_gadget
MODULES         = multi_gadget_capi.c multi_gadget_data.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c 
MAKEFILE        = multi_gadget.mk
...
S_FUNCTIONS     = xpctimeinfo.c donipcie.c Byte2Bits.c dopci8255.c serPos.c dinipcie.c adnipcie.c mastercon_mg.c xpcudpbytesend.c
S_FUNCTIONS_LIB = 
NUMST           = 3
TID01EQ         = 1
NCSTATES        = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\DOCUME~1\David\Desktop\Behavior\trunk\src\target\MULTI_~1
